<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_SaXzPiecesPro.aspx.cs" Inherits="qpoa.HumanResources.open_SaXzPiecesPro" %>
	...
	<body scroll="no" onload="onradiobutton()">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请选择计件工序</td>
				</tr>
				<tr>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center"
                                            Wrap="False" />
                                        <ItemTemplate>
                                           <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "Name")%>|<%#DataBinder.Eval(Container.DataItem, "DjMoney")%>' name="Rad"  />
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Name" HeaderText="计件工序" SortExpression="Name">
