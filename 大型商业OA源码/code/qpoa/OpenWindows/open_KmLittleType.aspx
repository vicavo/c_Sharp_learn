<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_KmLittleType.aspx.cs" Inherits="qpoa.OpenWindows.open_KmLittleType" %>
	...
	<body scroll="no" onload="onradiobutton()">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请选择知识小类</td>
				</tr>
				<tr>
			    <td valign="top" style="text-align: center">
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 567px; height: 49px">
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left">
                            大类：<asp:DropDownList ID="BigId" runat="server" Width="224px">
                            </asp:DropDownList>小类名称关键字：<asp:TextBox ID="name" runat="server"></asp:TextBox>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center"
                                            Wrap="False" />
                                        <ItemTemplate>
                                           <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "BigId")%>|<%#DataBinder.Eval(Container.DataItem, "BigName")%>|<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "Name")%>' name="Rad" />
                                        </ItemTemplate>
