<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_AssetsDepType.aspx.cs" Inherits="qpoa.OpenWindows.open_AssetsDepType" %>
	...
	<body scroll="no" onload="onradiobutton()">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请资产折旧类别</td>
				</tr>
				<tr>
			    ...
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 470px; height: 49px">
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left">
                           类别关键字：<asp:TextBox ID="name" runat="server" Width="334px"></asp:TextBox>
                    ...
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: center;">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                ...
                                BorderWidth="1px" CellPadding="3" CellSpacing="1" GridLines="None" Style="font-size: 12px" Width="99%" OnPageIndexChanging="GridView1_PageIndexChanging">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center"
                                            Wrap="False" />
                                        <ItemTemplate>
                                           <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "DepType")%>|<%#DataBinder.Eval(Container.DataItem, "DepRate")%>|<%#DataBinder.Eval(Container.DataItem, "DepCycle")%>' name="Rad" />
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="DepType" HeaderText="类别名称x" SortExpression="DepType">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                       <asp:BoundField DataField="DepRate" HeaderText="折旧率(%)" SortExpression="DepRate">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                 
                                    
                                    
                                     <asp:BoundField DataField="DepCycle" HeaderText="折旧周期(天)" SortExpression="DepCycle">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
