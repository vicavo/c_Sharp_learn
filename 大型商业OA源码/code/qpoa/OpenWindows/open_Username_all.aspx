<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_Username_all.aspx.cs" Inherits="qpoa.OpenWindows.open_Username_all" %>
			    ...
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 518px; height: 49px">
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left">
                            部门：<asp:DropDownList ID="Unit" runat="server" Width="224px">
                            </asp:DropDownList>名称关键字：<asp:TextBox ID="name" runat="server"></asp:TextBox>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center"
                                            Wrap="False" />
                                        <ItemTemplate>
                                           <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "username")%>|<%#DataBinder.Eval(Container.DataItem, "realname")%>|<%#DataBinder.Eval(Container.DataItem, "Unit")%>|<%#DataBinder.Eval(Container.DataItem, "UnitId")%>|<%#DataBinder.Eval(Container.DataItem, "QxString")%>|<%#DataBinder.Eval(Container.DataItem, "Respon ")%>|<%#DataBinder.Eval(Container.DataItem, "ResponId")%>' name="Rad" />
                                        </ItemTemplate>
