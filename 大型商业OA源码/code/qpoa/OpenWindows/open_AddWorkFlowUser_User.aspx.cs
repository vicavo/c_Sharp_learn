...
{
    public partial class open_AddWorkFlowUser_User : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToDownList()
        {
            ...
            //try
            //{
            string sql_down1 = "select * from qp_username  where username not in (" + strlist2 + ")  and  username  in (" + strlist + ")";
