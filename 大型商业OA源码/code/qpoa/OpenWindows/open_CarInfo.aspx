<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_CarInfo.aspx.cs" Inherits="qpoa.OpenWindows.open_CarInfo" %>
	...
	<body scroll="no" onload="onradiobutton()">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请选择车辆</td>
				</tr>
				<tr>
			    ...
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 470px; height: 49px">
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left">
                            车辆号关键字：<asp:TextBox ID="name" runat="server" Width="334px"></asp:TextBox>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center"
                                            Wrap="False" />
                                        <ItemTemplate>
                                           <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "CarNum")%>' name="Rad" />
                                        </ItemTemplate>
