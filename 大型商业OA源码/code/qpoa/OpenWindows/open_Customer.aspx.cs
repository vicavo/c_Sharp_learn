...
{
    public partial class open_Customer : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            Response.Redirect("open_Customer.aspx?str=" + name.Text + "&requeststr=" + Server.UrlDecode(Request.QueryString["requeststr"].ToString()) + "");
        }
