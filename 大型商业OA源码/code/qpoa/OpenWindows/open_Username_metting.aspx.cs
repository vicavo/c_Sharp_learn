...
{
    public partial class open_Username_metting : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("open_Username_metting.aspx?key=1&name=" + name.Text + "&requeststr=" + Server.UrlDecode(Request.QueryString["requeststr"].ToString()) + "");
        }
    }
}
