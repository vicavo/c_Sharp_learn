<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoPostAreaCodes.aspx.cs" Inherits="qpoa.PracticalTool.InfoPostAreaCodes" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      类型名：<input id="jsname" type="text" />请输入一个省名、市名、地区名、邮编、区号\
...
function chksearchstr()
{
    ...
    midSql=midSql+"Name="+document.getElementById('jsname').value+"";
     ...
     showwait();	
    window.location="InfoPostAreaCodes.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 邮编区号</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='InfoPostAreaCodes.aspx';showwait();">
                                    <font class="shadow_but">邮编区号</font></button>
                            </td>
                    ...
                    <td valign="top">
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Province" HeaderText="省/区/直辖市" SortExpression="Province">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                          <asp:BoundField DataField="AreaName" HeaderText="市/区/县" SortExpression="AreaName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                              
