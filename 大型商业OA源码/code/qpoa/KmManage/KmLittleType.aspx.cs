...
{
    public partial class KmLittleType : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "jjjj2", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "jjjj2", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "jjjj2", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "jjjj2", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStartCount = "select count(id) from qp_KmLittleType where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_KmLittleType";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_KmLittleType " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_KmLittleType  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除知识小类[" + CheckCbxNameDel() + "]", "知识小类维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("KmLittleType_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("KmLittleType_add.aspx");
        }
        ...
        {
            Response.Redirect("KmLittleType_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("KmLittleType_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
