...
{
    public partial class KmTitle_show_add_zj_manage_add : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (NewReader1.Read())
            {
                KmManger = NewReader1["DyUsername"].ToString();
            }
            NewReader1.Close();
            ...
            {
                string sql_insertgly = "insert into qp_Messages  (title,content,itimes,acceptusername,acceptrealname,sendusername,sendrealname,sfck,url,number) values ('你订阅的知识[" + Name.Text + "]，有更新，请注意查看！','你订阅的知识[" + Name.Text + "]，有更新，请注意查看！','" + System.DateTime.Now.ToString() + "','" + NewReader["username"] + "','" + NewReader["realname"] + "','系统消息','系统消息','否','KmManage/KmTitleDy.aspx','" + System.DateTime.Now.Year.ToString() + "" + System.DateTime.Now.Month.ToString() + "" + System.DateTime.Now.Day.ToString() + "" + System.DateTime.Now.Second.ToString() + "" + System.DateTime.Now.Millisecond.ToString() + "')";
