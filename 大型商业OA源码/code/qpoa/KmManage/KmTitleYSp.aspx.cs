...
{
    public partial class KmTitleYSp : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                BindAttribute();
                DataBindToGridview("order by SpTime desc");
                Bindquanxian();
        ...
        {
            List.QuanXianVis(GridView1, "jjjj8", Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string SQL_GetCount = "select count(id) from  qp_KmTitle where  (State!='暂存')";
            CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

            string SQL_GetList_xs = "select * from qp_KmTitle where (State!='暂存')  " + Sqlsort + "";
