<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitlePhTjQl.aspx.cs" Inherits="qpoa.KmManage.KmTitlePhTjQl" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 知识排行</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              ...
                              <button class="btn4off" onclick="javascript:window.location='KmTitlePhTjZx.aspx';showwait();" type="button"><font class="shadow_but">最新知识</font></button>
                             <button class="btn4on" onclick="javascript:window.location='KmTitlePhTjQl.aspx';showwait();" type="button"><font class="shadow_but">强力推荐</font></button>
                            </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="Realname" HeaderText="作者" SortExpression="Realname">
                                    ...
                                    <asp:BoundField DataField="TjTime" HeaderText="强力推荐时间" SortExpression="TjTime">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                        
