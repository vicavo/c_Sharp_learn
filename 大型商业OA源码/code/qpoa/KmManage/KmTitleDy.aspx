<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitleDy.aspx.cs" Inherits="qpoa.KmManage.KmTitleDy" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                     ...
                     <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 我的订阅</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
              ...
              <tr> 
                ...
                <td valign="top" style="height: 40px"> 
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <button class="btn4on" type="button" onclick="javascript:window.location='KmTitleDy.aspx';showwait();"><font class="shadow_but">我的订阅</font></button>
                                    ...
                                    <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                          <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "id") %>);">查看</a>
                                            ...
                                            <asp:LinkButton ID="DingYue" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="DingYue">取消订阅</asp:LinkButton>
