<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitleYSp.aspx.cs" Inherits="qpoa.KmManage.KmTitleYSp" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  知识审批  </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='KmTitleSp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"type="button"><font class="shadow_but">未审批</font></button>
                                <button class="btn4on" onclick="javascript:window.location='KmTitleYSp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();" type="button"><font class="shadow_but">已审批</font></button>
