<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitle_show_online.aspx.cs" Inherits="qpoa.KmManage.KmTitle_show_online" %>
...
<HTML>
	<HEAD>
		...
		function chknull()
		{
			...
			var num=Math.random();
			document.all.FramerControl1.Open("http://"+serverpath+"/KmManage/KmTitleListFj/<%=forfile%>?tmp="+num+"", true);
...
//		}	
        ...
        function SaveToWeb()
        {
          showwait();	
           ...
           document.all.FramerControl1.HttpPost("http://"+serverpath+"/KmManage/KmTitle_show_online_save.aspx?file=<%=forfile%>&number=<%=number%>&forname=<%=forname%>");
