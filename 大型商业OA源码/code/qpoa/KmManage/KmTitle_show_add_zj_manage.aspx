<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitle_show_add_zj_manage.aspx.cs" Inherits="qpoa.KmManage.KmTitle_show_add_zj_manage" %>
...
{
var num=Math.random();
window.open ("KmTitle_show_add_zj_manage_show.aspx?tmp="+num+"&id="+str+"&Number=<%=Request.QueryString["Number"] %>", "_blank", "height=560, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=60,left=130")
}

function updatefrom(str)
{
var num=Math.random();
window.open ("KmTitle_show_add_zj_manage_update.aspx?tmp="+num+"&id="+str+"&Number=<%=Request.QueryString["Number"] %>", "_blank", "height=560, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=60,left=130")
}
...
{
var num=Math.random();
window.open ("KmTitle_show_add_zj_manage_add.aspx?tmp="+num+"&Number=<%=Request.QueryString["Number"] %>", "_blank", "height=560, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=60,left=130")
}
                ...
                <tr>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server">新建章节</asp:LinkButton>
                                   </td>
                            </tr>
