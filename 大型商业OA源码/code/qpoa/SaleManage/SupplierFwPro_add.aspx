<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierFwPro_add.aspx.cs" Inherits="qpoa.SaleManage.SupplierFwPro_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 产品信息管理 >> <a href="SupplierFwPro.aspx"  class="line_b">服务型产品管理</a> >> 新增服务型产品信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
