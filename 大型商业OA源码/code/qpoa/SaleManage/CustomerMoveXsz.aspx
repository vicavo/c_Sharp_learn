<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMoveXsz.aspx.cs" Inherits="qpoa.SaleManage.CustomerMoveXsz" %>
...
var cValue = littleproduct.options[cindex].text;
    ...
    if (!window.confirm("你确认要将销售组["+cValue+"]的数据转移给用户["+document.getElementById('Realname').value+"]吗？"))
    {
     //showwait()
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 客户管理 >>  客户转移 >>  按销售组转移</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                              ...
                              <button class="btn4off6k" onclick="javascript:window.location='CustomerMove.aspx';showwait();" type="button"><font class="shadow_but">按结果转移</font></button>&nbsp;
                                <button class="btn4off6k" onclick="javascript:window.location='CustomerMoveRy.aspx';showwait();" type="button"><font class="shadow_but">按人员转移</font></button>&nbsp;
                                  <button class="btn4off6k" onclick="javascript:window.location='CustomerMoveBm.aspx';showwait();" type="button"><font class="shadow_but">按部门转移</font></button>&nbsp;
                                   <button class="btn4on6k" onclick="javascript:window.location='CustomerMoveXsz.aspx';showwait();" type="button"><font class="shadow_but">按销售组转移</font></button>&nbsp;
                            </td>
                    	...
                    	<table  cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                <td valign="top" style="height: 25px">
                                    将销售组<asp:DropDownList ID="UnitName" runat="server" Width="361px">
