<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleProduct.aspx.cs" Inherits="qpoa.SaleManage.SaleProduct" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;产品名称：<input id="jsproductname" type="text"   style="width: 138px"/>&nbsp;客户名称：<input id="jscustomername" type="text"   style="width: 138px"/>\
                        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销售人员：<input id="jssalerealname" type="text"   style="width: 138px"/>&nbsp;销售日期：<input id="jssaletime" type="text"   style="width: 138px"/>日期格式yyyy-mm-dd\
...
midSql=midSql+"&SaleTime="+document.getElementById('jssaletime').value+"";
    ...
    window.location="SaleProduct.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SaleProduct_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SaleProduct_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  销售记录  >>  常规产品</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='SaleProduct.aspx';showwait();"
                                    type="button">
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ProductName") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="UnitMoney" HeaderText="单价" SortExpression="UnitMoney">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ManyNum" HeaderText="数量" SortExpression="ManyNum">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
