...
{
    public partial class qp_SaleGroup : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                if (Request.QueryString["GroupRealname"] != null)
                {
                    MidSql = MidSql + " and GroupRealname like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["GroupRealname"])) + "%'";
                }
        ...
        {
            List.QuanXianVis(ImageButton1, "ffff7ab", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "ffff7ac", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "ffff7ad", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "ffff7ae", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "ffff7ai", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_SaleGroup where 1=1";
            SqlStrStartCount = "select count(id) from qp_SaleGroup where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_SaleGroup";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SaleGroup  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除销售组[" + CheckCbxNameDel() + "]", "销售组维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SaleGroup_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SaleGroup_add.aspx");
        }
        ...
        {
            Response.Redirect("SaleGroup_show.aspx?id=" + CheckCbxUpdate() + "");
        }
