<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierPro.aspx.cs" Inherits="qpoa.SaleManage.SupplierPro" %>
...
function chksearchstr()
{
    ...
    window.location="SupplierPro.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SupplierPro_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SupplierPro_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 产品信息管理 >>  常规产品信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='SupplierPro.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">常规产品</font></button>
                                <button class="btn4off" onclick="javascript:window.location='SupplierFwPro.aspx';showwait();" type="button"><font class="shadow_but">服务型产品</font></button>
                            </td>
                        ...
                        <div id="Div1" >
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="供应商" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
