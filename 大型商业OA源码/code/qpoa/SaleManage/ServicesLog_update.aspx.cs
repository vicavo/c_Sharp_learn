...
{
    public partial class ServicesLog_update : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string SQL_GetList = "select * from qp_ServicesLog where id='" + List.GetFormatStr(Request.QueryString["id"]) + "'";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string Sql_update1 = "Update qp_ServicesLog  Set KeyId='" + List.GetFormatStr(KeyId.Text) + "',Name='" + List.GetFormatStr(Name.Text) + "',KhId='" + List.GetFormatStr(KhId.Text) + "',KhRealname='" + List.GetFormatStr(KhRealname.Text) + "',ServicesType='" + List.GetFormatStr(ServicesType.Text) + "',ServicesMoney='" + List.GetFormatStr(ServicesMoney.Text) + "',Startime='" + List.GetFormatStr(Startime.Text) + "',Endtime='" + List.GetFormatStr(Endtime.Text) + "',Content='" + List.GetFormatStr(Content.Text) + "',Satisfaction='" + List.GetFormatStr(Satisfaction.Text) + "',Feedback='" + List.GetFormatStr(Feedback.Text) + "' ,Remark='" + List.GetFormatStr(Remark.Text) + "'  where id='" + int.Parse(Request.QueryString["id"]) + "'";
            List.ExeSql(Sql_update1);


            InsertLog("修改客户服务信息[" + Name.Text + "]", "客户服务");
