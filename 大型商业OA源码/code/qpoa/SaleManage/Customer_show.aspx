<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer_show.aspx.cs" Inherits="qpoa.SaleManage.Customer_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Customer.aspx"  class="line_b">客户信息管理</a> >> 查看客户信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
           ...
           <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                                      <button class="btn4on" onclick="javascript:window.location='Customer_show.aspx?id=<%=Request.QueryString["id"] %>';showwait();"
                                    type="button">
                                    <font class="shadow_but">客户信息</font></button>
                                <button class="btn4off" onclick="javascript:window.location='CustomerLxr.aspx?KeyId=<%=Request.QueryString["id"] %>';showwait();" type="button"><font class="shadow_but">联系人信息</font></button></td>
