<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllSaleData.aspx.cs" Inherits="qpoa.SaleManage.AllSaleData" %>
...
midSql=midSql+"&Endtime="+document.getElementById('jsendtime').value+"";
    ...
    window.location="AllSaleData.aspx?Type=2&key=1&"+midSql+"";
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
 ...
 <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  客户综合分析  >>  客户属性分析   >>  客户行业</td>                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AllSaleData.aspx?type=2';showwait();"
                                    type="button">
                                    <font class="shadow_but">客户行业</font></button>
