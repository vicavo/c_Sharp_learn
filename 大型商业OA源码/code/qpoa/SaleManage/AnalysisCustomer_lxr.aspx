<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisCustomer_lxr.aspx.cs" Inherits="qpoa.SaleManage.AnalysisCustomer_lxr" %>
...
function chksearchstr()
{
    ...
    window.location="AnalysisCustomer_lxr.aspx?id=<%=Request.QueryString["id"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("AnalysisCustomer_lxr_dc.aspx?id=<%=Request.QueryString["id"] %>&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("AnalysisCustomer_lxr_dc.aspx?id=<%=Request.QueryString["id"] %>&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="联系人姓名">
                                        ...
                                        <ItemTemplate>
                                            <a href=AnalysisCustomer_lxr_show.aspx?id=<%= Request.QueryString["id"]%>&showid=<%# DataBinder.Eval(Container.DataItem, "ID") %>><%# DataBinder.Eval(Container.DataItem, "KhRealname") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
