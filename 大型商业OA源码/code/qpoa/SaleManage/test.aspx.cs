        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Session["username"] == null)
            {
                ...
                while (NewReader_mx.Read())
                {
                    ...
                    //this.mx.Text += " <tr bgColor=#f3f8fe><td align=right width=15%>" + NewReader_mx["Name"] + "：</td><td width=85% colSpan=3>" + NewReader_mx["textbox"] + "</td>";

                    //typename += " <tr bgColor=#f3f8fe><td align=right width=15%>" + NewReader_mx["Name"] + "：</td><td width=85% colSpan=3>" + NewReader_mx["textbox"] + "</td>";
