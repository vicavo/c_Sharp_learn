...
{
    public partial class AnalysisCustomer_myd_show : System.Web.UI.Page
    {
        Db List = new Db();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string SQL_GetList = "select * from qp_ContactsSurvey where id='" + List.GetFormatStr(Request.QueryString["showid"]) + "'";
                ...
                NewReader.Close();
                InsertLog("查看满意度调查记录[" + Name.Text + "]", "客户综合信息");
                BindAttribute();
            }
        ...
        {
            Response.Redirect("AnalysisCustomer_myd.aspx?id="+Request.QueryString["id"]+"");
        }
