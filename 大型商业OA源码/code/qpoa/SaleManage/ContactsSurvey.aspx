<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactsSurvey.aspx.cs" Inherits="qpoa.ContactsSurvey" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      客户名称：<input id="jsname" type="text"  style="width: 348px"/>\
                        <br>  联&nbsp;&nbsp;系&nbsp;&nbsp;人：<input id="jskhrealname" type="text"   style="width: 138px"/>&nbsp;客服人员：<input id="jsrealname" type="text"   style="width: 138px"/>\
...
midSql=midSql+"Realname="+document.getElementById('jsrealname').value+"";
    ...
    window.location="ContactsSurvey.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ContactsSurvey_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ContactsSurvey_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  客户忠诚度管理  >>  满意度调查</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='ContactsSurvey.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">满意度调查</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Realname" HeaderText="客服人员" SortExpression="Realname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
