<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisCustomer_cpxs_dc.aspx.cs" Inherits="qpoa.SaleManage.AnalysisCustomer_cpxs_dc" %>
...
<body>
    ...
    <asp:GridView style="FONT-SIZE: 12px" id="GridView1" runat="server" Width="100%" PageSize="12" CellSpacing="2" CellPadding="4" BorderWidth="1px" BorderStyle="Solid" BorderColor="#999999" BackColor="#CCCCCC" AutoGenerateColumns="False" AllowSorting="True" OnRowDataBound="GridView1_RowDataBound" ForeColor="Black">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="UnitMoney" HeaderText="单价">
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False"  />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ManyNum" HeaderText="数量">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False"  />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="AllMoney" HeaderText="总价">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False"  />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SaleTime" HeaderText="销售日期" DataFormatString="{0:d}" HtmlEncode="False">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False"  />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SaleRealname" HeaderText="销售人员">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False"  />
                                    </asp:BoundField>
