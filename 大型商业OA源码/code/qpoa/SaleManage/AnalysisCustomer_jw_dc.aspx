<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisCustomer_jw_dc.aspx.cs" Inherits="qpoa.SaleManage.AnalysisCustomer_jw_dc" %>
...
<body>
    ...
    <asp:GridView style="FONT-SIZE: 12px" id="GridView1" runat="server" Width="100%" PageSize="12" CellSpacing="2" CellPadding="4" BorderWidth="1px" BorderStyle="Solid" BorderColor="#999999" BackColor="#CCCCCC" AutoGenerateColumns="False" AllowSorting="True" ForeColor="Black">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Startime" HeaderText="交往开始时间">
                                        <ItemStyle HorizontalAlign="Center"  />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False"  />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Endtime" HeaderText="交往结束时间">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False"  />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Content" HeaderText="交往内容">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False"  />
                                    </asp:BoundField>
