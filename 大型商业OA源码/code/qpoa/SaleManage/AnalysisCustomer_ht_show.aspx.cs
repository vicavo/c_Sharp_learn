...
{
    public partial class AnalysisCustomer_ht_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string SQL_GetList = "select * from qp_SaleContract where id='" + List.GetFormatStr(Request.QueryString["showid"]) + "'";
                ...
                InsertLog("查看销售合同[" + Name.Text + "]", "客户综合信息");
        ...
        {
            Response.Redirect("AnalysisCustomer_ht.aspx?id="+Request.QueryString["id"]+"");
        }
