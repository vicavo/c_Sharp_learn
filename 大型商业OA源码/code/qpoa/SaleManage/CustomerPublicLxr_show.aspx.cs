...
{
    public partial class CustomerPublicLxr_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                InsertLog("查看联系人信息[" + Name.Text + "]", "客户信息管理");
        ...
        //{
        //    Response.Redirect("CustomerPublicLxr.aspx?KeyId=" + Request.QueryString["KeyId"] + "");
        //}
