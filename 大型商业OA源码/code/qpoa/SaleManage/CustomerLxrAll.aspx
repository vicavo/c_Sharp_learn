<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLxrAll.aspx.cs" Inherits="qpoa.CustomerLxrAll" %>
...
function chksearchstr()
{
    ...
    window.location="CustomerLxrAll.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CustomerLxrAll_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CustomerLxrAll_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 客户联系人管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               <button class="btn4on" onclick="javascript:window.location='CustomerLxrAll.aspx';showwait();"
                                    type="button">
