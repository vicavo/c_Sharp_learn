...
{
    public partial class AnalysisCustomer_jw_show : System.Web.UI.Page
    {
        Db List = new Db();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string SQL_GetList = "select * from qp_ContactsLog where id='" + List.GetFormatStr(Request.QueryString["showid"]) + "'";
        ...
        {
            Response.Redirect("AnalysisCustomer_jw.aspx?id=" + List.GetFormatStr(Request.QueryString["id"]) + "");
        }
