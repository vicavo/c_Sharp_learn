<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLxrAll_show.aspx.cs" Inherits="qpoa.SaleManage.CustomerLxrAll_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                        <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>  <a href=CustomerLxrAll.aspx class="line_b">客户联系人</a> >> 查看联系人信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                           ...
                           <tr class="" id="nextrs1">
                            ...
                            <tr  class="" id="Tr2">
                             ...
                             <tr  id="printshow3">
                                <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                    	<div align="center">
                                            <input id="Button1" class="button_blue" onclick="history.back()" type="button" value="返 回" />&nbsp;</div> </td>
                            </tr>
