...
{
    public partial class SupplierProFw : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SupplierProFw_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SupplierProFw_add.aspx");
        }
        ...
        {
            Response.Redirect("SupplierProFw_show.aspx?id=" + CheckCbxUpdate() + "");
        }
