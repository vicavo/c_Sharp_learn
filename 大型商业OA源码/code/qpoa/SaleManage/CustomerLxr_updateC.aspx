<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLxr_updateC.aspx.cs" Inherits="qpoa.SaleManage.CustomerLxr_updateC" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>  <a href=CustomerLxrAll.aspx class="line_b">客户联系人</a> >> 修改联系人信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                           ...
                           <tr class="" id="nextrs1">
                            ...
                            <tr  class="" id="Tr2">
                             ...
                             <tr  id="printshow3">
                                ...
                                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<input id="Button3" class="button_blue" onclick="history.back()"
...
wName_1=window.showModalDialog("../OpenWindows/open_Customer.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:400px;DialogHeight=480px;status:no;scroll=yes;help:no");                
