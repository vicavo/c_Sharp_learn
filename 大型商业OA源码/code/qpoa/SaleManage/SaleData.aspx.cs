...
{
    public partial class SaleData : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "ffff7bb", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "ffff7bd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "ffff7be", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "ffff7bi", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_SaleData where type='" + Request.QueryString["type"] + "' and  1=1";
            SqlStrStartCount = "select count(id) from qp_SaleData where type='" + Request.QueryString["type"] + "' and 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_SaleData where type='"+Request.QueryString["type"]+"'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_SaleData where type='" + Request.QueryString["type"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SaleData  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除数据字典[" + CheckCbxNameDel() + "]", "销售管理-基础数据字典-" + typename + "");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SaleData_update.aspx?type="+type+"&id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SaleData_add.aspx?type=" + type + "&");
        }
