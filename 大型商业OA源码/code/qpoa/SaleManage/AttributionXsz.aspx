<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttributionXsz.aspx.cs" Inherits="qpoa.SaleManage.AttributionXsz" %>
...
midSql=midSql+"&Endtime="+document.getElementById('jsendtime').value+"";
    ...
    window.location="AttributionXsz.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  客户综合分析  >>  客户归属分析   >>  销售组统计</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AttributionXsz.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">销售组统计</font></button>
                    ...
                    <td valign="top" style="height: 179px">
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="用户销售组">
                                        <ItemStyle HorizontalAlign="left" Wrap="True" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                               <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "GroupName")%>'></asp:Label>
