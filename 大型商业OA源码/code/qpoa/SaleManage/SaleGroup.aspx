<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleGroup.aspx.cs" Inherits="qpoa.SaleManage.qp_SaleGroup" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                       名称：<input id="jsgroupname" type="text" />负责人：<input id="jsrealname" type="text" /><br>\
                       组员：<input id="jsgrouprealname" type="text" style="width: 318px"/><br>\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsgrouprealname').value!='')
    {
    midSql=midSql+"GroupRealname="+document.getElementById('jsgrouprealname').value+"";
    } 
    
    
     showwait();	
    window.location="SaleGroup.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 销售组维护</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='SaleGroup.aspx';showwait();">
                                    <font class="shadow_but">销售组</font></button>
                            </td>
                                    ...
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "GroupName") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="GroupName" HeaderText="销售组名称" SortExpression="GroupName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Realname" HeaderText="负责人" SortExpression="Realname">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="GroupRealname" HeaderText="组员" SortExpression="GroupRealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
