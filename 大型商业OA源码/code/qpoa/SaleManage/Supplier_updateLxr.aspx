<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier_updateLxr.aspx.cs" Inherits="qpoa.SaleManage.Supplier_updateLxr" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      供应商：<input id="jsname" type="text" />&nbsp;姓名：<input id="jskhrealname" type="text" />\
...
function chksearchstr()
{
    ...
    window.location="Supplier_updateLxr.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SupplierLxrxg_dc.aspx?KeyId=<%=Request.QueryString["KeyId"] %>&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SupplierLxrxg_dc.aspx?KeyId=<%=Request.QueryString["KeyId"] %>&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> <a href=Supplier.aspx class="line_b">供应商管理</a> >> 查看[<font color=red><%=KhRealnameShow%></font>]联系人信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               <button class="btn4off" onclick="javascript:window.location='Supplier_update.aspx?id=<%=Request.QueryString["KeyId"] %>';showwait();"
                                ...
                                <button class="btn4on" onclick="javascript:window.location='Supplier_updateLxr.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">联系人信息</font></button>
                                 <button class="btn4off" onclick="javascript:window.location='Supplier_updateSp.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">产品信息</font></button>
                            </td>
