...
{
    public partial class SupplierLxr_add : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            Response.Redirect("SupplierLxr.aspx");
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            this.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='SupplierLxr.aspx'</script>");
