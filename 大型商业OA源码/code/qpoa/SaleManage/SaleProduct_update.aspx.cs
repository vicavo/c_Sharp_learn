...
{
    public partial class SaleProduct_update : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string SQL_GetList = "select * from qp_SaleProduct where id='" + List.GetFormatStr(Request.QueryString["id"]) + "'";
                ...
                if (NewReader.Read())
                {
                    ...
                    ManyNum.Text = NewReader["ManyNum"].ToString();
                    UnitMoney.Text = NewReader["UnitMoney"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string Sql_update1 = "Update qp_SaleProduct  Set CpId='" + CpId.Text + "',ProductName='" + ProductName.Text + "',UnitMoney='" + List.GetFormatStr(UnitMoney.Text) + "',ManyNum='" + List.GetFormatStr(ManyNum.Text) + "',AllMoney='" + List.GetFormatStr(AllMoney.Text) + "',KeyId='" + List.GetFormatStr(KeyId.Text) + "',CustomerName='" + List.GetFormatStr(CustomerName.Text) + "',SaleTime='" + List.GetFormatStr(SaleTime.Text) + "',SaleUsername='" + List.GetFormatStr(SaleUsername.Text) + "',SaleRealname='" + List.GetFormatStr(SaleRealname.Text) + "',Remark='" + List.GetFormatStr(Remark.Text) + "' where id='" + int.Parse(Request.QueryString["id"]) + "'";
            List.ExeSql(Sql_update1);



            InsertLog("修改销售记录－常规产品[" + ProductName.Text + "]", "销售记录－常规产品");
