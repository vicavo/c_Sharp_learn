<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisCustomer_myd_show.aspx.cs" Inherits="qpoa.SaleManage.AnalysisCustomer_myd_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom" style="height: 24px"><a href="../main_d.aspx"  class="line_b">工作台</a> >>  <a href="AnalysisCustomer.aspx"  class="line_b">客户综合信息</a> >> <a href="AnalysisCustomer_myd.aspx?id=<%=Request.QueryString["id"] %>"  class="line_b">满意度调查</a> >> 查看满意度调查</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
