...
{
    public partial class Supplier_updateLxr_add : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql_insert = "insert into qp_SupplierLxr (KeyId,Number,Name,KhRealname,LxrPost,Sex,BothDay,Lovly,JtZipCode,JtAddress,GzTel,JtTel,MoveTel,Email,QqNumber,MsnNumber,Remark,Username,Realname,Unit,UnitId,Respon,ResponId,GroupName,GroupId,NowTimes) values ('" + List.GetFormatStr(KeyId.Text) + "','" + List.GetFormatStr(Number.Text) + "','" + List.GetFormatStr(Name.Text) + "','" + List.GetFormatStr(KhRealname.Text) + "','" + List.GetFormatStr(LxrPost.Text) + "','" + List.GetFormatStr(Sex.SelectedValue) + "','" + List.GetFormatStr(BothDay.Text) + "','" + List.GetFormatStr(Lovly.Text) + "','" + List.GetFormatStr(JtZipCode.Text) + "','" + List.GetFormatStr(JtAddress.Text) + "','" + List.GetFormatStr(GzTel.Text) + "','" + List.GetFormatStr(JtTel.Text) + "','" + List.GetFormatStr(MoveTel.Text) + "','" + List.GetFormatStr(Email.Text) + "','" + List.GetFormatStr(QqNumber.Text) + "','" + List.GetFormatStr(MsnNumber.Text) + "','" + List.GetFormatStr(Remark.Text) + "','" + this.Session["Username"] + "','" + this.Session["Realname"] + "','" + this.Session["Unit"] + "','" + this.Session["UnitId"] + "','" + this.Session["Respon"] + "','" + this.Session["ResponId"] + "','" + this.Session["GroupName"] + "','" + this.Session["GroupId"] + "','" + System.DateTime.Now.ToString() + "')";
