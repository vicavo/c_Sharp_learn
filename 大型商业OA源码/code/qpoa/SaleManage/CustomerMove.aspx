<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMove.aspx.cs" Inherits="qpoa.SaleManage.CustomerMove" %>
...
function chksearchstr()
{
    ...
    window.location="CustomerMove.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 客户管理 >>  客户转移 >>  按结果转移</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 80%;">
                              <button class="btn4on6k" onclick="javascript:window.location='CustomerMove.aspx';showwait();" type="button"><font class="shadow_but">按结果转移</font></button>&nbsp;
                              ...
                              <td style="height: 26px" align="right" > 
                                  <img id="IMG1" runat="server" border="0" onclick="UploadComplete()" src="../images/button_search.jpg" /></td>
                        </tr>
                    </table>
                    </div>
                </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div id="Div1" >
                            ...
                            <tr>
                                <td valign="top">
                                    将选择项转移到用户：  <asp:TextBox ID="Realname" runat="server" Width="19%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser();" alt="" src="../images/FDJ.gif" border="0"></A>
