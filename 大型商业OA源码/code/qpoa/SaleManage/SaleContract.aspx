<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleContract.aspx.cs" Inherits="qpoa.SystemManage.SaleContract" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      客户名称：<input id="jsname" type="text"  style="width: 158px"/>合同名称：<input id="jscontractname" type="text"  style="width: 138px"/>\
                        <br>  合同编号：<input id="jscontractnum" type="text"   style="width: 138px"/>&nbsp;合同类型：<input id="jscontracttype" type="text"   style="width: 138px"/><A href="javascript:void(0)"><IMG onclick="OpenSaleData11()" src="../images/FDJ.gif" border="0"></A>\
...
if(document.getElementById('jscontractname').value!='')
{
midSql=midSql+"&ContractName="+document.getElementById('jscontractname').value+"";
}  


if(document.getElementById('jscontractnum').value!='')
{
midSql=midSql+"ContractNum="+document.getElementById('jscontractnum').value+"";
}

if(document.getElementById('jscontracttype').value!='')
{
midSql=midSql+"ContractType="+document.getElementById('jscontracttype').value+"";
}
  
    showwait();
    	
    window.location="SaleContract.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SaleContract_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SaleContract_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  销售管理  >>  销售合同</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='SaleContract.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">销售合同</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ContractName") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                   ...
                                   <asp:BoundField DataField="Name" HeaderText="客户名称" SortExpression="Name">
                                    ...
                                    <asp:BoundField DataField="ContractName" HeaderText="合同名称" SortExpression="ContractName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
