<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierFwPro_update.aspx.cs" Inherits="qpoa.SaleManage.SupplierFwPro_update" %>
...
function chknull()
{
    ...
    if(document.getElementById('FwName').value=='')
    {
    alert('服务名称不能为空');
    form1.FwName.focus();
    return false;
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 产品信息管理 >> <a href="SupplierFwPro.aspx"  class="line_b">服务型产品管理</a> >> 修改服务型产品信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="17" width="33%">
                                    <asp:TextBox ID="FwName" runat="server" Width="90%"></asp:TextBox>
                                    </td>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                    服务收费标准：</td>
                                <td class="newtd2" height="17" width="35%">
                                    <asp:TextBox ID="FwMoney" runat="server" Width="90%"></asp:TextBox>
                                    </td>
                            </tr>
...
wName_1=window.showModalDialog("../OpenWindows/open_SupplierPublic.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:400px;DialogHeight=480px;status:no;scroll=yes;help:no");                
