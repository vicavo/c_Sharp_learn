<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLxr.aspx.cs" Inherits="qpoa.SaleManage.CustomerLxr" %>
...
function chksearchstr()
{
    ...
    window.location="CustomerLxr.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CustomerLxr_dc.aspx?KeyId=<%=Request.QueryString["KeyId"] %>&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CustomerLxr_dc.aspx?KeyId=<%=Request.QueryString["KeyId"] %>&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               <button class="btn4off" onclick="javascript:window.location='Customer_show.aspx?id=<%=Request.QueryString["KeyId"] %>';showwait();"
                                    type="button">
                                    <font class="shadow_but">客户信息</font></button>
                                <button class="btn4on" onclick="javascript:window.location='CustomerLxr.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">联系人信息</font></button>
