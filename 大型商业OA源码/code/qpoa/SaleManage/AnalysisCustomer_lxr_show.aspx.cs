...
{
    public partial class AnalysisCustomer_lxr_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                InsertLog("查看联系人信息[" + Name.Text + "]", "客户综合信息");
        ...
        {
            Response.Redirect("AnalysisCustomer_lxr.aspx?id=" + Request.QueryString["id"] + "");
        }
