<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttributionYwy.aspx.cs" Inherits="qpoa.SaleManage.AttributionYwy" %>
...
midSql=midSql+"&Endtime="+document.getElementById('jsendtime').value+"";
    ...
    window.location="AttributionYwy.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  客户综合分析  >>  客户归属分析   >>  业务员统计</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AttributionYwy.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">业务员统计</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="业务员">
                                        ...
                                        <ItemTemplate>
                                               <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "realname")%>'></asp:Label>
                                             <asp:Label ID="Label1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "username")%>' Visible=false></asp:Label>
                                        </ItemTemplate>
