...
{
    public partial class AnalysisCustomer_hf_show : System.Web.UI.Page
    {
        Db List = new Db();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string SQL_GetList = "select * from qp_ContactsVisit where id='" + List.GetFormatStr(Request.QueryString["showid"]) + "'";
                ...
                NewReader.Close();
                InsertLog("查看客户回访记录[" + Name.Text + "]", "客户综合信息");
        ...
        {
            Response.Redirect("AnalysisCustomer_hf.aspx?id="+Request.QueryString["id"]+"");
        }
