...
{
    public partial class Supplier_updateLxr : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Supplier_updateLxr_update.aspx?KeyId=" + Request.QueryString["KeyId"] + "&id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Supplier_updateLxr_add.aspx?KeyId=" + Request.QueryString["KeyId"] + "");
        }
        ...
        {
            Response.Redirect("Supplier_updateLxr_show.aspx?KeyId=" + Request.QueryString["KeyId"] + "&id=" + CheckCbxUpdate() + "");
        }
