<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierSpxg.aspx.cs" Inherits="qpoa.SaleManage.SupplierSpxg" %>
...
function chksearchstr()
{
    ...
    window.location="SupplierSpxg.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&key=1&"+midSql+"";
}
      ...
      <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
             ...
             <button class="btn4off" onclick="javascript:window.location='Supplier_show.aspx?id=<%=Request.QueryString["KeyId"] %>';showwait();"
                                    type="button">
                                    <font class="shadow_but">供应商信息</font></button>
                                <button class="btn4off" onclick="javascript:window.location='SupplierLxrxg.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">联系人信息</font></button>
                                 <button class="btn4on" onclick="javascript:window.location='SupplierSpxg.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">产品信息</font></button>
                            </td>
