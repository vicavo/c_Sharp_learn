...
{
    public partial class SupplierSp : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SupplierSp_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SupplierSp_add.aspx");
        }
        ...
        {
            Response.Redirect("SupplierSp_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void Button2_Click(object sender, EventArgs e)
        {
            Response.Redirect("SupplierSp.aspx");
        }
