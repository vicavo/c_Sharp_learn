<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServicesLog.aspx.cs" Inherits="qpoa.SaleManage.ServicesLog" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;客&nbsp;&nbsp;户&nbsp;&nbsp;名&nbsp;&nbsp;称：<input id="jsname" type="text"  style="width: 138px"/>&nbsp;联&nbsp;&nbsp;&nbsp;&nbsp;系&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;人：<input id="jskhrealname" type="text"  style="width: 138px"/>\
                         <br> &nbsp;&nbsp;&nbsp;交往开始时间：<input id="jsstartime"  type="text"   style="width: 138px"/>&nbsp;交往结束时间：<input id="jsendtime" type="text"   style="width: 138px"/>格式yyyy-mm-dd\
                          <br>  &nbsp;&nbsp;&nbsp;服&nbsp;&nbsp;务&nbsp;&nbsp;方&nbsp;&nbsp;式：<input id="jsservicestype" type="text"   style="width: 138px"/><A href="javascript:void(0)"><IMG onclick="OpenSaleData8()" src="../images/FDJ.gif" border="0"></A>&nbsp;满&nbsp;&nbsp;意&nbsp;&nbsp;度：<input id="jssatisfaction" type="text"   style="width: 138px"/>\
...
if(document.getElementById('jsservicestype').value!='')
{
midSql=midSql+"ServicesType="+document.getElementById('jsservicestype').value+"";
}



if(document.getElementById('jssatisfaction').value!='')
{
midSql=midSql+"&Satisfaction="+document.getElementById('jssatisfaction').value+"";
}  
...
midSql=midSql+"&Endtime="+document.getElementById('jsendtime').value+"";
    ...
    window.location="ServicesLog.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ServicesLog_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ServicesLog_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
...
var num=Math.random();
var str=document.getElementById("jsservicestype").value;
...
{
document.getElementById("jsservicestype").value=wName3; 
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 客户管理 >>  客户服务</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='ServicesLog.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">客户服务</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="KhRealname" HeaderText="客户联系人" SortExpression="KhRealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ServicesType" HeaderText="服务方式" SortExpression="ServicesType">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Startime" HeaderText="交往开始时间" SortExpression="Startime">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Endtime" HeaderText="交往结束时间" SortExpression="Endtime">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
