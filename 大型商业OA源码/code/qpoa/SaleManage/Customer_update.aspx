<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer_update.aspx.cs" Inherits="qpoa.SaleManage.Customer_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Customer.aspx"  class="line_b">客户信息管理</a> >> 修改客户信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="24" width="33%" colspan="3">
                                    <asp:DropDownList ID="Sharing" runat="server" Width="90%" AutoPostBack="True">
                           ...
                           <tr class="" id="nextrs1">
                            ...
                            <tr  class="" id="Tr5">
                             ...
                             <tr  id="printshow3">
                                ...
                                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                                            <input id="Button2" class="button_blue" onclick="history.back()" type="button" value="返 回" /></FONT></div> </td>
                            </tr>
