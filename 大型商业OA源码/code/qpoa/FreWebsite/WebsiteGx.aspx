<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebsiteGx.aspx.cs" Inherits="qpoa.FreWebsite.WebsiteGx" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      网址名：<input id="jsname" type="text" />共享人：<input id="jsrealname" type="text" />\
...
function chksearchstr()
{
   ...
   showwait();	
    window.location="WebsiteGx.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 共享网址</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Website.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">我的网址</font></button>
                                <button class="btn4on" onclick="javascript:window.location='WebsiteGx.aspx';showwait();" type="button"><font class="shadow_but">共享网址</font></button>
                            </td>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Realname" HeaderText="共享人" SortExpression="Realname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
