<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalariesAddSet_add_Jbupdate.aspx.cs" Inherits="qpoa.HumanResources.SalariesAddSet_add_Jbupdate" %>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><table width="100%" height="23" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td>
              人员薪资修改::::此处的修改，只针对此次的薪资录入，不影响帐套设置</td>
        </tr>
      </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="17" width="35%">
                                    <asp:TextBox ID="Unit" runat="server" Width="90%" ReadOnly="True"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="17%">
                                ...
                                <td class="newtd2" colspan="3" height="17">
                                    <asp:TextBox ID="JbMoney" runat="server" Width="95%"></asp:TextBox></td>
                            </tr>
