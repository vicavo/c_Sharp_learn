...
{
    public partial class SalariesSet : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(IMG2, "eeee8b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "eeee8b", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            if (List.StrIFInStr("eeee8b", Session["perstr"].ToString()))
            {
                string SQL_GetCount = "select count(id) from  qp_SalariesSet  ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_SalariesSet   " + Sqlsort + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SalariesSet   where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除帐套[" + CheckCbxNameDel() + "]", "帐套管理");
