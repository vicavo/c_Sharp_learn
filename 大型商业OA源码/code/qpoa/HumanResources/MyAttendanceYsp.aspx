<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAttendanceYsp.aspx.cs" Inherits="qpoa.HumanResources.MyAttendanceYsp" %>
...
window.location="MyAttendanceYsp.aspx?type=<%=Request.QueryString["Type"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MyAttendanceSp_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MyAttendanceSp_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  考勤管理  >>  <%=Typename%></td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='MyAttendanceSp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"type="button"><font class="shadow_but">未审批</font></button>
                                <button class="btn4on" onclick="javascript:window.location='MyAttendanceYsp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();" type="button"><font class="shadow_but">已审批</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                   ...
                                   　　　 <HeaderTemplate>
                                      ...
                                      <asp:BoundField DataField="Realname" HeaderText="登记人" SortExpression="Realname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                  
                                      <asp:TemplateField HeaderText="操作">
                                        <ItemStyle HorizontalAlign="Center" Width="60px" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Width="60px" />
                                        <ItemTemplate>
                                            <a href="MyAttendanceYsp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>&type=<%=Request.QueryString["Type"] %> ">查看</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
