<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalariesSet_add_jjcp_update.aspx.cs" Inherits="qpoa.HumanResources.SalariesSet_add_jjcp_update" %>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    ...
                                    规格型号：</td>
                                <td class="newtd2" height="17" width="33%">
                                    <asp:TextBox ID="Modle" runat="server" Width="90%"></asp:TextBox></td>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    style="color: #000000" width="15%">
                                    计件单价：</td>
                                <td class="newtd2" height="17" width="35%">
