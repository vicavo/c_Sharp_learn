...
{
    public partial class SaPieces : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "eeee6cb", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "eeee6cc", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "eeee6cd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "eeee6ce", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "eeee6ci", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "eeee6cf", Session["perstr"].ToString());
        ...
        {
            if (List.StrIFInStr("eeaee6c1", Session["perstr"].ToString()))
            {
                SqlStrStart = "select * from qp_SaXzPieces  where 1=1";
                SqlStrStartCount = "select count(id) from qp_SaXzPieces  where 1=1";
            }
            ...
            else
            {
                ...
                if (List.StrIFInStr("eeaee6c1", Session["perstr"].ToString()))
                {
                    string SQL_GetCount = "select count(id) from  qp_SaXzPieces  ";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                    string SQL_GetList_xs = "select * from qp_SaXzPieces   " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SaXzPieces   where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除计时工种[" + CheckCbxNameDel() + "]", "计时工种");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SaXzPieces_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SaXzPieces_add.aspx");
        }
        ...
        {
            Response.Redirect("SaXzPieces_show.aspx?id=" + CheckCbxUpdate() + "");
        }
