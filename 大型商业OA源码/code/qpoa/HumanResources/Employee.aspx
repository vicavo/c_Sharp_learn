<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="qpoa.HumanResources.Employee" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                   &nbsp;&nbsp;&nbsp;人员姓名：<input id="jsRealname" type="text"   style="width: 138px"/>&nbsp;&nbsp;部门名称：<input id="jsUnit" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                   <br>&nbsp;&nbsp;&nbsp;职位名称：<input id="jsPost" type="text"   style="width: 138px"/>&nbsp;&nbsp;在岗状态：<input id="jsStardType" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                   <br>&nbsp;&nbsp;&nbsp;政治面貌：<input id="jsPolitics" type="text"   style="width: 138px"/>&nbsp;&nbsp;学历情况：<input id="jsSchoolrecord" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
{
midSql=midSql+"Realname="+document.getElementById('jsRealname').value+"";
}
...
if(document.getElementById('jsStardType').value!='')
{
midSql=midSql+"StardType="+document.getElementById('jsStardType').value+"";
}



if(document.getElementById('jsPolitics').value!='')
{
midSql=midSql+"&Politics="+document.getElementById('jsPolitics').value+"";
}  


if(document.getElementById('jsSchoolrecord').value!='')
{
midSql=midSql+"&Schoolrecord="+document.getElementById('jsSchoolrecord').value+"";
} 
 
showwait();

window.location="Employee.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("Employee_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("Employee_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  人事档案  >>  人事档案管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Employee.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">人事档案</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="部门名称" SortExpression="Unit">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("Unit").ToString().Replace("-", "").Replace("|", "")))%>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>
