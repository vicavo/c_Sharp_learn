<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyAttendanceSp.aspx.cs"
    Inherits="qpoa.HumanResources.MyAttendanceSp" %>
...
window.location="MyAttendanceSp.aspx?type=<%=Request.QueryString["Type"]%>&key=1&"+midSql+"";
}
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 考勤管理 >>
                                                            <%=Typename%>
                                                        </td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4on" onclick="javascript:window.location='MyAttendanceSp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4off" onclick="javascript:window.location='MyAttendanceYsp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">已审批</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="MyAttendanceSp_sp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>&type=<%=Request.QueryString["Type"] %> ">
                                                                                审批</a>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
