...
{
    public partial class SaXzPieces_update : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string SQL_GetList = "select * from qp_SaXzPieces  where id='" + List.GetFormatStr(Request.QueryString["id"]) + "'";
        ...
        {
            Response.Redirect("SaXzPieces.aspx");
        }
