...
{
    public partial class SalariesSet_add_xzxm : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(GridView1, "eeee8b", Session["perstr"].ToString());
        ...
        {
            string SQL_GetCount = "select count(id) from  qp_SaProduct where  (SaNumber='" + Request.QueryString["number"]+ "')";
            CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

            string SQL_GetList_xs = "select * from qp_SaProduct where (SaNumber='" + Request.QueryString["number"] + "') " + Sqlsort + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SaProduct  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除薪资项目[" + CheckCbxNameDel() + "]", "帐套管理");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "shangyi")
            {
                ...
                string SQL_GetList = "select top 1 * from qp_SaProduct  where Paixun<" + PaiXunId.ToString() + "  and SaNumber='" + Request.QueryString["number"] + "' order by paixun desc";
                ...
                if (NewReader.Read())
                {
                    ...
                    string Sql_update_n = "Update qp_SaProduct   Set Paixun='" + NewReader["PaiXun"].ToString() + "'  where Paixun='" + PaiXunId.ToString() + "'";
                    List.ExeSql(Sql_update_n);


                    string Sql_update_s = "Update qp_SaProduct   Set Paixun='" + PaiXunId.ToString() + "'  where id='" + NewReader["id"].ToString() + "'";
            ...
            if (e.CommandName == "xiayi")
            {
                ...
                string SQL_GetList = "select top 1 * from qp_SaProduct  where Paixun>" + PaiXunId.ToString() + "  and  SaNumber='" + Request.QueryString["number"] + "' order by paixun asc";
                SqlDataReader NewReader = List.GetList(SQL_GetList);
                if (NewReader.Read())
                {
