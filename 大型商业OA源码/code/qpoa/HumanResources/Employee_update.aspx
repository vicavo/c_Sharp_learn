<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_update.aspx.cs" Inherits="qpoa.HumanResources.Employee_update" %>
...
window.open ("../SystemManage/username_add_down.aspx?tmp="+num+"&number="+cValue+"", "_blank", "height=1, width=1,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
}
...
window.showModalDialog("../SystemManage/username_add_del.aspx?tmp="+num+"&number="+cValue+" ","window","dialogWidth:1000px;DialogHeight=600px;status:no;scroll=yes;help:no");                
}
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Employee.aspx"  class="line_b">档案管理</a> >> 修改人事档案</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
