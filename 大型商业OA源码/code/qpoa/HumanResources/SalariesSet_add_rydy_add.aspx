<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalariesSet_add_rydy_add.aspx.cs" Inherits="qpoa.HumanResources.SalariesSet_add_rydy_add" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
			    ...
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 588px; height: 49px">
                    ...
                    <tr>
                        <td>
                            基本工资：<asp:TextBox ID="JbMoney" runat="server" Width="503px"></asp:TextBox></td>
                    </tr>
