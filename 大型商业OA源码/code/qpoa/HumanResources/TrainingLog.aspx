<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingLog.aspx.cs" Inherits="qpoa.HumanResources.TrainingLog" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                   &nbsp;&nbsp;&nbsp;参与职员：<input id="jsStaffName" type="text"   style="width: 138px"/>&nbsp;&nbsp;培训项目：<input id="jsTrainingPro" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                  <br> &nbsp;&nbsp;&nbsp;培训单位：<input id="jsTrainingCompany" type="text" style="width: 138px"/>&nbsp;&nbsp;开始日期：<input id="jsStarttime" type="text"   style="width: 138px"/>日期格式yyyy-mm-dd&nbsp;&nbsp;\
...
if(document.getElementById('jsTrainingPro').value!='')
{
midSql=midSql+"&TrainingPro="+document.getElementById('jsTrainingPro').value+"";
}  
 
 
if(document.getElementById('jsTrainingCompany').value!='')
{
midSql=midSql+"&TrainingCompany="+document.getElementById('jsTrainingCompany').value+"";
}  

 
if(document.getElementById('jsStarttime').value!='')
{
var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
if(!objRe.test(document.getElementById('jsStarttime').value))
{
...
midSql=midSql+"&Starttime="+document.getElementById('jsStarttime').value+"";
}  
...
window.location="TrainingLog.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("TrainingLog_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("TrainingLog_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  培训记录 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='TrainingLog.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">培训记录</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TrainingPro" HeaderText="培训项目" SortExpression="TrainingPro">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                 
                                    <asp:BoundField DataField="StaffName" HeaderText="参与职员" SortExpression="StaffName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>  
