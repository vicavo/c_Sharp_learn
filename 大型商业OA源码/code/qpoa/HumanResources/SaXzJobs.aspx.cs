...
{
    public partial class SaXzJobs : System.Web.UI.Page
    {
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            {
                SqlStrStart = "select * from qp_SaXzJobs  where 1=1";
                SqlStrStartCount = "select count(id) from qp_SaXzJobs  where 1=1";
            }
            ...
            else
            {
                ...
                if (List.StrIFInStr("eeaee6c1", Session["perstr"].ToString()))
                {
                    string SQL_GetCount = "select count(id) from  qp_SaXzJobs  ";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                    string SQL_GetList_xs = "select * from qp_SaXzJobs   " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SaXzJobs   where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SaXzJobs_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SaXzJobs_add.aspx");
        }
        ...
        {
            Response.Redirect("SaXzJobs_show.aspx?id=" + CheckCbxUpdate() + "");
        }
