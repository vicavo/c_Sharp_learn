<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalariesAddYsp.aspx.cs" Inherits="qpoa.HumanResources.SalariesAddYsp" %>
...
{
var num=Math.random();
window.open ("SalariesAddSet.aspx?tmp="+num+"&id="+str+"", "_blank", "height=650, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=100,left=120")
}
...
{
var num=Math.random();
window.open ("SalariesAddSet.aspx?tmp="+num+"", "_blank", "height=650, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=100,left=120")
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  薪资管理  >>  薪资录入</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='SalariesAdd.aspx';showwait();"type="button"><font class="shadow_but">未审批</font></button>
                             <button class="btn4on" onclick="javascript:window.location='SalariesAddYsp.aspx';showwait();"type="button"><font class="shadow_but">已审批</font></button>
                    
                            </td>
                              <td style="height: 26px" align="right" > <img onclick="addfrom()" src="../images/button_add.jpg"  border=0 id="IMG2" runat="server"/></td>
                        </tr>
                    </table>
                    </div>
                </td>
                        ...
                        <div id="Div1" >
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="薪资名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   
                                                                  
                                    <asp:TemplateField HeaderText="对应年月">
                                        <ItemStyle HorizontalAlign="Center" Wrap="True" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <%# DataBinder.Eval(Container.DataItem, "DyYear") %>年<%# DataBinder.Eval(Container.DataItem, "DyMonth") %>月
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    
                                    <asp:BoundField DataField="SaName" HeaderText="帐套名称" SortExpression="SaName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="SpRealname" HeaderText="审批人" SortExpression="SpRealname">
                                     ...
                                     <asp:TemplateField HeaderText="查看">
                                        ...
                                        <ItemTemplate>
                                            <a href='javascript:void(0)' onclick='window.open ("SalariesAddSet_show.aspx?Number=<%# DataBinder.Eval(Container.DataItem, "Number") %>", "_blank", "height=650, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=100,left=120")'>明细</a>
                                        </ItemTemplate>
