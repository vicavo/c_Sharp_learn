<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaXzJobs_show.aspx.cs" Inherits="qpoa.HumanResources.SaXzJobs_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; <a href="SaXzPieces.aspx"  class="line_b">计时工种</a> >>&nbsp; 查看计时工种</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
