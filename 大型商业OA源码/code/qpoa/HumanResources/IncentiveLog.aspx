<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncentiveLog.aspx.cs" Inherits="qpoa.HumanResources.IncentiveLog" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                   &nbsp;&nbsp;&nbsp;奖惩职员：<input id="jsStaffName" type="text"   style="width: 138px"/>&nbsp;&nbsp;奖惩区分：<input id="jsType" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                  <br> &nbsp;&nbsp;&nbsp;授予单位：<input id="jsUnit" type="text" style="width: 138px"/>&nbsp;&nbsp;奖惩日期：<input id="jsSetTime" type="text"   style="width: 138px"/>日期格式yyyy-mm-dd&nbsp;&nbsp;\
                   <br> &nbsp;&nbsp;&nbsp;奖惩名目：<input id="jsJcNames" type="text" style="width: 138px"/>&nbsp;&nbsp;奖惩原因：<input id="jsReasons" type="text"   style="width: 138px"/>\
...
if(document.getElementById('jsStaffName').value!='')
{
midSql=midSql+"StaffName="+document.getElementById('jsStaffName').value+"";
}
...
if(document.getElementById('jsJcNames').value!='')
{
midSql=midSql+"&JcNames="+document.getElementById('jsJcNames').value+"";
}  
 
 
if(document.getElementById('jsReasons').value!='')
{
midSql=midSql+"&Reasons="+document.getElementById('jsReasons').value+"";
}  

 
 
 
if(document.getElementById('jsSetTime').value!='')
{
var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
if(!objRe.test(document.getElementById('jsSetTime').value))
{
alert('日期格式不正确，请按照yyyy-mm-dd格式输入');

return false;
}  
midSql=midSql+"&SetTime="+document.getElementById('jsSetTime').value+"";
}  
...
window.location="IncentiveLog.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("IncentiveLog_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("IncentiveLog_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  奖惩记录 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='IncentiveLog.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">奖惩记录</font></button>
                                    ...
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Realname") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Type" HeaderText="奖惩区分" SortExpression="Type">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField> 
                                    <asp:BoundField DataField="Reasons" HeaderText="奖惩原因" SortExpression="Reasons">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   
                                    
                                                                    
                                    <asp:BoundField DataField="StaffName" HeaderText="奖惩职员" SortExpression="StaffName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>  
