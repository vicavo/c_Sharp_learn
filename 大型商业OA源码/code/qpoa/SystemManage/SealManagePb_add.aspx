<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SealManagePb_add.aspx.cs" Inherits="qpoa.SystemManage.SealManagepPb_add" %>
...
//return false;
//}
var sAllowExt = ".gif|.GIF|.jpg|.JPG|.png|.PNG|.bmp|.BMP";
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="SealManagepPb.aspx"  class="line_b">公章维护</a> >> 新增公章维护</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
