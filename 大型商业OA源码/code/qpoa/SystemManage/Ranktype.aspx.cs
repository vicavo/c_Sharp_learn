...
namespace qpoa.SystemManage
{
    public partial class Ranktype : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "iiii1cb", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "iiii1cd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "iiii1ce", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "iiii1ci", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_Ranktype where 1=1";
            SqlStrStartCount = "select count(id) from qp_Ranktype where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_Ranktype";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Ranktype " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Ranktype  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除重要等级[" + CheckCbxNameDel() + "]", "重要等级维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Ranktype_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Ranktype_add.aspx");
        }
        ...
        {
            Response.Redirect("Ranktype_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Ranktype_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
