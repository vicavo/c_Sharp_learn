<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentModle_qx.aspx.cs" Inherits="qpoa.SystemManage.DocumentModle_qx" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                    <br>姓名：<input id="jsrealname" type="text" />&nbsp;部门：<input id="jsunit" type="text" />\
                            <br>角色：<input id="jsrespon" type="text" />&nbsp;职位：<input id="jspost" type="text" />\
...
function chksearchstr()
{
    ...
    window.location="DocumentModle_qx.aspx?id=<%=keyid%>&key=1&"+midSql+"";
}
...
window.showModalDialog('DocumentModle_qx_add.aspx?id='+id+'&tmp='+num+'','window','dialogWidth:505px;DialogHeight=600px;status:no;help=no;scroll=on');window.location='#'
showwait();
window.location="DocumentModle_qx.aspx?id=<%=keyid%>&tmp='+num+";
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="DocumentModle.aspx"  class="line_b">红头文件管理</a> >>红头文件权限设置</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='DocumentModle_qx.aspx?id=<%=keyid %>';showwait();">
                                    <font class="shadow_but">红头文件</font></button>
                            </td>
                              <td style="height: 26px" align="right" > 
                                 <img src="../images/button_add.jpg"  onclick="qxadd('<%=keyid %>')" style="cursor:hand"/>
                     ...
                     <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="17" colspan="3" width="85%">
                                     <asp:Label ID="Name" runat="server" Width="85%"></asp:Label>
                                    <input id="Button3" type="button" value="下载" onclick="down()"/></td>
                            </tr>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Unit" HeaderText="部门名称" SortExpression="Unit">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Respon" HeaderText="角色名称" SortExpression="Respon">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" />
                                    </asp:BoundField>
