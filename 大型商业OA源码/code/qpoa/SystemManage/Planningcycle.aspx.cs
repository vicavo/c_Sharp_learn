...
{
    public partial class Planningcycle : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc1cb", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "cccc1cd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc1ce", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc1ci", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_Planningcycle where 1=1";
            SqlStrStartCount = "select count(id) from qp_Planningcycle where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_Planningcycle";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Planningcycle " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Planningcycle  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除计划周期[" + CheckCbxNameDel() + "]", "计划周期维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Planningcycle_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Planningcycle_add.aspx");
        }
        ...
        {
            Response.Redirect("Planningcycle_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Planningcycle_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
