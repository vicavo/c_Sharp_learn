...
{
    public partial class SealSp : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_YinZhang  where 1=1 and  (State='等待审批') ";
            SqlStrStartCount = "select count(id) from qp_YinZhang  where 1=1 and  (State='等待审批')";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_YinZhang where  (State='等待审批')";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_YinZhang where (State='等待审批')  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
