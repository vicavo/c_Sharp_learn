<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Programtype.aspx.cs" Inherits="qpoa.SystemManage.Programtype" %>
...
function chksearchstr()
{
    ...
    midSql=midSql+"Name="+document.getElementById('jsname').value+"";
     ...
     showwait();	
    window.location="Programtype.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 日程类型维护</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off6k" 
                                    type="button" onclick="javascript:window.location='Programtype.aspx';showwait();">
                                    <font class="shadow_but">日程类型维护</font></button>
                            </td>
