<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="username_qx.aspx.cs" Inherits="qpoa.SystemManage.username_qx" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                     ...
                     <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Username.aspx"  class="line_b">用户管理</a> >> 用户授权</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
      ...
      <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
            ...
            <a href="javascript:void(0)" onclick="checkAll()" class="line">全选</a><a href="javascript:void(0)" onclick="fanAll()" class="line">反选</a>
