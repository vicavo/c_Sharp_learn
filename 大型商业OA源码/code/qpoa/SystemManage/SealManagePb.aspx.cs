...
{
    public partial class SealManagepPb : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            {
                SqlStrStart = "select * from qp_YinZhangPb  and 1=1";
                SqlStrStartCount = "select count(id) from qp_YinZhangPb  and  1=1";
            ...
            else
            {
                if (List.StrIFInStr("iiiia1b", Session["perstr"].ToString()))
                {
                    string SQL_GetCount = "select count(id) from  qp_YinZhangPb  ";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_YinZhangPb " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                }//个人
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                l3.Attributes.Add("onclick", "javascript:return confirm('确认密码重置印章[" + e.Row.Cells[0].Text.ToString() + "]吗？将会重置该印章所有使用人的密码？重置后面密码为：666666')");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ShanChu")
            {
                ...
                string SQL_GetList = "select * from qp_YinZhangPb where id='" + ID + "'";
                ...
                if (NewReader.Read())
                {
                    ...
                    string SqlStr = "  Delete from qp_YinZhangPb where ID='" + ID + "'";
                    List.ExeSql(SqlStr);

                    string SqlStr1 = "  Delete from qp_YinZhang where Number='" + NewReader["Number"] + "'";
                    List.ExeSql(SqlStr1);
            ...
            if (e.CommandName == "Tingzhi")
            {
                ...
                if (NewReader.Read())
                {
                    ...
                    string Sql_update1 = "Update qp_YinZhangPb    Set State='停止' where id='" + ID + "'";
                    List.ExeSql(Sql_update1);


                    string Sql_update2 = "Update qp_YinZhang    Set State='停止' where Number='" + NewReader["Number"] + "'";
                    List.ExeSql(Sql_update2);
            ...
            if (e.CommandName == "Chongzhi")
            {
                ...
                if (NewReader.Read())
                {
                    ...
                    string Sql_update1 = "Update qp_YinZhangPb  Set Password='" + hashPassword + "' where id='" + ID + "'";
                    List.ExeSql(Sql_update1);

                    string Sql_update2 = "Update qp_YinZhang  Set Password='" + hashPassword + "' where Number='" + NewReader["Number"] + "'";
                    List.ExeSql(Sql_update2);
        ...
        {
            Response.Redirect("SealManagePb_add.aspx");
        }
