<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sms_In.aspx.cs" Inherits="qpoa.SystemManage.Sms_In" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                    &nbsp;短信内容：<input id="jsMsg" type="text" />&nbsp;手&nbsp;机&nbsp;号&nbsp;：<input id="jsmbno" type="text" /> \
                         <br>收信时间：<input id="jsArriveTime" type="text" />yyyy-mm-dd\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsArriveTime').value!='')
    {
     var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
    if(!objRe.test(document.getElementById('jsArriveTime').value))
    {
    ...
    midSql=midSql+"&ArriveTime="+document.getElementById('jsArriveTime').value+"";
    }   
	showwait();
    window.location="Sms_In.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  接收短信 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='Sms_In.aspx';showwait();">
                                    <font class="shadow_but">接收短信</font></button>
                            </td>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="mbno" HeaderText="来信手机号" SortExpression="mbno">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                    ...
                                    <asp:BoundField DataField="ArriveTime" HeaderText="收信时间" SortExpression="ArriveTime">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                         <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
