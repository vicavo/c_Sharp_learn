...
{
    public partial class Planningtype : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            SqlStrStart = "select * from qp_Planningtype where 1=1";
            SqlStrStartCount = "select count(id) from qp_Planningtype where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_Planningtype";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Planningtype " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Planningtype  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除计划类型[" + CheckCbxNameDel() + "]", "计划类型维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Planningtype_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Planningtype_add.aspx");
        }
        ...
        {
            Response.Redirect("Planningtype_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Planningtype_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
