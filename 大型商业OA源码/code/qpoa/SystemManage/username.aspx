<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="username.aspx.cs" Inherits="qpoa.SystemManage.username" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      用户名：<input id="jsusername" type="text" />&nbsp;真实姓名：<input id="jsrealname" type="text" />\
                         <br>工&nbsp;&nbsp;&nbsp;号：<input id="jsworknum" type="text" />&nbsp;部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;门：<input id="jsunit" type="text" />\
                            <br>角&nbsp;&nbsp;&nbsp;色：<input id="jsrespon" type="text" />&nbsp;职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：<input id="jspost" type="text" />\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsusername').value!='')
    {
    midSql=midSql+"username="+document.getElementById('jsusername').value+"";
    }
    if(document.getElementById('jsrealname').value!='')
    {
    midSql=midSql+"&realname="+document.getElementById('jsrealname').value+"";
    }  
    if(document.getElementById('jsworknum').value!='')
    {
    midSql=midSql+"&worknum="+document.getElementById('jsworknum').value+"";
    }    
    ...
    window.location="username.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("username_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("username_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 用户管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='username.aspx';showwait();">
                              ...
                              <td style="height: 26px" align="right" > 
                                  ...
                                  <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/images/button_qx.jpg" OnClick="ImageButton5_Click" />
