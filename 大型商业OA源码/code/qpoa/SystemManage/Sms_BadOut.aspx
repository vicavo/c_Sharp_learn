<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sms_BadOut.aspx.cs" Inherits="qpoa.SystemManage.Sms_BadOut" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;发&nbsp;送&nbsp;人&nbsp;：<input id="jsusername" type="text" />&nbsp;手&nbsp;机&nbsp;号&nbsp;：<input id="jsmbno" type="text" /> \
                         <br>&nbsp;短信内容：<input id="jsMsg" type="text" />&nbsp;失败时间：<input id="jsSendTime" type="text" />yyyy-mm-dd\
...
function chksearchstr()
{
	...
	showwait();
    window.location="Sms_BadOut.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("Sms_BadOut_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("Sms_BadOut_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  发送失败短信 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='Sms_BadOut.aspx';showwait();">
                                    <font class="shadow_but">失败短信</font></button>
                            </td>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="mbno" HeaderText="手机号" SortExpression="mbno">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                         <ItemStyle Wrap="False" />
                                    </asp:BoundField>
