<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SealManage.aspx.cs" Inherits="qpoa.SystemManage.SealManage" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                         印章名称：<input id="jsName" type="text"   style="width: 138px"/>&nbsp;印章使用人：<input id="jsRealname" type="text"   style="width: 138px"/>\
...
midSql=midSql+"Realname="+document.getElementById('jsRealname').value+"";
    ...
    window.location="SealManage.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  印章维护 &gt;&gt; 私章维护</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='SealManage.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">私章维护</font></button>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="State" HeaderText="印章状态" SortExpression="State">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='SealManage_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
