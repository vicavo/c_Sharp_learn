<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sms_Out.aspx.cs" Inherits="qpoa.SystemManage.Sms_Out" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;发&nbsp;送&nbsp;人&nbsp;：<input id="jsusername" type="text" />&nbsp;手&nbsp;机&nbsp;号&nbsp;：<input id="jsmbno" type="text" /> \
                         <br>&nbsp;短信内容：<input id="jsMsg" type="text" />&nbsp;计划时间：<input id="jsSendTime" type="text" />yyyy-mm-dd\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsmbno').value!='')
    {
    midSql=midSql+"&mbno="+document.getElementById('jsmbno').value+"";
    }  
    
    if(document.getElementById('jsMsg').value!='')
    {
    midSql=midSql+"&Msg="+document.getElementById('jsMsg').value+"";
    }  
    
      
    if(document.getElementById('jsSendTime').value!='')
    {
     var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
    if(!objRe.test(document.getElementById('jsSendTime').value))
    {
    ...
    midSql=midSql+"&SendTime="+document.getElementById('jsSendTime').value+"";
    }   
	showwait();
    window.location="Sms_Out.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("Sms_Out_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("Sms_Out_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  等待发送短信 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='Sms_Out.aspx';showwait();">
                                    <font class="shadow_but">待发短信</font></button>
                            </td>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="username" HeaderText="发送人" SortExpression="username">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="mbno" HeaderText="待发手机号" SortExpression="mbno">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                         <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Msg" HeaderText="短信内容" SortExpression="Msg">
                                        <ItemStyle />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                         <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SendTime" HeaderText="计划时间" SortExpression="SendTime">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                         <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
