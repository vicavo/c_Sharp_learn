<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SealManagePb.aspx.cs" Inherits="qpoa.SystemManage.SealManagepPb" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                         印章名称：<input id="jsName" type="text"   style="width: 138px"/>\
...
midSql=midSql+"&Name="+document.getElementById('jsName').value+"";
    ...
    window.location="SealManagePb.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  印章维护 &gt;&gt; 公章维护</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Name" HeaderText="印章名称" SortExpression="Name">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='SealManagePb_gl.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&number=<%# DataBinder.Eval(Container.DataItem, "number") %>' onclick="showwait();">管理</a>
