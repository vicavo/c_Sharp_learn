...
namespace qpoa.SystemManage
{
    public partial class Programtype : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "iiii1ab", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "iiii1ad", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "iiii1ae", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "iiii1ai", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_Programtype where 1=1";
            SqlStrStartCount = "select count(id) from qp_Programtype where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_Programtype";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Programtype " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Programtype  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除日程类型[" + CheckCbxNameDel() + "]", "日程类型维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Programtype_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Programtype_add.aspx");
        }
        ...
        {
            Response.Redirect("Programtype_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Programtype_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
