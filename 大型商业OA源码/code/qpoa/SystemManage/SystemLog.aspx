<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemLog.aspx.cs" Inherits="qpoa.SystemManage.SystemLog" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;内&nbsp;&nbsp;&nbsp;容：<input id="jsname" type="text" />&nbsp;操作模块：<input id="jsmkname" type="text" /> \
                         <br>&nbsp;操作人：<input id="jsrealname" type="text" />&nbsp;时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间：<input id="jsnowtimes" type="text" />格式yyyy-mm-dd\
                          <br>&nbsp;部&nbsp;&nbsp;&nbsp;门：<input id="jsunit" type="text" />\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsmkname').value!='')
    {
    midSql=midSql+"&mkname="+document.getElementById('jsmkname').value+"";
    }  
    ...
    if(document.getElementById('jsnowtimes').value!='')
    {
     var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
    if(!objRe.test(document.getElementById('jsnowtimes').value))
    {
    ...
    midSql=midSql+"&nowtimes="+document.getElementById('jsnowtimes').value+"";
    }   
	showwait();
    window.location="SystemLog.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SystemLog_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SystemLog_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 系统日志</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='SystemLog.aspx';showwait();">
