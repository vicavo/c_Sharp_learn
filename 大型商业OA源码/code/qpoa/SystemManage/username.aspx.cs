    ...
    public partial class username : System.Web.UI.Page
    {
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                {
                    MidSql = MidSql + " and username like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["username"])) + "%'";
                }
                ...
                if (Request.QueryString["worknum"] != null)
                {
                    MidSql = MidSql + " and worknum like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["worknum"])) + "%'";
                }
        ...
        {
            List.QuanXianVis(ImageButton1, "iiii4b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "iiii4c", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "iiii4d", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "iiii4e", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "iiii4i", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "iiii4f", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton5, "iiii4h", Session["perstr"].ToString());
        }
        ...
        public void BindAttribute()
        {
            ...
            ImageButton5.Attributes["onclick"] = "javascript:return updatecheck();";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_username  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除用户[" + CheckCbxNameDel() + "]", "用户管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("username_update.aspx?id=" + CheckCbxUpdate() + "");
        ...
        {
            Response.Redirect("username_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("username_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
