<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Respon.aspx.cs" Inherits="qpoa.SystemManage.Respon" %>
...
function chksearchstr()
{
    ...
    showwait();	
    window.location="Respon.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 角色管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              ...
                              <td style="height: 26px" align="right" > &nbsp;<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/button_add.jpg" OnClick="ImageButton1_Click" />
                                  ...
                                  <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/images/button_qx.jpg" OnClick="ImageButton4_Click" />
