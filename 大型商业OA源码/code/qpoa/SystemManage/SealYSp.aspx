<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SealYSp.aspx.cs" Inherits="qpoa.SystemManage.SealYSp" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;印章名称：<input id="jsName" type="text"  style="width: 418px"/>\
...
window.location="SealYSp.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  印章审批  </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='SealSp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"type="button"><font class="shadow_but">未审批</font></button>
                                <button class="btn4on" onclick="javascript:window.location='SealYSp.aspx?type=<%=Request.QueryString["Type"]%>';showwait();" type="button"><font class="shadow_but">已审批</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="操作">
                                        ...
                                        <ItemTemplate>
                                            <a href="SealYSp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>&type=<%=Request.QueryString["Type"] %> ">查看</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
