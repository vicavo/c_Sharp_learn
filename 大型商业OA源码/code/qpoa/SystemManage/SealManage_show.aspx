<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SealManage_show.aspx.cs" Inherits="qpoa.SystemManage.SealManage_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%" style="height: 24px"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom" style="height: 24px"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="SealManage.aspx"  class="line_b">
                           私章维护</a> >> 查看印章</td>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off" 
                                    type="button">
                                    <font class="shadow_but">私章维护</font></button></td>
