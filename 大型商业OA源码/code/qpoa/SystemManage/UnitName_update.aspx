<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitName_update.aspx.cs" Inherits="qpoa.SystemManage.UnitName_update" %>
          ...
          <td height="35">
            ...
            <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
              ...
              <asp:TextBox ID="QxString1" runat="server" Visible="False"></asp:TextBox>
                        <asp:TextBox ID="ParentNodes" runat="server" Visible="False"></asp:TextBox></td>
                    <td width="17" >
                        &nbsp;</td>
                </tr>
            </table>
