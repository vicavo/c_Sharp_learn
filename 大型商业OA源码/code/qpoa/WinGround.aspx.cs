...
namespace qpoa
{
    public partial class WinGround : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            //List.QuanXianVis(ImageButton1, "iiii1bb", Session["perstr"].ToString());

            //List.QuanXianVis(ImageButton2, "iiii1bd", Session["perstr"].ToString());
            //List.QuanXianVis(ImageButton3, "iiii1be", Session["perstr"].ToString());
            //List.QuanXianVis(IMG1, "iiii1bi", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_WinGround where username='" + Session["username"] + "' and 1=1";
            SqlStrStartCount = "select count(id) from qp_WinGround where username='" + Session["username"] + "' and  1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_WinGround where username='"+Session["username"]+"'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_WinGround  where username='" + Session["username"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_WinGround  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除Windows快捷组[" + CheckCbxNameDel() + "]", "Windows快捷组");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("WinGround_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("WinGround_add.aspx");
        }
