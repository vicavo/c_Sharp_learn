    ...
    public partial class modle : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (NewReader_mx.Read())
            {
                ...
                ModelContent += "  <tr class=\"TableControl\">  <td align=\"middle\" class=\"menulines\" onclick=\"javascript:window.opener.qiupengmodel('" + aaa + "');window.close()\" style=\"cursor: hand\">" + NewReader_mx["name"] + "</td> </tr>";
                glTMP1 = glTMP1 + 1;
                if (glTMP1 == 1)
                {
