...
{
    public partial class WorkFlowSearchJs : System.Web.UI.Page
    {
        Db List = new Db();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Response.Write("<script language=javascript>alert('提交成功！');window.opener.location.href='WorkFlowSearch.aspx';window.close();</script>");
        }
    }
}
