<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListYbl.aspx.cs"
    Inherits="qpoa.WorkFlow.WorkFlowListYbl" %>
...
window.location="WorkFlowListYbl.aspx?key=1&"+midSql+"";
}
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 工作管理 >> 已办理工作</td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 739px; height: 26px">
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <asp:DropDownList ID="FormName" runat="server" AutoPostBack="True" Width="180px">
                                                                        </asp:DropDownList>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="流程操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='WorkFlowListYbl_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'
