<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SealUseLog.aspx.cs" Inherits="qpoa.WorkFlow.SealUseLog" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                        印章名称：<input id="jsName" type="text" /> 时间：<input id="jsUsetime" type="text" />格式yyyy-mm-dd\
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 印章使用记录</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    ...
                                    <font class="shadow_but">使用记录</font></button>
                            </td>
