<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowJk.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowJk" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 工作管理 >> <a href="WorkFlowJk.aspx">
                                                                工作监控</a></td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='WorkFlowJk.aspx';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">工作监控</font></button>
                                                        </td>
                                                                ...
                                                                <td class="newtd2">
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img id="StartTime_HelpButton" onclick="Jscript:var sID ;sID = event.srcElement.id; sID = sID.substring(0,sID.lastIndexOf('_HelpButton'));DateSelect(sID);"
                                                                            src="../images/FDJ.gif" border="0"></a> 至<asp:TextBox ID="EndTime" runat="server"
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="表单类型" SortExpression="FormName">
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='window.open ("DIYForm_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "FormId") %>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")'>
                                                                    ...
                                                                    <asp:BoundField DataField="JBRObjectName" HeaderText="当前经办人" SortExpression="JBRObjectName">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="步骤与流程图" SortExpression="NodeName">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='window.open ("AddWorkFlow_show_lc.aspx?FlowNumber=<%# DataBinder.Eval(Container.DataItem, "FlowNumber") %>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "UpNodeName") %>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="流程操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LState" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "State")%>'
                                                                                Visible="false"></asp:Label>
