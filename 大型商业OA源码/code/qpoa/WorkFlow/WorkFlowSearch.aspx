<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowSearch.aspx.cs"
    Inherits="qpoa.WorkFlow.WorkFlowSearch" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 工作管理 >> <a href="WorkFlowSearch.aspx">
                                                                工作查询</a></td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='WorkFlowSearch.aspx';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">工作查询</font></button>
                                                        </td>
