<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowName_show_show.aspx.cs"
    Inherits="qpoa.WorkFlow.WorkFlowName_show_show" %>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="FlowName" runat="server" Width="95%"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="newtd2" colspan="3" height="24">
                                                        <asp:Label ID="FormName" runat="server" Width="95%"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                                        width="17%">
                                                        流程状态：</td>
                                                    <td class="newtd2" colspan="3" height="24">
                                                        <asp:Label ID="FlowType" runat="server" Width="95%"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                                        width="15%">
                                                    ...
                                                    <td class="newtd2" height="24" width="85%" colspan="3">
                                                        <asp:Label ID="JkRealname" runat="server" Width="95%"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                                        width="15%">
                                                        使用人部门：</td>
                                                    <td class="newtd2" height="24" width="85%" colspan="3">
                                                        <asp:Label ID="FlowUnitName" runat="server" Width="95%"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                                        width="15%">
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="85%">
                                                        <asp:Label ID="OverSetCon" runat="server" Width="95%"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        是否允许修改文号：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="xgwenhao" runat="server" Width="95%"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        自动文号表达式：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="Wenhao" runat="server"></asp:Label>
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        自动编号计数器：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="BianhaoJs" runat="server"></asp:Label>
                                                        同一流程下编号开始的数字
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        自动编号位数：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="BianhaoWs" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
