<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListSp_online.aspx.cs"
    Inherits="qpoa.WorkFlow.WorkFlowListSp_online" %>
                        ...
                        <tr>
                            <td>
                                <input style="width: 84px" onclick="openyz()" type="button" value="我的印章" id="Button10"
                                    runat="server">
                                <input style="width: 84px" onclick="Track()" type="button" value="进入留痕" id="Button8"
                                    runat="server">
                                <input style="width: 84px" onclick="UnTrack()" type="button" value="取消留痕" id="Button9"
                                    runat="server">
                                <input style="width: 84px" onclick="clearTrack()" type="button" value="清除留痕" id="Button7"
                                    runat="server">
                                <input style="width: 84px" type="button" value="打印文档" id="Button6" language="javascript"
