...
namespace qpoa.WorkFlow
{
    public partial class AddWorkFlow : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ListTreeView, "bbbb4a", Session["perstr"].ToString());
        ...
        private void BindTree()
        {
            ...
            while (MyReader.Read())
            {
                ...
                string SQL_GetFile = "select id,FormName from qp_DIYForm where TypeId='" + MyReader["id"].ToString() + "' and  (CHARINDEX('," + this.Session["username"] + ",',','+openusername+',')   >   0 ) ";
                ...
                while (FileReader.Read())
                {
                    ...
                    OrganizationNode1.NavigateUrl = "AddWorkFlow_show.aspx?FormId=" + strId + "";
