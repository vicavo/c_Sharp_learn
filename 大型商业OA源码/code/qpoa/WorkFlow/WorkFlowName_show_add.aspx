<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowName_show_add.aspx.cs"
    Inherits="qpoa.WorkFlow.WorkFlowName_show_add" %>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        自动文号表达式：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Wenhao" runat="server" Width="90%">{F}流程（{Y}年{M}月{D}日{H}:{I}）</asp:TextBox><a href="javascript:my_tip()">查看说明</a>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                ...
                                                                &nbsp; &nbsp; &nbsp;&nbsp;<asp:Button ID="Button4" runat="server" Text="下一步设置节点"
                                                                    CssClass="button_blue" OnClick="Button4_Click" />
                                                                &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" Text="下一步复制流程" CssClass="button_blue"
                                                                    OnClick="Button2_Click" />
                                                                &nbsp; &nbsp;&nbsp;<input id="Button3" class="button_blue" onclick="javascript:window.close()"
                                                                    type="button" value="不保留关闭窗口" /></font></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
