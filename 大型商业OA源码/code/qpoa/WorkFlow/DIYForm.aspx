<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIYForm.aspx.cs" Inherits="qpoa.WorkFlow.DIYForm" %>
...
{
var num=Math.random();
window.open ("DIYForm_show.aspx?tmp="+num+"&id="+str+"", "_blank", "height=675, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")
}

function updatefrom(str)
{
var num=Math.random();
window.open ("DIYForm_update.aspx?tmp="+num+"&id="+str+"", "_blank", "height=675, width=850,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")
}
...
{
var num=Math.random();
window.open ("DIYForm_add.aspx?tmp="+num+"", "_blank", "height=675, width=850,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  表单设计  >>  表单设计管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='DIYForm.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">表单设计</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FormName") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="Type" HeaderText="表单类别" SortExpression="Type">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a href="javascript:void(0)" onclick="updatefrom(<%# DataBinder.Eval(Container.DataItem, "ID") %>);">修改</a>
                                        </ItemTemplate>
