...
{
    public partial class WorkFlowListYWt : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort, string sqlfrom)
        {
            ...
            SqlStrStart = "select * from qp_WtWorkFlow where  Username='" + Session["username"] + "'  and 1=1";
            SqlStrStartCount = "select count(id) from qp_WtWorkFlow where  Username='" + Session["username"] + "'  and  1=1";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_WtWorkFlow  where Username='"+Session["username"]+"' ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from qp_WtWorkFlow   where  Username='" + Session["username"] + "'  " + sqlfrom + " " + Sqlsort + " ";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
