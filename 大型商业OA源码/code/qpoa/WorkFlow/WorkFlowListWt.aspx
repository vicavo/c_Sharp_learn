<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowListWt.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowListWt" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="WorkFlowList.aspx"  class="line_b">待办工作</a> >> 工作委托</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%"><%=NodeName %>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                            ...
                            <tr  id="printshow3">
                                ...
                                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<input id="Button2" class="button_blue" onclick="history.back()"
                                                size="20" type="button" value="返 回" /></FONT></div> </td>
                            </tr>
