<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowName_show_add_node.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowName_show_add_node" %>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                ...
                                <td  class="newtd2" colspan="4" height="17">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width=33% >
                                                    <strong>设计视图：</strong>  
                                                        <input id="txst" type="button" value="图形视图" onclick="parent.set_main.location='WorkFlowName_show_add_node_show.aspx?FlowNumber=<%=Request.QueryString["FlowNumber"] %>'"/>
                                                        <input id="Button1" type="button" value="列表视图" onclick="parent.set_main.location='WorkFlowName_show_add_node_lb.aspx?FlowNumber=<%=Request.QueryString["FlowNumber"] %>'"/>
                                                   </td>
                                                <td width=67% align="right" >
                                                        <input id="Button7" type="button" value="电子印章" onclick="setyz();"/>
                            ...
                            <tr>
                               ...
                               <IFRAME border="0" name="set_main" marginWidth="1" marginHeight="1" src="WorkFlowName_show_add_node_show.aspx?FlowNumber=<%=Request.QueryString["FlowNumber"] %>" frameBorder="0" width="100%"  height="500" BORDERCOLOR="#EDEDED"></IFRAME>
                                    </td>
