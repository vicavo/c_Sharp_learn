...
{
    public partial class ProManageFY : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "kkkka1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "kkkka1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "kkkka1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "kkkka1", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "kkkka1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "kkkka1", Session["perstr"].ToString());
        }
        ...
        {
            SqlStrStart = "select * from qp_ProManageFY where Username='" + this.Session["username"] + "' and 1=1";
            SqlStrStartCount = "select count(id) from qp_ProManageFY where  Username='" + this.Session["username"] + "' and  1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_ProManageFY where Username='" + this.Session["username"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from qp_ProManageFY where Username='" + this.Session["username"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_ProManageFY  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除费用报销[" + CheckCbxNameDel() + "]", "费用报销");
        ...
        {
            Response.Redirect("ProManageFY_update.aspx?id=" + CheckCbxUpdate() + "&XmName=" + Request.QueryString["XmName"] + "");
        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("ProManageFY_add.aspx?XmName=" + Request.QueryString["XmName"] + "");
        }

        protected void ImageButton6_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("ProManageFY_show.aspx?id=" + CheckCbxUpdate() + "&XmName=" + Request.QueryString["XmName"] + "");
        }
    }
}
