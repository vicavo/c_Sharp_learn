<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageLR_show.aspx.cs"
    Inherits="qpoa.ProManage.ProManageLR_show" %>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="17%">
                                                        利润：</td>
                                                    <td class="newtd2" colspan="3" height="24">
                                                        <asp:Label ID="Lirun" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
