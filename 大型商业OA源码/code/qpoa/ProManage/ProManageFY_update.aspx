<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageFY_update.aspx.cs"
    Inherits="qpoa.ProManage.ProManageFY_update" %>
...
{  
    ...
    wName2=window.showModalDialog("../OpenWindows/open_ProData.aspx?tmp="+num+"&requeststr="+str+"&type=5","window", "dialogWidth:400px;DialogHeight=480px;status:no;scroll=yes;help:no");               
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="ProManageFY.aspx?XmName="
                                                                class="line_b">费用报销</a> >> 修改费用报销</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="17%">
                                                        报销内容：</td>
                                                    <td class="newtd2" colspan="3" height="24">
                                                        <asp:TextBox ID="Neirong" runat="server" Width="95%" Height="59px" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="17%">
                                                        审批人：</td>
                                                    <td class="newtd2" colspan="3" height="24">
                                                        <asp:TextBox ID="SpRealname" runat="server" Width="95%"></asp:TextBox><a href="javascript:void(0)"><img
                                                            onclick="openuser();" alt="" src="../images/FDJ.gif" border="0"></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="17%">
