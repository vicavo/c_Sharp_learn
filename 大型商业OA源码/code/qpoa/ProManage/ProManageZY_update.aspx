<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageZY_update.aspx.cs" Inherits="qpoa.ProManage.ProManageZY_update" %>
...
{  
    ...
    wName2=window.showModalDialog("../OpenWindows/open_ProData.aspx?tmp="+num+"&requeststr="+str+"&type=4","window", "dialogWidth:400px;DialogHeight=480px;status:no;scroll=yes;help:no");               
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="ProManageZY.aspx?XmName=" class="line_b">
                                                                项目资源</a> >> 修改项目资源</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">项目资源</font></button></td>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="24" width="35%">
                                                        <asp:TextBox ID="Mingcheng" runat="server" Width="95%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
