<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageFYGL.aspx.cs"
    Inherits="qpoa.ProManage.ProManageFYGL" %>
...
function chksearchstr()
{
    ...
    window.location="ProManageFYGL.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ProManageFYGL_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ProManageFYGL_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4on" onclick="javascript:window.location='ProManageFYGL.aspx';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4off" onclick="javascript:window.location='ProManageFYGYSP.aspx';showwait();"
                                                                type="button">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="ProManageFYGL_sp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>">
                                                                                审批</a>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
