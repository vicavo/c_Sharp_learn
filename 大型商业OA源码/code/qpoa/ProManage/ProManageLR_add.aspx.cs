...
{
    public partial class ProManageLR_add : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            string sql_insert = "insert into qp_ProManageLR    (XmName,Leibie,Zhuti,Lirun,Username,Realname,Unit,UnitId,QxString,Respon,ResponId,NowTimes) values ('" + XmName.SelectedValue + "','" + List.GetFormatStr(Leibie.Text) + "','" + List.GetFormatStr(Zhuti.Text) + "','" + List.GetFormatStr(Lirun.Text) + "','" + this.Session["Username"] + "','" + this.Session["Realname"] + "','" + this.Session["Unit"] + "','" + this.Session["UnitId"] + "','" + this.Session["QxString"] + "','" + this.Session["Respon"] + "','" + this.Session["ResponId"] + "','" + System.DateTime.Now.ToString() + "')";
