...
{
    public partial class ProManageRW_add : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            string sql_insert = "insert into qp_ProManageRW    (XmName,Leibie,Zhuti,Contents,Starttime,Endtime,CyUsername,CyRealname,Username,Realname,Unit,UnitId,QxString,Respon,ResponId,NowTimes) values ('" + XmName.SelectedValue + "','" + List.GetFormatStr(Leibie.Text) + "','" + List.GetFormatStr(Zhuti.Text) + "','" + List.GetFormatStr(Contents.Text) + "','" + List.GetFormatStr(Starttime.Text) + "','" + List.GetFormatStr(Endtime.Text) + "','" + List.GetFormatStr(CyUsername.Text) + "','" + List.GetFormatStr(CyRealname.Text) + "','" + this.Session["Username"] + "','" + this.Session["Realname"] + "','" + this.Session["Unit"] + "','" + this.Session["UnitId"] + "','" + this.Session["QxString"] + "','" + this.Session["Respon"] + "','" + this.Session["ResponId"] + "','" + System.DateTime.Now.ToString() + "')";
