<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageFYGYSP.aspx.cs" Inherits="qpoa.ProManage.ProManageFYGYSP" %>
<html>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;项目名称：<input id="jsname" type="text"  style="width: 208px" value="<%=Request.QueryString["XmName"] %>"/>\
...
function chksearchstr()
{
    ...
    {
        midSql=midSql+"XmName="+document.getElementById('jsname').value+"";
    }
    
    showwait();
    
    window.location="ProManageFYGYSP.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ProManageFYGYSP_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ProManageFYGYSP_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 报销管理</td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='ProManageFYGL.aspx';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4on" onclick="javascript:window.location='ProManageFYGYSP.aspx';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">已审批</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <a><img onclick="UploadComplete()" src="../images/button_search.jpg" border="0" id="IMG1"
                                                                runat="server" /></a>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Leibie" HeaderText="报销类别" SortExpression="Leibie">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Zhuti" HeaderText="报销主题" SortExpression="Zhuti">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="Jieguo" HeaderText="审批结果" SortExpression="Jieguo">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="ProManageFYGYSP_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>">
                                                                                查看</a>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
