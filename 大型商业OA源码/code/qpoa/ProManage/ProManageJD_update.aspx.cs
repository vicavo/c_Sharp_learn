...
{
    public partial class ProManageJD_update : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            string Sql_update1 = "Update qp_ProManageJD  Set XmName='" + XmName.SelectedValue + "',Jieduan='" + Jieduan.Text + "',Wanchenglv='" + List.GetFormatStr(Wanchenglv.Text) + "' where id='" + int.Parse(Request.QueryString["id"]) + "'";
