<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageLR_dc.aspx.cs" Inherits="qpoa.ProManage.ProManageLR_dc" %>
        ...
        <div>
            <asp:GridView Style="font-size: 12px" ID="GridView1" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Leibie" HeaderText="利润类别">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Zhuti" HeaderText="利润主题">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
