<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageYS.aspx.cs" Inherits="qpoa.ProManage.ProManageYS" %>
...
function chksearchstr()
{
    ...
    window.location="ProManageYS.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ProManageYS_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ProManageYS_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 项目预算</td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='ProManageYS.aspx?XmName=';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">项目预算</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/button_add.jpg"
                                                                OnClick="ImageButton1_Click" />
                                                            <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/images/button_show.jpg"
                                                                OnClick="ImageButton6_Click" />
                                                            <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/button_update.jpg"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "XmName") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="Leibie" HeaderText="预算类别" SortExpression="Leibie">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Zhuti" HeaderText="预算主题" SortExpression="Zhuti">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Feiyong" HeaderText="预算费用" SortExpression="Feiyong">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="NowTimes" HeaderText="创建时间" SortExpression="NowTimes">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
