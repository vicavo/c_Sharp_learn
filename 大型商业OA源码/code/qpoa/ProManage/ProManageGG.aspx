<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageGG.aspx.cs" Inherits="qpoa.ProManage.ProManageGG" %>
...
function chksearchstr()
{
    ...
    window.location="ProManageGG.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ProManageGG_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ProManageGG_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 项目公告</td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='ProManageGG.aspx';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">项目公告</font></button>
                                                        </td>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Biaoti") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="Biaoti" HeaderText="公告标题" SortExpression="Biaoti">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Leibie" HeaderText="公告类别" SortExpression="Leibie">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
