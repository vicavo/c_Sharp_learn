...
{
    public partial class ProManageMG_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview()
        {
            ...
            {
                string SQL_GetList_xs = "select * from qp_ProManage where Username='" + this.Session["username"] + "' and 1=1";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
