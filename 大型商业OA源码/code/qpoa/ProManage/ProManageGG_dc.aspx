<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageGG_dc.aspx.cs"
    Inherits="qpoa.ProManage.ProManageGG_dc" %>
        ...
        <div>
            <asp:GridView Style="font-size: 12px" ID="GridView1" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Leibie" HeaderText="公告类别">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Biaoti" HeaderText="公告标题">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
