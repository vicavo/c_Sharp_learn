<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingJy.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingJy" %>
...
showwait();
var num=Math.random();
window.open ("OfficeThingJy_dc.aspx?outkey=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("OfficeThingJy_dc.aspx?outkey=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='OfficeThingJy.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
                                <button class="btn4off" onclick="javascript:window.location='OfficeThingJy_tg.aspx';showwait();" type="button"><font class="shadow_but">已通过</font></button>
