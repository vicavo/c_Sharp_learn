<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingApply_jxz.aspx.cs" Inherits="qpoa.PublicAffairs.MettingApply_jxz" %>
...
function chksearchstr()
{
    ...
    window.location="MettingApply_jxz.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MettingApply_dc.aspx?key=5&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MettingApply_dc.aspx?key=5&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
  ...
  <button class="btn4off" onclick="javascript:window.location='MettingApply.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
   <button class="btn4off" onclick="javascript:window.location='MettingApply_dsp.aspx';showwait();" type="button"><font class="shadow_but">待审批</font></button>
                               ...
                               <button class="btn4off" onclick="javascript:window.location='MettingApply_wtg.aspx';showwait();" type="button"><font class="shadow_but">未通过</font></button>
                                  <button class="btn4on" onclick="javascript:window.location='MettingApply_jxz.aspx';showwait();" type="button"><font class="shadow_but">进行中</font></button>
                                   ...
                                   <asp:BoundField DataField="ManagerName" HeaderText="审批人" SortExpression="ManagerName">
                                       ...
                                       <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                          ...
                                          <a href='MettingApply_hyjy.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">会议纪要</a>
