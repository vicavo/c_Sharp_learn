<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetMettingJs.aspx.cs" Inherits="qpoa.PublicAffairs.NetMettingJs" %>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               ...
                               <button class="btn4on" onclick="javascript:window.location='NetMettingJs.aspx';showwait();" type="button"><font class="shadow_but">已经结束</font></button>                             
                            </td>
