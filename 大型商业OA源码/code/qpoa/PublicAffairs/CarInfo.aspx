<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarInfo.aspx.cs" Inherits="qpoa.PublicAffairs.CarInfo" %>
...
window.location="CarInfo.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarInfo_dc.aspx?keys=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarInfo_dc.aspx?keys=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
