<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Assets_add.aspx.cs" Inherits="qpoa.PublicAffairs.Assets_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Assets.aspx"  class="line_b">固定资产</a> >> 新增固定资产</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                           ...
                           <tr class="" id="nextrs1">
                            ...
                            <tr>
                                ...
                                <td align="right" class="newtd1" nowrap="nowrap"
                                    ...
                                    开始折旧日期：</td>
                                <td class="newtd2" width="35%" style="height: 17px">
                                    <asp:TextBox ID="DepStartDate" runat="server" Width="85%" ></asp:TextBox>
                                    <script>SetNeed('DepStartDate')</script>
                                      <A href="javascript:void(0)"><IMG id="DepStartDate_HelpButton" onclick="Jscript:var sID ;sID = event.srcElement.id; sID = sID.substring(0,sID.lastIndexOf('_HelpButton'));DateSelect(sID);"
																		src="../images/FDJ.gif" border="0"></A>
