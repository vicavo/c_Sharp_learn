<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingContent_show.aspx.cs" Inherits="qpoa.PublicAffairs.MettingContent_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="MettingContent.aspx"  class="line_b">会议纪要</a> >> 修改会议纪要</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:Label ID="JyRealname" runat="server" Width="90%"></asp:Label></td>
                            </tr>
