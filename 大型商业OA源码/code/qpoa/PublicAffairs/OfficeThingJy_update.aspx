<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingJy_update.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingJy_update" %>
  ...
  <tr>
    <td valign="top"><table width="100%" height="23" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  办公用品管理  >>  <a href=OfficeThingJy.aspx class="line_b">办公用品登记</a>  >>  新增借用登记</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
      ...
      <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off6k" 
                                    type="button">
                                    <font class="shadow_but">借用登记</font></button></td>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="17" colspan="3" width="85%">
                                    <asp:TextBox ID="Name" runat="server" Width="90%"></asp:TextBox>&nbsp;<A href="javascript:void(0)"><IMG onclick="openoffice();" alt="" src="../images/FDJ.gif" border="0"></A></td>
                            </tr>
                             <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                ...
                                <td class="newtd2" height="17" width="35%">
                                    <asp:TextBox ID="LyRealname" runat="server" Width="85%"></asp:TextBox>
                                    <A href="javascript:void(0)"><IMG onclick="openuser();" alt="" src="../images/FDJ.gif" border="0"></A> </td>
                                  <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                      数量：
                                </td>
                                <td class="newtd2"  height="17" width="35%">
                                    <asp:TextBox ID="ShuLiang" runat="server" Width="90%">0</asp:TextBox></td>    
        ...
        <asp:TextBox ID="Shenpi" runat="server" Visible="False"></asp:TextBox></td>
  </tr>
</table>
  <asp:TextBox ID="NameId" runat="server" Width="90%"  style="DISPLAY: none"></asp:TextBox>
     <asp:TextBox ID="LyUsername" runat="server" Width="90%"  style="DISPLAY: none"></asp:TextBox>
...
{  
var num=Math.random();
var str=""+document.getElementById('LyUsername').value+"|"+document.getElementById('LyRealname').value+"";
...
for(var i=0;i<arr.length;i++)
{ 
document.getElementById("LyUsername").value=arr[0]; 
document.getElementById("LyRealname").value=arr[1]; 
