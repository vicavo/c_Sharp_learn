<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingLy.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingLy" %>
...
showwait();
var num=Math.random();
window.open ("OfficeThingLy_dc.aspx?outkey=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("OfficeThingLy_dc.aspx?outkey=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='OfficeThingLy.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
