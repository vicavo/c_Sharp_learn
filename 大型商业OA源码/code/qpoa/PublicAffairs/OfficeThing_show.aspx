<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThing_show.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThing_show" %>
              ...
              <tr> 
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  办公用品管理  >>  <a href=OfficeThing.aspx class="line_b">办公用品管理</a>  >>  查看办公用品</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%" >
                                    <asp:Label ID="Measurement" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                               <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">供应商： 
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%" >
                                    <asp:Label ID="CompanyName" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                             <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">库警参数： 
                                ...
                                <td class="newtd2" height="17" width="35%">
                                    <asp:Label ID="Limits" runat="server" Width="90%"></asp:Label></td>
                                  <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">当前库存： 
                                </td>
                                <td class="newtd2"  height="17" width="35%">
                                    <asp:Label ID="Inventory" runat="server" Width="90%"></asp:Label></td>    
