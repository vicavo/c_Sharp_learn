<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarApply_sp.aspx.cs" Inherits="qpoa.PublicAffairs.CarApply_sp" %>
...
function chksearchstr()
{
    ...
    window.location="CarApply_sp.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarApply_sp_dc.aspx?key=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarApply_sp_dc.aspx?key=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
...
{ 
var num=Math.random();
window.showModalDialog('CarApply_sp_ct.aspx?id='+id+'&tmp='+num+'','window','dialogWidth:727px;DialogHeight=400px;status:no;help=no;scroll=on');window.location='#'
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 车辆使用管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                 <button class="btn4on" onclick="javascript:window.location='CarApply_sp.aspx';showwait();" type="button"><font class="shadow_but">待审批</font></button>
                                <button class="btn4off" onclick="javascript:window.location='CarApply_sp_ytg.aspx';showwait();" type="button"><font class="shadow_but">已通过</font></button>
                               <button class="btn4off" onclick="javascript:window.location='CarApply_sp_wtg.aspx';showwait();" type="button"><font class="shadow_but">未通过</font></button>
                                  <button class="btn4off" onclick="javascript:window.location='CarApply_sp_syz.aspx';showwait();" type="button"><font class="shadow_but">使用中</font></button>
                               <button class="btn4off" onclick="javascript:window.location='CarApply_sp_yjs.aspx';showwait();" type="button"><font class="shadow_but">已结束</font></button>                             
                            </td>
                        ...
                        <div id="Div1" >
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Carpeople" HeaderText="用车人" SortExpression="Carpeople">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    
                                    <asp:TemplateField HeaderText="用车部门" SortExpression="UnitName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                  ...
                                  <asp:BoundField DataField="Starttime" HeaderText="开始时间" SortExpression="Starttime">
                                   ...
                                   <asp:BoundField DataField="Realname" HeaderText="申请人" SortExpression="ManagerName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                       ...
                                       <asp:TemplateField HeaderText="是否冲突">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="120px"/>
                                        <ItemTemplate>
                                            <asp:Label ID="StringId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                       ...
                                       <asp:TemplateField HeaderText="相关操作">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="120px"/>
                                        <ItemTemplate>
                                            <a href='CarApply_sp_sp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">审批</a>
