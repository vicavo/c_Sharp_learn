<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarApply.aspx.cs" Inherits="qpoa.WebEditor.CarApply" %>
...
function chksearchstr()
{
    ...
    window.location="CarApply.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarApply_dc.aspx?key=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarApply_dc.aspx?key=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <button class="btn4on" onclick="javascript:window.location='CarApply.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="ManagerName" HeaderText="审批人" SortExpression="ManagerName">
                                       ...
                                       <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <a href='CarApply_update.aspx?keyback=1&id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">修改</a>
