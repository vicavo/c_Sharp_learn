<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetsDepLog.aspx.cs" Inherits="qpoa.PublicAffairs.AssetsDepLog" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                   &nbsp;&nbsp;&nbsp;资产名称：<input id="jsAssetsName" type="text"   style="width: 138px"/>&nbsp;&nbsp;折旧日期：<input id="jsEndtime" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
if(document.getElementById('jsAssetsName').value!='')
{
midSql=midSql+"AssetsName="+document.getElementById('jsAssetsName').value+"";
}
...
window.location="AssetsDepLog.aspx?key=1&"+midSql+"&id=<%=Request.QueryString["id"] %>";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  固定资产折旧记录</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AssetsDep.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">折旧记录</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="AssetsName" HeaderText="资产名称" SortExpression="AssetsName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="折旧日期" >
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="Fjumber" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                            <asp:Label ID="Label2" runat="server" ></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>

                                     <asp:BoundField DataField="DepStartMoney" HeaderText="折旧前金额" SortExpression="DepStartMoney" DataFormatString="{0:#,##0.00}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   

                                     <asp:BoundField DataField="DepMoney" HeaderText="折旧额" SortExpression="DepMoney" DataFormatString="{0:#,##0.00}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                  
                                    
                                       <asp:BoundField DataField="DepLastMoney" HeaderText="折旧后金额" SortExpression="DepLastMoney" DataFormatString="{0:#,##0.00}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                               
