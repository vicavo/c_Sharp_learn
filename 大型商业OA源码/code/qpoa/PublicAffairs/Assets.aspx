<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Assets.aspx.cs" Inherits="qpoa.PublicAffairs.Assets" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                   &nbsp;&nbsp;&nbsp;资产编号：<input id="jsNumber" type="text"   style="width: 138px"/>&nbsp;&nbsp;资产名称：<input id="jsName" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                   <br>&nbsp;&nbsp;&nbsp;规格型号：<input id="jsAssetModel" type="text"   style="width: 138px"/>&nbsp;&nbsp;制造厂商：<input id="jsMadeCompany" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                   <br>&nbsp;&nbsp;&nbsp;资产性质：<input id="jsAssetType" type="text"   style="width: 138px"/>&nbsp;&nbsp;折旧类型：<input id="jsDepType" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                   <br>&nbsp;&nbsp;&nbsp;所属部门：<input id="jsUnitName" type="text"   style="width: 138px"/>&nbsp;&nbsp;保&nbsp;&nbsp;管&nbsp;人：<input id="jsBgRealname" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
if(document.getElementById('jsAssetModel').value!='')
{
midSql=midSql+"&AssetModel="+document.getElementById('jsAssetModel').value+"";
}


if(document.getElementById('jsMadeCompany').value!='')
{
midSql=midSql+"MadeCompany="+document.getElementById('jsMadeCompany').value+"";
}



if(document.getElementById('jsAssetType').value!='')
{
midSql=midSql+"&AssetType="+document.getElementById('jsAssetType').value+"";
}  


if(document.getElementById('jsDepType').value!='')
{
midSql=midSql+"&DepType="+document.getElementById('jsDepType').value+"";
} 
...
if(document.getElementById('jsBgRealname').value!='')
{
midSql=midSql+"&BgRealname="+document.getElementById('jsBgRealname').value+"";
} 
...
window.location="Assets.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("Assets_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("Assets_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1000, width=1000")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  固定资产  >>  固定资产管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Assets.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">固定资产</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Number" HeaderText="资产编号" SortExpression="Number">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                 
                                    <asp:BoundField DataField="Name" HeaderText="资产名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="所属部门" SortExpression="UnitName">
                                     ...
                                     <asp:BoundField DataField="ActualMoney" HeaderText="资产原值" SortExpression="ActualMoney" DataFormatString="{0:#,##0.00}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   

                                     <asp:BoundField DataField="FrontMoney" HeaderText="资产当前值" SortExpression="FrontMoney" DataFormatString="{0:#,##0.00}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                  
                                    
                                    <asp:BoundField DataField="BgRealname" HeaderText="保管人" SortExpression="BgRealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>  
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='AssetsDepLog.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">折旧记录</a>
                                        </ItemTemplate>
