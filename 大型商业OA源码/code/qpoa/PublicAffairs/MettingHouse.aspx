<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingHouse.aspx.cs" Inherits="qpoa.PublicAffairs.MettingHouse" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;&nbsp;&nbsp;会议室名称：<input id="jsname" type="text"  style="width: 398px"/>\
                    <br>&nbsp;&nbsp;&nbsp;设&nbsp;备&nbsp;情&nbsp;况：<input id="jsEquipment" type="text"  style="width: 398px"/>\
                        <br>&nbsp;&nbsp;&nbsp;会议室描述：<input id="jsIntroduction" type="text"  style="width: 398px"/>\
                          <br>&nbsp;&nbsp;&nbsp;地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：<input id="jsAddress" type="text"  style="width: 398px"/>\
...
if(document.getElementById('jsEquipment').value!='')
{
midSql=midSql+"&Equipment="+document.getElementById('jsEquipment').value+"";
}  
...
window.location="MettingHouse.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MettingHouse_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MettingHouse_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  会议管理  >>  会议室设置</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='MettingHouse.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">会议室</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="会议室名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PeopleNum" HeaderText="可容纳人数" SortExpression="PeopleNum">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                      <asp:TemplateField HeaderText="设备情况" SortExpression="Equipment">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("Equipment").ToString().Length > 10) ? (Eval("Equipment").ToString().Substring(0, 10)) + "..." : (Eval("Equipment").ToString()))%>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>
                                  
                                      <asp:TemplateField HeaderText="会议室描述" SortExpression="Introduction">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("Introduction").ToString().Length > 10) ? (Eval("Introduction").ToString().Substring(0, 10)) + "..." : (Eval("Introduction").ToString()))%>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="地址" SortExpression="Address">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("Address").ToString().Length > 10) ? (Eval("Address").ToString().Substring(0, 10)) + "..." : (Eval("Address").ToString()))%>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>                                
