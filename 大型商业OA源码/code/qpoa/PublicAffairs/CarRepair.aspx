<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarRepair.aspx.cs" Inherits="qpoa.PublicAffairs.CarRepair" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;&nbsp;&nbsp;车牌号：<input id="jsCarNum" type="text"   style="width: 138px"/>&nbsp;&nbsp;维护日期：<input id="jsRepairTime" type="text"   style="width: 138px"/>日期格式yyyy-mm-dd\
                       <br>&nbsp;&nbsp;&nbsp;经办人：<input id="jsPeople" type="text"   style="width: 138px"/>&nbsp;&nbsp;维护类型：<input id="jsRepairType" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
if(document.getElementById('jsRepairType').value!='')
{
midSql=midSql+"&RepairType="+document.getElementById('jsRepairType').value+"";
}  


if(document.getElementById('jsPeople').value!='')
{
midSql=midSql+"People="+document.getElementById('jsPeople').value+"";
}



if(document.getElementById('jsRepairTime').value!='')
{
var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
if(!objRe.test(document.getElementById('jsRepairTime').value))
{
...
midSql=midSql+"&RepairTime="+document.getElementById('jsRepairTime').value+"";
 
}
showwait();

window.location="CarRepair.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarRepair_dc.aspx?keys=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarRepair_dc.aspx?keys=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  车辆维护管理 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                ...
                <td valign="top" style="height: 40px"> 
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                           ...
                           <button class="btn4off" onclick="javascript:window.location='CarRepair.aspx';showwait();"type="button"><font class="shadow_but">车辆维护</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="RepairTime" HeaderText="维护日期" SortExpression="RepairTime" DataFormatString="{0:d}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="RepairType" HeaderText="维护类型" SortExpression="RepairType">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                        <asp:BoundField DataField="People" HeaderText="经办人" SortExpression="People">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                               
                                          <asp:BoundField DataField="RepairMoney" HeaderText="维护费用" SortExpression="RepairMoney">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                    
                                </Columns>
