...
{
    public partial class OfficeThing : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                if (Request.QueryString["Measurement"] != null)
                {
                    MidSql = MidSql + " and Measurement like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["Measurement"])) + "%'";
                }
                ...
                {
                    MidSql = MidSql + " and CompanyName like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["CompanyName"])) + "%'";
                }


                if (Request.QueryString["IfKj"] != null)
                {
                    if (Request.QueryString["IfKj"] == "1")
                    {
                        MidSql = MidSql + " and Inventory <= Limits";
                    }
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc2ab", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "cccc2ac", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "cccc2ad", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc2ae", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc2ai", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "cccc2af", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            //{
                ...
                SqlStrStartCount = "select count(id) from qp_OfficeThing where 1=1";
            //}
            ...
            else
            {
                ...
                //if (List.StrIFInStr("cc1cca3", Session["perstr"].ToString()))
                //{
                    string SQL_GetCount = "select count(id) from  qp_OfficeThing ";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_OfficeThing  " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                //} //公司
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_OfficeThing  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除办公用品[" + CheckCbxNameDel() + "]", "办公用品管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("OfficeThing_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("OfficeThing_add.aspx");
        }
        ...
        {
            Response.Redirect("OfficeThing_show.aspx?id=" + CheckCbxUpdate() + "");
        }
