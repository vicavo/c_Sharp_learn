<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarInfo_add.aspx.cs" Inherits="qpoa.PublicAffairs.CarInfo_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="CarInfo.aspx"  class="line_b">车辆信息管理</a> >> 新增车辆</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
