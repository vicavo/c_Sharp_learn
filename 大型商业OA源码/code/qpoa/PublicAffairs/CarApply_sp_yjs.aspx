<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarApply_sp_yjs.aspx.cs" Inherits="qpoa.PublicAffairs.CarApply_sp_yjs" %>
...
function chksearchstr()
{
    ...
    window.location="CarApply_sp_yjs.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarApply_sp_dc.aspx?key=5&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarApply_sp_dc.aspx?key=5&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               ...
                               <button class="btn4on" onclick="javascript:window.location='CarApply_sp_yjs.aspx';showwait();" type="button"><font class="shadow_but">已结束</font></button>                             
                            </td>
