<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingBf_show.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingBf_show" %>
              ...
              <tr> 
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  办公用品管理  >>  <a href=OfficeThingBf.aspx class="line_b">办公用品登记</a>  >>  查看报废登记</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td class="newtd2" height="17" width="35%">
                                    <asp:Label ID="LyRealname" runat="server" Width="90%"></asp:Label></td>
                                  <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                      数量：
                                </td>
