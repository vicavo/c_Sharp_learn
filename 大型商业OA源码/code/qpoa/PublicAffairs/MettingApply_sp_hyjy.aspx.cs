...
{
    public partial class MettingApply_sp_hyjy : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            Response.Redirect("MettingApply_sp_jxz.aspx");
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            InsertLog("修改会议纪要[" + Name.Text + "]", "会议申请");


            this.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='MettingApply_sp_jxz.aspx'</script>");
