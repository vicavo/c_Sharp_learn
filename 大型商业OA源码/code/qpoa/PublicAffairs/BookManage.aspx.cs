...
namespace qpoa.PublicAffairs
{
    public partial class BookManage : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc3cb", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "cccc3cc", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "cccc3cd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc3ce", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc3ci", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "cccc3cf", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            //{
            SqlStrStart = "select * from qp_BookManage where 1=1";
            SqlStrStartCount = "select count(id) from qp_BookManage where 1=1";
            //}
            ...
            else
            {
                ...
                //if (List.StrIFInStr("cc1cca3", Session["perstr"].ToString()))
                //{
                string SQL_GetCount = "select count(id) from  qp_BookManage ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from qp_BookManage  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
                //} //公司
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_BookManage  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除图书信息[" + CheckCbxNameDel() + "]", "图书信息管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("BookManage_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("BookManage_add.aspx");
        }
        ...
        {
            Response.Redirect("BookManage_show.aspx?id=" + CheckCbxUpdate() + "");
        }
