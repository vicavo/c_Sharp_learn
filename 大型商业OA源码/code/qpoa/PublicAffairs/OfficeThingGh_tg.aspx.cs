...
{
    public partial class OfficeThingGh_tg : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_OfficeThingGh where 1=1 and   Shenpi='已通过' and      (Username='" + this.Session["username"] + "')";
            SqlStrStartCount = "select count(id) from qp_OfficeThingGh where 1=1 and   Shenpi='已通过' and     (Username='" + this.Session["username"] + "')";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_OfficeThingGh where   Shenpi='已通过' and     (Username='" + this.Session["username"] + "')";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_OfficeThingGh where   Shenpi='已通过' and     (Username='" + this.Session["username"] + "') " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
