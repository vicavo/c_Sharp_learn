...
{
    public partial class Bookype : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc3bb", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "cccc3bd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc3be", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc3bi", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_Bookype where 1=1";
            SqlStrStartCount = "select count(id) from qp_Bookype where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_Bookype";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Bookype " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Bookype  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除图书类别[" + CheckCbxNameDel() + "]", "图书类别维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Bookype_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Bookype_add.aspx");
        }
        ...
        {
            Response.Redirect("Bookype_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Bookype_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
