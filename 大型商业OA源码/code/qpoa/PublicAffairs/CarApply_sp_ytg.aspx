<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarApply_sp_ytg.aspx.cs" Inherits="qpoa.PublicAffairs.CarApply_sp_ytg" %>
...
function chksearchstr()
{
    ...
    window.location="CarApply_sp_ytg.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarApply_sp_dc.aspx?key=2&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarApply_sp_dc.aspx?key=2&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4on" onclick="javascript:window.location='CarApply_sp_ytg.aspx';showwait();" type="button"><font class="shadow_but">已通过</font></button>
                                   ...
                                   <asp:BoundField DataField="Realname" HeaderText="申请人" SortExpression="ManagerName">
                                       ...
                                       <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="ShanChu">撤消</asp:LinkButton>
                                        </ItemTemplate>
