...
namespace qpoa
{
    public partial class CarType: System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc5gb", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "cccc5gd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc5ge", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc5gi", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_CarType where 1=1";
            SqlStrStartCount = "select count(id) from qp_CarType where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_CarType";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_CarType " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_CarType  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除车辆类型[" + CheckCbxNameDel() + "]", "车辆类型管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("CarType_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("CarType_add.aspx");
        }
        ...
        {
            Response.Redirect("CarType_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("CarType_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
