<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyWorkPlan_fz.aspx.cs" Inherits="qpoa.PublicAffairs.MyWorkPlan_fz" %>
...
window.location="MyWorkPlan_fz.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("WorkPlan_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("WorkPlan_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  工作计划  >>  我的计划  >>  负责计划</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                            ...
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='MyWorkPlan.aspx';showwait();"type="button"><font class="shadow_but">所有计划</font></button>
                                <button class="btn4off" onclick="javascript:window.location='MyWorkPlan_bm.aspx';showwait();" type="button"><font class="shadow_but">部门计划</font></button>
                                 ...
                                 <button class="btn4on" onclick="javascript:window.location='MyWorkPlan_fz.aspx';showwait();" type="button"><font class="shadow_but">负责计划</font></button>
                            </td>
