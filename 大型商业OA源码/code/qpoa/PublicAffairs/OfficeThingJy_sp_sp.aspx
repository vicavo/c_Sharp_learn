<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingJy_sp_sp.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingJy_sp_sp" %>
              ...
              <tr> 
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  办公用品管理  >>  <a href=OfficeThingJy_sp.aspx class="line_b">办公用品借用审批</a>  >>  审批借用登记</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
