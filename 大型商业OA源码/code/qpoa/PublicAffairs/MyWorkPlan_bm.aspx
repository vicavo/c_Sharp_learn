<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyWorkPlan_bm.aspx.cs" Inherits="qpoa.PublicAffairs.MyWorkPlan_bm" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;计划标题：<input id="jsname" type="text"  style="width: 398px"/>\
                       <br>&nbsp;&nbsp;&nbsp;计划周期：<input id="jsplancycle" type="text"   style="width: 138px"/>&nbsp;【<A href="javascript:void(0)" onclick="OpenSaleData3()">选择</A>】&nbsp;计划类型：<input id="jsplantype" type="text"   style="width: 138px"/>&nbsp;【<A href="javascript:void(0)" onclick="OpenSaleData6()">选择</A>】&nbsp;\
                        <br>&nbsp;&nbsp;&nbsp;参与部门：<input id="jssendunit" type="text"  style="width: 398px"/>\
                        <br>&nbsp;&nbsp;&nbsp;参与人员：<input id="jssendrealname" type="text"  style="width: 398px"/>\
...
if(document.getElementById('jsplancycle').value!='')
{
midSql=midSql+"&PlanCycle="+document.getElementById('jsplancycle').value+"";
}  


if(document.getElementById('jsplantype').value!='')
{
midSql=midSql+"PlanType="+document.getElementById('jsplantype').value+"";
}


if(document.getElementById('jssendunit').value!='')
{
midSql=midSql+"&SendUnit="+document.getElementById('jssendunit').value+"";
}  


if(document.getElementById('jssendrealname').value!='')
{
midSql=midSql+"SendRealname="+document.getElementById('jssendrealname').value+"";
} 
 
showwait();

window.location="MyWorkPlan_bm.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MyWorkPlan_bm_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MyWorkPlan_bm_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  工作计划  >>  我的计划  >>  部门计划</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='MyWorkPlan.aspx';showwait();"type="button"><font class="shadow_but">所有计划</font></button>
                                <button class="btn4on" onclick="javascript:window.location='MyWorkPlan_bm.aspx';showwait();" type="button"><font class="shadow_but">部门计划</font></button>
                                  <button class="btn4off" onclick="javascript:window.location='MyWorkPlan_cy.aspx';showwait();" type="button"><font class="shadow_but">参与计划</font></button>
                                 <button class="btn4off" onclick="javascript:window.location='MyWorkPlan_fz.aspx';showwait();" type="button"><font class="shadow_but">负责计划</font></button>
                            </td>
                        ...
                        <div id="Div1" >
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="计划名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PlanCycle" HeaderText="计划周期" SortExpression="PlanCycle">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PlanType" HeaderText="计划类型" SortExpression="PlanType">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="参与部门" SortExpression="SendUnit">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("SendUnit").ToString().Length > 10) ? (Eval("SendUnit").ToString().Substring(0, 10)) + "..." : (Eval("SendUnit").ToString()))%>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="参与人员" SortExpression="SendRealname">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("SendRealname").ToString().Length > 10) ? (Eval("SendRealname").ToString().Substring(0, 10)) + "..." : (Eval("SendRealname").ToString()))%>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>
