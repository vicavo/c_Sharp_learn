...
namespace qpoa
{
    public partial class AssetsType : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc6cb", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "cccc6cd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc6ce", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc6ci", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_AssetsType where 1=1";
            SqlStrStartCount = "select count(id) from qp_AssetsType where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_AssetsType";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_AssetsType " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
