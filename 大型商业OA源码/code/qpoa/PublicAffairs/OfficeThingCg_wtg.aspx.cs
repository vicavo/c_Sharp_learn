...
{
    public partial class OfficeThingCg_wtg : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_OfficeThingCg where 1=1 and   ( Shenpi='未通过'  or Shenpi='放弃审批') and    (Username='" + this.Session["username"] + "')";
            SqlStrStartCount = "select count(id) from qp_OfficeThingCg where 1=1 and    ( Shenpi='未通过'  or Shenpi='放弃审批') and    (Username='" + this.Session["username"] + "')";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_OfficeThingCg where   ( Shenpi='未通过'  or Shenpi='放弃审批')  and   (Username='" + this.Session["username"] + "')";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_OfficeThingCg where    ( Shenpi='未通过'  or Shenpi='放弃审批')  and   (Username='" + this.Session["username"] + "') " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
        ...
        {
            Response.Redirect("OfficeThingCg_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("OfficeThingCg_add.aspx");
        }

        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("OfficeThingCg_update.aspx?id=" + CheckCbxUpdate() + "");
        }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_OfficeThingCg  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除办公用品入库登记[" + CheckCbxNameDel() + "]", "办公用品入库登记");
