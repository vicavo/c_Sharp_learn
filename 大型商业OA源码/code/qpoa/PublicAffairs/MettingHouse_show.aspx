<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingHouse_show.aspx.cs" Inherits="qpoa.PublicAffairs.MettingHouse_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="MettingHouse.aspx"  class="line_b">会议室设置</a> >> 查看会议室</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" style="height: 17px">
                                    <asp:Label ID="PeopleNum" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                            ...
                            <tr  class="" id="Tr1">
                                ...
                                <td class="newtd2" height="17" width="33%" colspan=3>
                                    <asp:Label ID="Equipment" runat="server" Width="90%"></asp:Label></td>
