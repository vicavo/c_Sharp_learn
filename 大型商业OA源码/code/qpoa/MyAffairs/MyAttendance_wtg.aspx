<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAttendance_wtg.aspx.cs" Inherits="qpoa.MyAffairs.MyAttendance_wtg" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;事由：<input id="jssubject" type="text"  style="width: 418px"/>\
...
if(document.getElementById('jssubject').value!='')
{
midSql=midSql+"Subject="+document.getElementById('jssubject').value+"";
}
...
window.location="MyAttendance_wtg.aspx?type=<%=Request.QueryString["Type"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MyAttendance_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=3&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MyAttendance_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=3&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  个人考勤  >>  <%=Typename%></td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='MyAttendance.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
                                <button class="btn4off" onclick="javascript:window.location='MyAttendance_tg.aspx?type=<%=Request.QueryString["Type"]%>';showwait();" type="button"><font class="shadow_but">已通过</font></button>
                               <button class="btn4on" onclick="javascript:window.location='MyAttendance_wtg.aspx?type=<%=Request.QueryString["Type"]%>';showwait();" type="button"><font class="shadow_but">未通过</font></button>
                            </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Subject") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Subject" HeaderText="事由" SortExpression="Subject">
                                   ...
                                   　　　 <HeaderTemplate>
                                      ...
                                      <asp:BoundField DataField="Shenpi" HeaderText="审批" SortExpression="Shenpi">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
