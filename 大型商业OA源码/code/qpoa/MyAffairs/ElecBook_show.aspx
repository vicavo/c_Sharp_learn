<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ElecBook_show.aspx.cs" Inherits="qpoa.MyAffairs.ElecBook_show" %>
...
function chksearchstr()
{
    ...
    showwait();	
    window.location="ElecBook_show.aspx?id=<%= Request.QueryString["id"] %>&key=1&"+midSql+"";
}
                    ...
                    <td valign="top" >
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                     ...
                                     <asp:TemplateField HeaderText="文件名称" SortExpression="OldName">
                                        ...
                                        <ItemTemplate>
                                           <a href=ElecBook_down.aspx?number=<%# DataBinder.Eval(Container.DataItem, "NewName") %> target=_blank><%# DataBinder.Eval(Container.DataItem, "OldName") %></a>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" HorizontalAlign=Center />
                                    </asp:TemplateField>   
                                    <asp:TemplateField HeaderText="书架名称" SortExpression="FoldersName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <a href="javascript:void(0)" onclick="UploadComplete()">查询文件</a>
                                   将选中文件转移：<asp:DropDownList ID="Folder" runat="server" Width="128px">
                                    </asp:DropDownList>
...
<asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">新建子书架</asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">重命名书架</asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click" >公开书架</asp:LinkButton>
                                    <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click">删除此书架</asp:LinkButton>
                                    文件夹名：<%=Namefile %> 
                                </td>
                            </tr>
