<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyNotic_show.aspx.cs" Inherits="qpoa.MyAffairs.CompanyNotic_show" %>
...
function chknull()
{
    ...
    if(document.getElementById('IfShare').value=='公开给其他公司')
    {
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 公司通知 >> <a href="CompanyNotic.aspx"  class="line_b">公司通知管理</a> >> 查看公司通知</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
...
function  openuser1()  
{  
if(document.getElementById('IfShare').value=='只允许本公司查看')
{
alert('请选择公开给其他公司');
form1.IfShare.focus();
return false;
