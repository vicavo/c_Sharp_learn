<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OftenModle_show.aspx.cs" Inherits="qpoa.MyAffairs.OftenModle_show" %>
...
function chknull()
{
    ...
    if(document.getElementById('Sharing').value=='是')
    {
        ...
        if(document.getElementById('SharingRealname').value=='')
        {
        alert('共享人员不能为空');
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 查看常用模版</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
...
<%=ContractContentupdate%>
                             ...
                             <tr>
                              ...
                              <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:Label ID="SharingRealname" runat="server" Width="90%"></asp:Label></td>
                            </tr>                       
