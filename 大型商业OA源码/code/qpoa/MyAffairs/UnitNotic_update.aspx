<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitNotic_update.aspx.cs" Inherits="qpoa.MyAffairs.UnitNotic_update"  validateRequest="false"%>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 部门通知 >> <a href="UnitNotic.aspx"  class="line_b">部门通知管理</a> >> 修改部门通知</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                           ...
                           <tr>
                               ...
                               <td class="newtd2" colspan="3" height="24">
                                ...
                                <td class="newtd2" height="24" colspan="3">
                                    <asp:DropDownList ID="IfShare" runat="server" Width="95%">
                                        <asp:ListItem>只允许本部门查看</asp:ListItem>
                                        <asp:ListItem>公开给其他部门</asp:ListItem>
                                    </asp:DropDownList></td>
                            </tr>             
