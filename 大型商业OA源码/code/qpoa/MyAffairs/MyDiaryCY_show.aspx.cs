...
{
    public partial class MyDiaryCY_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string SQL_GetList = "select * from qp_MyDiary where ((CHARINDEX('," + this.Session["username"] + ",',','+LdUsername+',')   >   0 )) and  id='" + List.GetFormatStr(Request.QueryString["id"]) + "'";
        ...
        {
            Response.Redirect("MyDiaryCY.aspx");
        }
