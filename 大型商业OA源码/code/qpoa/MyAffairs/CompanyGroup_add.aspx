<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyGroup_add.aspx.cs" Inherits="qpoa.MyAffairs.CompanyGroup_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="CompanyGroup.aspx"  class="line_b">公司通讯录</a> >> 新增公司通讯录</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
