<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ElecBook_add.aspx.cs" Inherits="qpoa.MyAffairs.ElecBook_add" %>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:TextBox ID="remark" runat="server" MaxLength="5000" Width="90%"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                    排序号：</td>
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:TextBox ID="PxNum" runat="server" Width="90%"></asp:TextBox></td>
                            </tr>
                             <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
