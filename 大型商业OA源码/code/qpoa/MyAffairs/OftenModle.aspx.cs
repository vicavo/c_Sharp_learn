...
{
    public partial class OftenModle : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(ImageButton2, "1111l6", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "1111l6", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_OftenModle where Username='" + this.Session["username"] + "' and 1=1";
            SqlStrStartCount = "select count(id) from qp_OftenModle where  Username='" + this.Session["username"] + "' and  1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_OftenModle where  Username='" + this.Session["username"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_OftenModle where  Username='" + this.Session["username"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
