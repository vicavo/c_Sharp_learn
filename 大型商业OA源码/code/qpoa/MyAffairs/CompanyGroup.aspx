<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyGroup.aspx.cs" Inherits="qpoa.MyAffairs.CompanyGroup" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;姓名：<input id="jsName" type="text"  style="width: 398px"/>\
                       <br>&nbsp;&nbsp;&nbsp;部门：<input id="jsUnit" type="text"   style="width: 138px"/>&nbsp;【<A href="javascript:void(0)" onclick="OpenSaleData1()">选择</A>】&nbsp;角色：<input id="jsRespon" type="text"   style="width: 138px"/>&nbsp;【<A href="javascript:void(0)" onclick="OpenSaleData2()">选择</A>】&nbsp;\
                         <br>&nbsp;&nbsp;&nbsp;职位：<input id="jsPost" type="text"   style="width: 138px"/>&nbsp;【<A href="javascript:void(0)" onclick="OpenSaleData3()">选择</A>】&nbsp;性别：<input id="jsSex" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
if(document.getElementById('jsUnit').value!='')
{
midSql=midSql+"&Unit="+document.getElementById('jsUnit').value+"";
}  

if(document.getElementById('jsRespon').value!='')
{
midSql=midSql+"Respon="+document.getElementById('jsRespon').value+"";
}
...
window.location="CompanyGroup.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CompanyGroup_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CompanyGroup_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
function outexcelxs()
{
showwait();
var num=Math.random();
window.open ("CompanyGroup_dc.aspx?tmp="+num+"&xs=<%=Request.QueryString["XS"]%>", "_blank", "height=1, width=1")
}	
...
var num=Math.random();
var str=document.getElementById("jsUnit").value;
...
{
document.getElementById("jsUnit").value=wName1; 
}
...
var num=Math.random();
var str=document.getElementById("jsRespon").value;
...
document.getElementById("jsRespon").value=aaa; 
}
...
{  
var num=Math.random();
var str=document.getElementById("jsPost").value;
...
document.getElementById("jsPost").value=aaa; 
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  通讯录管理  >>  公司通讯录管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='CompanyGroup.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">公司通讯录</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Unit" HeaderText="部门" SortExpression="Unit">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Respon" HeaderText="角色" SortExpression="Respon">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                   <asp:BoundField DataField="Post" HeaderText="职位" SortExpression="Post">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>            
                                       <asp:BoundField DataField="Officetel" HeaderText="办公电话" SortExpression="Officetel">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>      
                                    ...
                                    <asp:TemplateField HeaderText="发送手机短信" >
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                          <a href='javascript:void(0)' onclick='window.open ("smsmodle.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=460, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=100,left=100")'>发送手机短信</a>
                                       </ItemTemplate>
