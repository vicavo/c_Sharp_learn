...
{
    public partial class ElecBook_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            InsertLog("删除电子刊物[" + CheckCbxNameDel() + "]", "电子刊物");
        ...
        {
            string SqlStr = "  Delete from qp_ElecBook  where id='" + IDStr + "'";
            ...
            while (MyReader.Read())
            {
                string SqlStr1 = "  Delete from qp_ElecBook  where id='" + MyReader["ID"].ToString() + "'";
                List.ExeSql(SqlStr1);
                string SQL_GetList1 = "select * from qp_ElecBook where ParentNodesID=" + MyReader["id"] + " ";
        ...
        {
            Response.Redirect("ElecBook_open.aspx?id=" + Request.QueryString["id"] + "");
        }
