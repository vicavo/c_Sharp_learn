...
{
    public partial class Folders_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                string SQL_GetList = "select * from qp_Folders   where id='" + int.Parse(Request.QueryString["id"]) + "'  and username='" + Session["username"] + "'";
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_Paper  where FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "'  and 1=1 ";
            SqlStrStartCount = "select count(id) from qp_Paper  where   FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "'  and  1=1 ";
            ...
            string SQL_GetCount = "select count(id) from  qp_Paper where  FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "' ";
            CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

            string SQL_GetList_xs = "select * from qp_Paper where  FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "' " + Sqlsort + " ";
            GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
            GridView1.DataBind();
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Paper  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);
        ...
        protected void LinkButton7_Click(object sender, EventArgs e)
        {
            ...
            string SQL_GetList = "select * from qp_Folders  where id='" + Folder.SelectedValue + "'";
            SqlDataReader NewReader = List.GetList(SQL_GetList);
            if (NewReader.Read())
            {
                string Sql_update = "Update qp_Paper  Set FoldersName='" + NewReader["Name"] + "',FoldersID='" + NewReader["id"] + "' where ID in (" + CheckStr + ")";
                List.ExeSql(Sql_update);
            }
            NewReader.Close();
  

            InsertLog("转移文件[" + CheckCbxNameDel() + "]", "个人文件柜");
        ...
        protected void LinkButton5_Click(object sender, EventArgs e)
        {
            ...
            //string SQL_GetList = "select * from qp_Folders  where id='" + Request.QueryString["id"] + "'";
            //SqlDataReader NewReader = List.GetList(SQL_GetList);
            //if (NewReader.Read())
            //{
            //    string SqlStr = "  Delete from qp_Folders  where id='" + Request.QueryString["id"] + "'";
            //    List.ExeSql(SqlStr);

            //    string SqlStr1 = "  Delete from qp_Folders  where ParentNodesID='" + Request.QueryString["id"] + "'";
            //    List.ExeSql(SqlStr1);



            //    InsertLog("删除文件夹[" + NewReader["name"] + "]", "个人文件柜");
            //}
            //NewReader.Close();
        ...
        {
            string SqlStr = "  Delete from qp_Folders  where id='" + IDStr + "'";
            ...
            while (MyReader.Read())
            {
                string SqlStr1 = "  Delete from qp_Folders  where id='" + MyReader["ID"].ToString() + "'";
                List.ExeSql(SqlStr1);

                string SQL_GetList1 = "select * from qp_Folders where ParentNodesID=" + MyReader["id"] + " ";
        ...
        protected void LinkButton6_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Folders_showGx.aspx?id=" + Request.QueryString["id"] + "");

        }

        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            Response.Redirect("Folders_add.aspx?id=" + Request.QueryString["id"] + "");
        }

        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            Response.Redirect("Folders_update.aspx?id=" + Request.QueryString["id"] + "");
        }

        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            Response.Redirect("Paper_add.aspx?id=" + Request.QueryString["id"] + "");
        }
