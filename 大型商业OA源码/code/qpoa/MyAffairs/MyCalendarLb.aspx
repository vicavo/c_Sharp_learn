<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCalendarLb.aspx.cs" Inherits="qpoa.MyAffairs.MyCalendarLb" %>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                             ...
                             <button class="btn4on" onclick="javascript:window.location='MyCalendarLb.aspx';showwait();"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CalendarTime" HeaderText="事务时间" SortExpression="CalendarTime" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='MyCalendar_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                             <a href='MyCalendar_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">修改</a>
                                        </ItemTemplate>
