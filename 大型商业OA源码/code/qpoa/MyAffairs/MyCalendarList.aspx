<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCalendarList.aspx.cs" Inherits="qpoa.MyAffairs.MyCalendarList" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      邮件参数：<input id="jsname" type="text" />\
...
function chksearchstr()
{
   ...
   showwait();	
    window.location="Emailprv.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="MyCalendar.aspx" class="line_b">日程安排</a> >> 日程安排信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='MyCalendar.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">日程安排</font></button>
                ...
                <tr>
                    ...
                    <td valign="top">
                    	<table  cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td vAlign="top">
								  以下显示的<font color=red><%= Request.QueryString["time"]%></font>的信息
                                    ...
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CalendarTime") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="CalendarTime" HeaderText="事务时间" SortExpression="CalendarTime" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                     ...
                                     <asp:TemplateField HeaderText="开始时间">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "StarttimeHour") %>：<%# DataBinder.Eval(Container.DataItem, "StarttimeMini") %>
                                        </ItemTemplate>
                                      ...
                                      <asp:TemplateField HeaderText="结束时间">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                              <%# DataBinder.Eval(Container.DataItem, "EndtimeHour") %>：<%# DataBinder.Eval(Container.DataItem, "EndtimeMini") %>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" HorizontalAlign=Center />
                                    </asp:TemplateField>  
                                      ...
                                      <asp:TemplateField HeaderText="内容">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                             <%# ((Eval("Content").ToString().Length > 15) ? (Eval("Content").ToString().Substring(0, 10)) + "..." : (Eval("Content").ToString()))%>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" HorizontalAlign=Center />
                                    </asp:TemplateField>                 
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='MyCalendar_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&time=<%= Request.QueryString["time"]%>' onclick="showwait();">查看</a>
                                             <a href='MyCalendar_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&time=<%= Request.QueryString["time"]%>' onclick="showwait();">修改</a>
                                        </ItemTemplate>
