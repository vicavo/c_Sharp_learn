<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDiary_show.aspx.cs" Inherits="qpoa.MyAffairs.MyDiary_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="MyDiary.aspx"  class="line_b">日志上报</a> >> 查看日志上报</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
