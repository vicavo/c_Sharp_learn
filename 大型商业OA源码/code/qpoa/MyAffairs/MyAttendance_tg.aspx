<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAttendance_tg.aspx.cs" Inherits="qpoa.MyAffairs.MyAttendance_tg" %>
...
window.location="MyAttendance_tg.aspx?type=<%=Request.QueryString["Type"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MyAttendance_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=2&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MyAttendance_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=2&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='MyAttendance.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
                                <button class="btn4on" onclick="javascript:window.location='MyAttendance_tg.aspx?type=<%=Request.QueryString["Type"]%>';showwait();" type="button"><font class="shadow_but">已通过</font></button>
                               <button class="btn4off" onclick="javascript:window.location='MyAttendance_wtg.aspx?type=<%=Request.QueryString["Type"]%>';showwait();" type="button"><font class="shadow_but">未通过</font></button>
                            </td>
