<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyNetMetting_ycy.aspx.cs" Inherits="qpoa.MyAffairs.MyNetMetting_ycy" %>
...
function chksearchstr()
{
    ...
    window.location="MyNetMetting_ycy.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4off" onclick="javascript:window.location='MyNetMetting.aspx';showwait();" type="button"><font class="shadow_but">我的会议</font></button>
                               <button class="btn4on" onclick="javascript:window.location='MyNetMetting_ycy.aspx';showwait();" type="button"><font class="shadow_but">参与会议</font></button>
