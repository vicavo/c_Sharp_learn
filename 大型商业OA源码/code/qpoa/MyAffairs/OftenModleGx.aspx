<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OftenModleGx.aspx.cs" Inherits="qpoa.MyAffairs.OftenModleGx" %>
...
function chksearchstr()
{
   ...
   showwait();	
    window.location="OftenModleGx.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 常用模版</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='OftenModle.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">我的模版</font></button>
                                <button class="btn4on" onclick="javascript:window.location='OftenModleGx.aspx';showwait();" type="button"><font class="shadow_but">共享模版</font></button>
                            </td>
                        ...
                        <div id="Div1">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="模版名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    
                                     <asp:BoundField DataField="Realname" HeaderText="拥有人" SortExpression="Realname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                   
                                    
                                    
                                    <asp:TemplateField HeaderText="共享人员" SortExpression="SharingRealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("SharingRealname").ToString().Length > 15) ? (Eval("SharingRealname").ToString().Substring(0, 15)) + "..." : (Eval("SharingRealname").ToString()))%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
