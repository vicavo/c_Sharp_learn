...
{
    public partial class MyCalendarLb : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                if (Request.QueryString["CalendarTime"] != null)
                {
                    MidSql = MidSql + " and (convert(char(10),cast(CalendarTime as datetime),120)=convert(char(10),cast('" + Request.QueryString["CalendarTime"] + "' as datetime),120) ) ";
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(ImageButton3, "1111f", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_MyCalendar  where Username='" + this.Session["username"] + "' and 1=1";
            SqlStrStartCount = "select count(id) from qp_MyCalendar  where  Username='" + this.Session["username"] + "' and  1=1";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_MyCalendar where  Username='" + this.Session["username"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_MyCalendar where  Username='" + this.Session["username"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_MyCalendar   where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除日程安排[" + CheckCbxNameDel() + "]", "日程安排");
