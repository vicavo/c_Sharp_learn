<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emailprv.aspx.cs" Inherits="qpoa.MyAffairs.Emailprv" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 邮件参数设置</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Emailprv.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">邮件参数</font></button>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EmailAdd" HeaderText="邮件地址" SortExpression="EmailAdd">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='Emailprv_Pass.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">修改密码</a>
                                        </ItemTemplate>
