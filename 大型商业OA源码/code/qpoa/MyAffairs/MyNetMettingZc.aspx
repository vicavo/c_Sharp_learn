<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyNetMettingZc.aspx.cs" Inherits="qpoa.MyAffairs.MyNetMettingZc" %>
...
function chksearchstr()
{
    ...
    window.location="MyNetMettingZc.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              ...
                              <button class="btn4on" onclick="javascript:window.location='MyNetMettingZc.aspx';showwait();" type="button"><font class="shadow_but">主持会议</font></button>
                            </td>
