...
namespace qpoa.MyAffairs
{
    public partial class Folders_add : System.Web.UI.Page
    {
        ...
        {
            string SQL_GetList_sta = "select top 1 * from qp_Folders where id='" + ParentNodesID.SelectedValue + "' ";
            ...
            {
                string SQL_GetList = "select top 1 * from qp_Folders where ParentNodesID='0' order by QxString desc";
            ...
            {
                string SQL_GetList = "select  * from qp_Folders where id='" + ParentNodesID.SelectedValue + "'";
                ...
                if (NewReader.Read())
                {
                    if (NewReader["QxString"].ToString().Length == 5)
                    {
                        ...
                        string SQL_GetList_key = "select  top 1 * from qp_Folders where  QxString like '%" + NewReader["QxString"].ToString() + "%' and  len(QxString)=9 order by QxString desc";
                    ...
                    {
                        //有数字可以直接加
                        string SQL_GetList_key = "select  top 1 * from qp_Folders where  QxString like '%" + NewReader["QxString"].ToString() + "%' and  len(QxString)=" + NewReader["QxString"].ToString().Length + "+4 order by QxString desc";
                       ...
                       // Response.Write("SQL_GetList_key：" + SQL_GetList_key + "<br>");
                        ...
                        {
                            string SQL_GetList_key1 = "select  top 1 * from qp_Folders where  QxString like '%" + NewReader["QxString"].ToString().Substring(0, NewReader["QxString"].ToString().Length - 4) + "%' and  len(QxString)=" + NewReader["QxString"].ToString().Length + " order by QxString desc";
