<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDiaryCY.aspx.cs" Inherits="qpoa.MyAffairs.MyDiaryCY" %>
...
function chksearchstr()
{
   ...
   showwait();	
   window.location="MyDiaryCY.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 日志查阅</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                             <button class="btn4off" onclick="javascript:window.location='MyDiaryCY.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">日志查阅</font></button>
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="内容">
                                        ...
                                        <ItemStyle Wrap="False" HorizontalAlign=Center />
                                                      ...
                                                      <asp:BoundField DataField="Realname" HeaderText="上报人" SortExpression="Realname" >
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>     
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='MyDiaryCY_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                        </ItemTemplate>
