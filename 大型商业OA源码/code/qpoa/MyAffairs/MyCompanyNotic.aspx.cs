...
namespace qpoa
{
    public partial class MyCompanyNotic : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(IMG1, "11c11c11", Session["perstr"].ToString());
            List.QuanXianVis(GridView1, "11c11c11", Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_CompanyNotic where (CHARINDEX('," + this.Session["UnitId"] + ",',','+GxUnitNameId+',')   >   0 ) and 1=1";
            SqlStrStartCount = "select count(id) from qp_CompanyNotic where (CHARINDEX('," + this.Session["UnitId"] + ",',','+GxUnitNameId+',')   >   0 ) and  1=1";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_CompanyNotic  where (CHARINDEX('," + this.Session["UnitId"] + ",',','+GxUnitNameId+',')   >   0 ) ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from qp_CompanyNotic   where (CHARINDEX('," + this.Session["UnitId"] + ",',','+GxUnitNameId+',')   >   0 )  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
