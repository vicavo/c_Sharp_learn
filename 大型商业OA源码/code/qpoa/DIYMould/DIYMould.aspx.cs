...
{
    public partial class DIYMould : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string SQL_GetCount = "select count(id) from  qp_DIYMould where Username='" + Session["Username"] + "'";
            CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

            string SQL_GetList_xs = "select * from qp_DIYMould where Username='" + Session["Username"] + "' " + Sqlsort + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_DIYMould  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除工作台模块[" + CheckCbxNameDel() + "]", "工作台模块");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("DIYMould_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("DIYMould_add.aspx");
        }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "shangyi")
            {
                ...
                string SQL_GetList = "select top 1 * from qp_DIYMould where Paixun<" + PaiXunId.ToString() + "  and Username='" + Session["Username"] + "' order by paixun desc";
                ...
                if (NewReader.Read())
                {
                    ...
                    string Sql_update_n = "Update qp_DIYMould  Set Paixun='" + NewReader["PaiXun"].ToString() + "'  where Paixun='" + PaiXunId.ToString() + "'";
                    List.ExeSql(Sql_update_n);


                    string Sql_update_s = "Update qp_DIYMould  Set Paixun='" + PaiXunId.ToString() + "'  where id='" + NewReader["id"].ToString() + "'";
            ...
            if (e.CommandName == "xiayi")
            {
                ...
                string SQL_GetList = "select top 1 * from qp_DIYMould where Paixun>" + PaiXunId.ToString() + "  and Username='" + Session["Username"] + "' order by paixun asc";
                SqlDataReader NewReader = List.GetList(SQL_GetList);
                if (NewReader.Read())
                {
        ...
        {
            Response.Redirect("DIYMould_show.aspx?type=" + type + "&id=" + CheckCbxUpdate() + "");
        }
