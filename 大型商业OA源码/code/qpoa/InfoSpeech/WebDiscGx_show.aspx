<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebDiscGx_show.aspx.cs" Inherits="qpoa.InfoSpeech.WebDiscGx_show" %>
    ...
    <td valign="top">
      <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="17" style="height: 381px">
                        &nbsp;</td>
                    <td valign="top" style="height: 381px">
