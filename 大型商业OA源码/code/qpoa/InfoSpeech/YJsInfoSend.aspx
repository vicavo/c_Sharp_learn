<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YJsInfoSend.aspx.cs" Inherits="qpoa.InfoSpeech.YJsInfoSend" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;文件主题：<input id="jsTitle" type="text"  style="width: 398px"/>\
                       <br>&nbsp;&nbsp;&nbsp;文件内容：<input id="jsContent" type="text"   style="width: 138px"/>&nbsp;&nbsp;传阅时间：<input id="jsSettime" type="text"   style="width: 138px"/>格式yyyy-mm-dd&nbsp;\
...
window.location="YJsInfoSend.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  接收文件</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='JsInfoSend.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">未阅读</font></button>
                                     <button class="btn4on" onclick="javascript:window.location='YJsInfoSend.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">已阅读</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                     <asp:TemplateField HeaderText="标题" SortExpression="Title">
                                        ...
                                        <ItemTemplate>
                                          <a href=YJsInfoSend_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "Gid") %>><%# DataBinder.Eval(Container.DataItem, "Title") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField> 
                                    
                                    <asp:BoundField DataField="GState" HeaderText="状态" SortExpression="GState">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    
                                    
                                    <asp:BoundField DataField="LSettime" HeaderText="创建时间" SortExpression="LSettime">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    
                                    <asp:TemplateField HeaderText="相关操作">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="60px"/>
                                        <ItemTemplate>
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Gid")%>' Visible=false></asp:Label>
                                          <a href="YJsInfoSend_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "Gid")%>">查看</a>
                                        </ItemTemplate>
