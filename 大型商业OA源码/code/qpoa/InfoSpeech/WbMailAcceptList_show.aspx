<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WbMailAcceptList_show.aspx.cs" Inherits="qpoa.InfoSpeech.WbMailAcceptList_show" %>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="17" colspan="3" width="85%">
                                    <asp:Label ID="txtSender" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:Label ID="txtSubject" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%" style="word-break:break-all">
                                    <asp:Label ID="txtBody" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
