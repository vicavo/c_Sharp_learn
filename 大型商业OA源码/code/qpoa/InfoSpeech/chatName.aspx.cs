...
{
    public partial class chatName : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "dddd5b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "dddd5b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "dddd5b", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "dddd5b", Session["perstr"].ToString());
            List.QuanXianVis(GridView1, "dd5dd5b1", Session["perstr"].ToString());
        }
        ...
        {
            SqlStrStart = "select * from qp_chatName where 1=1";
            SqlStrStartCount = "select count(id) from qp_chatName where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_chatName";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_chatName " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_chatName  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除聊天室[" + CheckCbxNameDel() + "]", "聊天室管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("chatName_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("chatName_add.aspx");
        }
        ...
        {
            Response.Redirect("chatName_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("chatName_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
