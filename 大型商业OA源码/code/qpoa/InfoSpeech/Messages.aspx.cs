...
namespace qpoa.InfoSpeech
{
    public partial class Messages : System.Web.UI.Page
    {
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            {
                SqlStrStart = "select * from qp_Messages where sfck='否' and acceptusername='" + Session["username"] + "' and 1=1";
                SqlStrStartCount = "select count(id) from qp_Messages where sfck='否' and  acceptusername='" + Session["username"] + "'  and 1=1";
            }
            ...
            else
            {
                ...
                if (List.StrIFInStr("dd1dd1a", Session["perstr"].ToString()))
                {
                    ...
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_Messages where sfck='否' and  acceptusername='" + Session["username"] + "'  " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
