<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JsInfoSend_show_online.aspx.cs" Inherits="qpoa.InfoSpeech.JsInfoSend_show_online" %>
...
<HTML>
	<HEAD>
		...
		function chknull()
		{
			...
			document.all.FramerControl1.caption = "在线阅读：<%=forname%>";
	...
	<body onload="chknull();">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　在线阅读</td>
				</tr>
				<tr>
