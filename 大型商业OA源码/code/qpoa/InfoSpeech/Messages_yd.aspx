<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messages_yd.aspx.cs" Inherits="qpoa.InfoSpeech.Messages_yd" %>
...
window.location="Messages_yd.aspx?key=1&"+midSql+"";
}
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Messages.aspx';showwait();"
                                  ...
                                  <button class="btn4on" onclick="javascript:window.location='Messages_yd.aspx';showwait();"
