<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="toupiaobt_update.aspx.cs" Inherits="qpoa.InfoSpeech.toupiaobt_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; 修改投票主题</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off" 
                                    type="button">
                                    <font class="shadow_but">投票主题</font></button></td>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    ...
                                    选择类型：</td>
                                <td class="newtd2" height="17" colspan="3" width="83%">
                                    <asp:DropDownList ID="xuanze" runat="server" Width="95%">
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="83%">
                                    <asp:DropDownList ID="ifopen" runat="server" Width="95%">
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17">
                                     <asp:TextBox ID="Gkrealname" runat="server" Height="55px" TextMode="MultiLine" Width="85%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser1();" alt="" src="../images/FDJ.gif" border="0"></A></td>
                            </tr>
