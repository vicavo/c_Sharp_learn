<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatName_update.aspx.cs" Inherits="qpoa.InfoSpeech.chatName_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="chatName.aspx"  class="line_b">聊天室管理</a> >> 修改聊天室信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
