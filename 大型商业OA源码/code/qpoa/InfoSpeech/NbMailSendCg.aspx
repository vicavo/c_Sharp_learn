<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NbMailSendCg.aspx.cs" Inherits="qpoa.InfoSpeech.NbMailSendCg" %>
...
window.location="NbMailSendCg.aspx?key=1&"+midSql+"";
}
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='NbMailAccept.aspx';showwait();"
                                  ...
                                  <button class="btn4on" onclick="javascript:window.location='NbMailSendCg.aspx';showwait();"
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailSendCg_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "sendrealname") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField> 
                                 <asp:TemplateField HeaderText="邮件主题" SortExpression="title">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailSendCg_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "title") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
