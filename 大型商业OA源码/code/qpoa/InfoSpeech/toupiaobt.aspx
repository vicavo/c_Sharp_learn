<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="toupiaobt.aspx.cs" Inherits="qpoa.InfoSpeech.toupiaobt" %>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="投票主题">
                                        ...
                                        <ItemTemplate>
                                          <a href='toupiaobtmanage.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();"><%# DataBinder.Eval(Container.DataItem, "title") %></a>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>    
                                    <asp:BoundField DataField="xuanze" HeaderText="选择类型" SortExpression="xuanze">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                     <asp:BoundField DataField="type" HeaderText="当前状态" SortExpression="type">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                   
                                    <asp:BoundField DataField="ifopen" HeaderText="公开投票" SortExpression="ifopen">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                                                     
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                           ...
                                           <a href='toupiaobt_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">修改</a>
                                            <a href='toupiaobtmanage.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">管理</a>
                                            <asp:LinkButton ID="canyu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="canyu">结束</asp:LinkButton>
                                             <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="gongkai">公开</asp:LinkButton>
                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="guanbi">关闭</asp:LinkButton>
                                        </ItemTemplate>
