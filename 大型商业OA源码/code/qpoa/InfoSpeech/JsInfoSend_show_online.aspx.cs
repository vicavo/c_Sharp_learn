...
{
    public partial class JsInfoSend_show_online : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string SQL_GetList1 = "select * from qp_InfoSend  where Number='" + Request.QueryString["number"].ToString() + "' and  AllowUpdate='是'";
