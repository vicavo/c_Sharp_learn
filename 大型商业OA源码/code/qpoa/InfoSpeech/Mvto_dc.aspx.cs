...
{
    public partial class Mvto_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview()
        {
            ...
            {
                string SQL_GetList_xs = "select * from OutBox where 1=1 and username='" + Session["realname"] + "(" + Session["Username"] + ")' order by id desc";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
