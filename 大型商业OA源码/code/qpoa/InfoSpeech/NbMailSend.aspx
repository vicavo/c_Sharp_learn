<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NbMailSend.aspx.cs" Inherits="qpoa.InfoSpeech.NbMailSend" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;邮件主题：<input id="jstitle" type="text"  style="width: 398px"/>\
                       <br>&nbsp;&nbsp;&nbsp;发送人员：<input id="jssendrealname" type="text"   style="width: 138px"/>&nbsp;&nbsp;发送时间：<input id="jsitimes" type="text"   style="width: 138px"/>格式yyyy-mm-dd&nbsp;\
...
if(document.getElementById('jsitimes').value!='')
{
var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
if(!objRe.test(document.getElementById('jsitimes').value))
{
alert('日期格式不正确，请按照yyyy-mm-dd格式输入');

return false;
}  
midSql=midSql+"itimes="+document.getElementById('jsitimes').value+"";
} 

 
showwait();

window.location="NbMailSend.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  内部邮件管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='NbMailAccept.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">收件箱</font></button>
                                  <button class="btn4off" onclick="javascript:window.location='NbMailSendCg.aspx';showwait();"
                                    type="button"><font class="shadow_but">草稿箱</font></button>
                                 <button class="btn4on" onclick="javascript:window.location='NbMailSend.aspx';showwait();"
                                    type="button"><font class="shadow_but">已发送</font></button>
                              <button class="btn4off" onclick="javascript:window.location='NbMailSendDel.aspx';showwait();"
                                    type="button"><font class="shadow_but">已删除</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "title") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                                <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "sfck") %>'
                                               Visible="False" Width="0px"></asp:Label> 
                                        ...
                                        <asp:TemplateField HeaderText="接收人" SortExpression="acceptrealname">
                                        <ItemStyle Wrap="True" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailSend_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "acceptrealname")%></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField> 
                                 <asp:TemplateField HeaderText="邮件主题" SortExpression="title">
                                        <ItemStyle Wrap="True" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailSend_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "title") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
