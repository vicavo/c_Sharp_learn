<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WbMailAcceptList.aspx.cs" Inherits="qpoa.InfoSpeech.WbMailAcceptList" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 外部邮件</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='WbMail.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">收件箱</font></button>
    
       <button class="btn4off" onclick="javascript:window.location='WbSendMail.aspx';showwait();"
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "txtSender") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="发件人">
                                        ...
                                        <ItemTemplate>
                                          <a href='WbMailAcceptList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();"><%# DataBinder.Eval(Container.DataItem, "txtSender") %>[<%# DataBinder.Eval(Container.DataItem, "txtSendMail") %>]</a>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>    
                                    <asp:BoundField DataField="txtSubject" HeaderText="邮件主题" SortExpression="txtSubject">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                  
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='WbMailAcceptList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                        </ItemTemplate>
