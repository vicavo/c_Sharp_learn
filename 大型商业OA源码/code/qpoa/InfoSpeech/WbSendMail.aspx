<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WbSendMail.aspx.cs" Inherits="qpoa.InfoSpeech.WbSendMail" %>
    ...
    <td valign="top"><table width="100%" height="23" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
       ...
       <button class="btn4on" onclick="javascript:window.location='WbSendMail.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">发件箱</font></button>
                                    ...
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "EmailName") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="EmailName" HeaderText="邮箱名称" SortExpression="EmailName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="EmailAdd" HeaderText="邮件地址" SortExpression="EmailAdd">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                  
  
                                      <asp:TemplateField HeaderText="邮件主页">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="80px"/>
                                        <ItemTemplate>
                                            <a href="<%# DataBinder.Eval(Container.DataItem, "MainNet") %>" target="blank " >邮件主页</a>
                                        </ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="80px"/>
                                        <ItemTemplate>
                                            <a href='WbSendMailList.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">发件箱</a>
                                        </ItemTemplate>
