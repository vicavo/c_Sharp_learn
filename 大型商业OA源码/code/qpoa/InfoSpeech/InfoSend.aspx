<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoSend.aspx.cs" Inherits="qpoa.InfoSpeech.InfoSend" %>
...
window.location="InfoSend.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='InfoSend.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">传阅文件</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                     <asp:TemplateField HeaderText="标题" SortExpression="Title">
                                        ...
                                        <ItemTemplate>
                                          <a href=InfoSend_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "Title") %></a>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="Settime" HeaderText="创建时间" SortExpression="Settime">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                          <a href="InfoSend_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">查看</a>
                                           <a href="InfoSend_update.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">修改</a>
                                            ...
                                            <asp:LinkButton ID="ZtOrQd" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="ZtOrQd">暂停/启动</asp:LinkButton>
                                        </ItemTemplate>
