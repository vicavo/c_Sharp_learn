<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MvTo.aspx.cs" Inherits="qpoa.InfoSpeech.MvTo" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                            &nbsp;短信内容：<input id="jsMsg" type="text"  style="width: 334px"/> \
                         <br>&nbsp;手&nbsp;机&nbsp;号&nbsp;：<input id="jsmbno" type="text" />&nbsp;计划时间：<input id="jsSendTime" type="text" />yyyy-mm-dd\
...
function chksearchstr()
{
	...
	showwait();
    window.location="MvTo.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("Mvto_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("Mvto_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='MvTo.aspx';showwait();">
