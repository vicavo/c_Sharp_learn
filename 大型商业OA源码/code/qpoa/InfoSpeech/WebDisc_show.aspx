<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebDisc_show.aspx.cs" Inherits="qpoa.MyAffairs.WebDisc_show" %>
...
function chksearchstr()
{
    ...
    showwait();	
    window.location="WebDisc_show.aspx?id=<%= Request.QueryString["id"] %>&key=1&"+midSql+"";
}
                    ...
                    <td valign="top" >
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="文件名称" SortExpression="OldName">
                                        ...
                                        <ItemTemplate>
                                           <a href=WebDisc_down.aspx?number=<%# DataBinder.Eval(Container.DataItem, "NewName") %> target=_blank><%# DataBinder.Eval(Container.DataItem, "OldName") %></a>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" HorizontalAlign=Center />
                                    </asp:TemplateField>   
                                    <asp:TemplateField HeaderText="文件夹名称" SortExpression="FoldersName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("FoldersName").ToString().Replace("-", "").Replace("|", "")))%>
                                        </ItemTemplate>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <a href="javascript:void(0)" onclick="UploadComplete()">查询文件</a>
                                   将选中文件转移：<asp:DropDownList ID="Folder" runat="server" Width="153px">
                                    </asp:DropDownList>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                  ...
                                  &nbsp;&nbsp;<font color="#000000">页码：<asp:TextBox ID="GoPage" runat="server" Width="25px"></asp:TextBox>
                                      ...
                                      &nbsp;&nbsp;共有<font color=red><%=CountsLabel%></font>条数据&nbsp; 当前为第<font color=red><%=CurrentlyPageLabel%></font>页 
