<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="toupiaobtmanage_update.aspx.cs" Inherits="qpoa.InfoSpeech.toupiaobtmanage_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; 修改投票选项</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="83%">
                                    <asp:TextBox ID="TpRealname" runat="server" Width="95%" Height="83px" TextMode="MultiLine"></asp:TextBox></td>
                            </tr>
