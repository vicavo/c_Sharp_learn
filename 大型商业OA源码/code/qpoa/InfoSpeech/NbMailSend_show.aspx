<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NbMailSend_show.aspx.cs" Inherits="qpoa.InfoSpeech.NbMailSend_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; 查看内部邮件</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="17%">
                                    邮件内容：</td>
                                <td class="newtd2" height="17" colspan="3"><%=content %>
