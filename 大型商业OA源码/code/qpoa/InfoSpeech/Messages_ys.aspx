<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messages_ys.aspx.cs" Inherits="qpoa.Messages_ys" %>
...
window.location="Messages_ys.aspx?key=1&"+midSql+"";
}
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Messages.aspx';showwait();"
                                 ...
                                 <button class="btn4off" onclick="javascript:window.location='Messages_yf.aspx';showwait();"
                                    type="button"><font class="shadow_but">已发消息</font></button>
                              <button class="btn4on" onclick="javascript:window.location='Messages_ys.aspx';showwait();"
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="消息标题" SortExpression="title">
                                    ...
                                    <asp:BoundField DataField="sendrealname" HeaderText="发送人" SortExpression="sendrealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                   <asp:BoundField DataField="sfck" HeaderText="是否阅读" SortExpression="sfck">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
