...
namespace qpoa.FilesManage
{
    public partial class FilesManageBookXh : System.Web.UI.Page
    {
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(ImageButton3, "hhhh6", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "hhhh6", Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            if (List.StrIFInStr("hhhh6", Session["perstr"].ToString()))
            {
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            InsertLog("删除文件管理[" + CheckCbxNameDel() + "]", "档案销毁");
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "HuanYuan")
            {
                ...
                InsertLog("还原文件", "档案销毁");
                this.Response.Write("<script language=javascript>alert('还原成功！');</script>");
                DataBindToGridview("order by id desc");
            }
