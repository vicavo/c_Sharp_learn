<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageYSp.aspx.cs" Inherits="qpoa.FilesManage.FilesManageYSp" %>
...
window.location="FilesManageYSp.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageSp.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">未审批</font></button>
                                 <button class="btn4on" onclick="javascript:window.location='FilesManageYSp.aspx';showwait();"
