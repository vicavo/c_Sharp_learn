...
namespace qpoa.FilesManage
{
    public partial class FilesManageYSp : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            //        string Sql_update = "Update qp_FilesManageBook Set JrUsername=JrUsername+'" + NewReader["JrUsername"] + ",' , JrRealname=JrRealname+'" + NewReader["JrRealname"] + ",'  where  id='" + NewReader["BookId"] + "'";
            //        List.ExeSql(Sql_update);


            //        string Sql_updateLog = "Update qp_FilesManageBookLog  Set State='未归还'  where id='" + ID + "'";
            //        List.ExeSql(Sql_updateLog);


            //        string sql_insertgly = "insert into qp_Messages  (title,content,itimes,acceptusername,acceptrealname,sendusername,sendrealname,sfck,url,number) values ('您申请的借阅文件[" + NewReader["Num"] + "]！已经通过审批！','您申请的借阅文件[" + NewReader["Num"] + "]！已经通过审批！','" + System.DateTime.Now.ToString() + "','" + NewReader["JrUsername"] + "','" + NewReader["JrRealname"] + "','系统消息','系统消息','否','FilesManage/FilesManageJy_ytg.aspx','" + System.DateTime.Now.Year.ToString() + "" + System.DateTime.Now.Month.ToString() + "" + System.DateTime.Now.Day.ToString() + "" + System.DateTime.Now.Second.ToString() + "" + System.DateTime.Now.Millisecond.ToString() + "')";
