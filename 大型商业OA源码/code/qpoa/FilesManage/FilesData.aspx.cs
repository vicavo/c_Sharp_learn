...
{
    public partial class FilesData : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "hhhh7b", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "hhhh7d", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "hhhh7e", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "hhhh7i", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_FilesData where type='" + Request.QueryString["type"] + "' and  1=1";
            SqlStrStartCount = "select count(id) from qp_FilesData where type='" + Request.QueryString["type"] + "' and 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_FilesData where type='" + Request.QueryString["type"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_FilesData where type='" + Request.QueryString["type"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_FilesData  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除基础数据设置[" + CheckCbxNameDel() + "]", "基础数据设置-" + typename + "");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("FilesData_update.aspx?type=" + type + "&id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("FilesData_add.aspx?type=" + type + "&");
        }
