<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageYgh.aspx.cs" Inherits="qpoa.FilesManage.FilesManageYgh" %>
...
window.location="FilesManageYgh.aspx?key=1&"+midSql+"";
}
                            ...
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageJy.aspx';showwait();"
                                 ...
                                 <button class="btn4off" onclick="javascript:window.location='FilesManageJy_ytg.aspx';showwait();"
                                    type="button"><font class="btn4off">未归还</font></button>
                                    ...
                                    type="button"><font class="shadow_but">拒绝借阅</font></button>      
                                     ...
                                     <button class="btn4on" onclick="javascript:window.location='FilesManageYgh.aspx';showwait();"
