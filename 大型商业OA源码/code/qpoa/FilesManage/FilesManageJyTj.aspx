<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageJyTj.aspx.cs" Inherits="qpoa.FilesManage.FilesManageJyTj" %>
...
window.location="FilesManageJyTj.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  借阅统计</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageBook.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">借阅统计</font></button>
