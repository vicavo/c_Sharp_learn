<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesRoom.aspx.cs" Inherits="qpoa.FilesManage.FilesRoom" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;&nbsp;&nbsp;卷库名称：<input id="jsName" type="text"  style="width: 398px"/>\
                         <br>&nbsp;&nbsp;&nbsp;所属部门：<input id="jsUnitName" type="text"  style="width: 398px"/>\
...
window.location="FilesRoom.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  卷库管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesRoom.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">卷库管理</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Number" HeaderText="卷库号" SortExpression="Number">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                     <asp:BoundField DataField="Name" HeaderText="卷库名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                   
