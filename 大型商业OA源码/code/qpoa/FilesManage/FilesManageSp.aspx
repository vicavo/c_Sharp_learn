<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageSp.aspx.cs" Inherits="qpoa.FilesManage.FilesManageSp" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      <br>&nbsp;&nbsp;&nbsp;文件标题：<input id="jsTitle" type="text"   style="width: 138px"/>&nbsp;&nbsp;借阅人员：<input id="jsJyRealname" type="text"   style="width: 138px"/>\
...
if(document.getElementById('jsJyRealname').value!='')
{
midSql=midSql+"JyRealname="+document.getElementById('jsJyRealname').value+"";
}
...
window.location="FilesManageSp.aspx?key=1&"+midSql+"";
}
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                         <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 案卷审批</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='FilesManageSp.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">未审批</font></button>
                                 <button class="btn4off" onclick="javascript:window.location='FilesManageYSp.aspx';showwait();"
                                    type="button"><font class="shadow_but">已审批</font></button>
                            </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="文件号" SortExpression="Num">
                                        ...
                                        <ItemTemplate>
                                            <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "BookId") %>);"> <%# ((Eval("Num").ToString()))%></a>
                                        </ItemTemplate>
                                   ...
                                   <asp:BoundField DataField="JyRealname" HeaderText="借阅人姓名" SortExpression="JyRealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>           
                                       <asp:BoundField DataField="JyTime" HeaderText="借阅时间" SortExpression="JyTime">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                            
                                   ...
                                   <asp:BoundField DataField="State" HeaderText="状态" SortExpression="State">
                                       ...
                                       <asp:BoundField DataField="GhTime" HeaderText="归还时间" SortExpression="GhTime">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>  
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                      ...
                                      <asp:Label ID="LJyUsername" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "JyUsername")%>' Visible=false></asp:Label>
                                      
                                      <asp:LinkButton ID="TongGuo" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="TongGuo">通过</asp:LinkButton>
                                            <asp:LinkButton ID="JuJue" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="JuJue">拒绝</asp:LinkButton>
