...
namespace qpoa.FilesManage
{
    public partial class FilesManageJyTj : System.Web.UI.Page
    {
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(IMG1, "hhhh5a", Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            if (List.StrIFInStr("hhhh5a", Session["perstr"].ToString()))
            {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_FilesManageBookLog  where  BookId='" + ln.Text + "'";
                string CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                ll4.Text = CountsLabel;
