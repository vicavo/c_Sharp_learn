<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDataUpdate.aspx.cs" Inherits="qpoa.MyDataUpdate" %>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" style="height: 564px">
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                              ...
                              <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    ...
                                    部门名称：</td>
                                <td class="newtd2" height="17" width="33%">
                                    <asp:TextBox ID="Unit" runat="server" Width="90%"></asp:TextBox></td>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                    职位：</td>
                                <td class="newtd2" height="17" width="35%">
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="24" width="33%">
                                    <asp:TextBox ID="Sex" runat="server" Width="90%"></asp:TextBox></td>
                                <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                    width="15%">
                                    生日：</td>
                                <td class="newtd2" height="24" width="35%">
                                    <asp:TextBox ID="Bothday" runat="server" Width="90%"></asp:TextBox></td>
                            </tr>
                           ...
                           <tr class="" id="nextrs1">
                            ...
                            <tr>
                                ...
                                <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                    ...
                                    小灵通：</td>
                                <td class="newtd2" height="24" width="35%">
                                    <asp:TextBox ID="LittleTel" runat="server" Width="90%"></asp:TextBox></td>
                            </tr>
                                ...
                                <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                   ...
                                   QQ号码：</td>
                                <td class="newtd2" height="24" width="35%">
                                    <asp:TextBox ID="QQNum" runat="server" Width="90%"></asp:TextBox></td>
                            </tr>  
                            ...
                            <tr>
                                <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                    ...
                                    MSN：</td>
                                <td class="newtd2" height="24" width="33%">
                                    <asp:TextBox ID="Msn" runat="server" Width="90%"></asp:TextBox></td>
                                <td align="right" class="newtd1" height="24" nowrap="nowrap"
                                    width="15%">
                                   ICQ号码：</td>
                                <td class="newtd2" height="24" width="35%">
                                    <asp:TextBox ID="ICQ" runat="server" Width="90%"></asp:TextBox></td>
                            </tr>               
                            ...
                            <tr  class="" id="Tr2">
                                ...
                                <td class="newtd2" height="17" width="33%" colspan=3>
                                    <asp:TextBox ID="Address" runat="server" Width="90%"></asp:TextBox></td>
                                ...
                                <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                    	<div align="center"><FONT face="宋体">
                                            <asp:Button ID="Button1" runat="server" CssClass="button_blue" OnClick="Button1_Click"
                                                Text="确 定" />&nbsp; &nbsp;<input id="Button3" class="button_blue" onclick="window.close()" type="button" value="关 闭" /></FONT></div> </td>
                            </tr>
