...
{
    public partial class Sms_SeadedOut : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(ImageButton3, "iiiia1de", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "iiiia1di", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "iiiia1df", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from SendedOutBox where 1=1";
            SqlStrStartCount = "select count(id) from SendedOutBox where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  SendedOutBox ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from SendedOutBox  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from SendedOutBox  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除已发送短信", "已发送短信");
