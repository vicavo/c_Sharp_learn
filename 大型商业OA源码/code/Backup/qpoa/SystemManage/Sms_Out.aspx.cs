...
{
    public partial class Sms_Out : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from OutBox where 1=1";
            SqlStrStartCount = "select count(id) from OutBox where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  OutBox ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from OutBox  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
