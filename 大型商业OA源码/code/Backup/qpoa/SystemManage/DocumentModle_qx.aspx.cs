...
{
    public partial class DocumentModle_qx : System.Web.UI.Page
    {
        Db List = new Db();
        public static string CountsLabel, AllPageLabel, CurrentlyPageLabel, SqlStrStart, SqlStrMid, SqlStr, SqlStrStartCount, SqlStrCount, newname;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            keyid = int.Parse(Request.QueryString["id"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_DocumentModleQx where keyid='" + List.GetFormatStr(Request.QueryString["id"]) + "' and 1=1";
            SqlStrStartCount = "select count(id) from qp_DocumentModleQx where keyid='" + List.GetFormatStr(Request.QueryString["id"]) + "' and  1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_DocumentModleQx where keyid='" + List.GetFormatStr(Request.QueryString["id"]) + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_DocumentModleQx  where keyid='" + List.GetFormatStr(Request.QueryString["id"]) + "' " + Sqlsort + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_DocumentModleQx  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除红头文件["+Name.Text+"]用户权限[" + CheckCbxNameDel() + "]", "红头文件管理");
