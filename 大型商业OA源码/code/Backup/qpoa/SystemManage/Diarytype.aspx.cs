...
{
    public partial class Diarytype : System.Web.UI.Page
    {
        ...
        {
            SqlStrStart = "select * from qp_Diarytype where 1=1";
            SqlStrStartCount = "select count(id) from qp_Diarytype where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_Diarytype";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Diarytype " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Diarytype  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除日志类型[" + CheckCbxNameDel() + "]", "日志类型维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Diarytype_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Diarytype_add.aspx");
        }
        ...
        {
            Response.Redirect("Diarytype_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Diarytype_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
