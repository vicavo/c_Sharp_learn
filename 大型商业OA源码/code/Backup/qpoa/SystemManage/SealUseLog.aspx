<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SealUseLog.aspx.cs" Inherits="qpoa.SystemManage.SealUseLog" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                        &nbsp;&nbsp;&nbsp;&nbsp;印章名称：<input id="jsName" type="text" />\
                      <br> &nbsp;&nbsp;&nbsp;&nbsp;使&nbsp;用&nbsp;人&nbsp;：<input id="jsRealname" type="text" />\
                         <br>&nbsp;&nbsp;&nbsp;&nbsp;时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间：<input id="jsUsetime" type="text" />格式yyyy-mm-dd\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsUsetime').value!='')
    {
    var objRe = /^([0-9]){4,4}-([0-9]){1,2}-([0-9]){1,2}$/;
    if(!objRe.test(document.getElementById('jsUsetime').value))
    {
    ...
    midSql=midSql+"&Usetime="+document.getElementById('jsUsetime').value+"";
    }   
	showwait();
    window.location="SealUseLog.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 印章使用日志</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='SealUseLog.aspx';showwait();">
                                    <font class="shadow_but">使用日志</font></button>
                            </td>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="印信名称" SortExpression="Name">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Realname" HeaderText="使用人" SortExpression="Realname">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                         <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="Usetime" HeaderText="使用时间" SortExpression="Usetime">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                         <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
