...
{
    public partial class DocumentModle : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "iiii3b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "iiii3c", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "iiii3d", Session["perstr"].ToString());
            //List.QuanXianVis(ImageButton4, "iiii3h", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "iiii3e", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "iiii3i", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_DocumentModle where 1=1";
            SqlStrStartCount = "select count(id) from qp_DocumentModle where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_DocumentModle";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_DocumentModle " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_DocumentModle  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除红头文件[" + CheckCbxNameDel() + "]", "红头文件管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("DocumentModle_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("DocumentModle_add.aspx");
        }
        ...
        {
            Response.Redirect("DocumentModle_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("DocumentModle_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
