...
{
    public partial class SealYSp : System.Web.UI.Page
    {

        Db List = new Db();
        public static string CountsLabel, AllPageLabel, CurrentlyPageLabel, SqlStrStart, SqlStrMid, SqlStr, SqlStrStartCount, SqlStrCount, Typename;
        ...
        {
            List.QuanXianVis(GridView1, "iiiia1a", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_YinZhang  where 1=1 and  (State='正常' or State='驳回'  or State='停止' )  and YxType='私章'";
            SqlStrStartCount = "select count(id) from qp_YinZhang  where 1=1 and  (State='正常' or State='驳回'  or State='停止' )   and YxType='私章' ";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_YinZhang where  (State='正常' or State='驳回'  or State='停止' )   and YxType='私章' ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_YinZhang where (State='正常' or State='驳回'  or State='停止' )   and YxType='私章'  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
