...
{
    public partial class Sms_BadOut : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStartCount = "select count(id) from badoutbox where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  badoutbox ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from badoutbox  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from badoutbox  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除发送失败短信", "发送失败短信");
