<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentModle_show.aspx.cs" Inherits="qpoa.SystemManage.DocumentModle_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="DocumentModle.aspx"  class="line_b">红头文件管理</a> >> 查看红头文件</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <asp:Label ID="QxRealname" runat="server" Width="85%"></asp:Label>
                                </td>
                            </tr>
