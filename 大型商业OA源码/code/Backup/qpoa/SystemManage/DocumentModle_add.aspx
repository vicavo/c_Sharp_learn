<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentModle_add.aspx.cs" Inherits="qpoa.SystemManage.DocumentModle_add" %>
...
alert("提示:\r不支持此格式的文件！请区分文件扩展名大小写\r只能上传.doc");
return(false);
uploadFile.focus;
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="DocumentModle.aspx"  class="line_b">红头文件管理</a> >> 新增红头文件</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
