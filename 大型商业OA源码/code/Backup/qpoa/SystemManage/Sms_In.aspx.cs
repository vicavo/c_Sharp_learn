...
{
    public partial class Sms_In : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                if (Request.QueryString["ArriveTime"] != null)
                {
                    MidSql = MidSql + " and convert(char(10),cast(ArriveTime as datetime),120)=convert(char(10),cast('" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["ArriveTime"])) + "' as datetime),120) ";
                }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from InBox where 1=1";
            SqlStrStartCount = "select count(id) from InBox where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  InBox ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from InBox  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from InBox  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除接收短信", "接收短信");
