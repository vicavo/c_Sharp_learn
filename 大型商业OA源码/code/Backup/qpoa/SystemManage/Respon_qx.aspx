<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Respon_qx.aspx.cs" Inherits="qpoa.SystemManage.Respon_qx" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                     ...
                     <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Respon.aspx"  class="line_b">角色管理</a> >> 角色授权</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='Respon.aspx';showwait();">
                                    <font class="shadow_but">角色信息</font></button>
                            </td>
                      ...
                      <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                              ...
                              <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap" >
                                    快速定位：</td>
                                <td class="newtd2" height="17" colspan="3">
                                   [<a href="#grsw">个人事务</a>] [<a href="#gzlc">工作流程</a>]  [<a href="#ggsw">公共事务</a>]   [<a href="#xxjl">信息交流</a>] [<a href="#rlzy">人力资源</a>]  [<a href="#xsgl">销售管理</a>] [<a href="#fjcx">附件程序</a>] [<a href="#xtgl">系统管理</a>]</td>
                              </tr>                            
                          ...
                          <tr>
                              <td class="newtd2" colspan="4" height="17" align="center">
                                  <asp:CheckBox ID="CheckBox1" runat="server" Checked="True" Text="是否修改此角色对应的所有用户权限，如果选中，对应此角色的所有用户权限将会随此操作而修改" ForeColor="Red" /></td>
                          </tr>
                      ...
                      <td valign="top" background="../images/next_bg.jpg">
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width=100%>
                              <tr>
                                  ...
                                  <div align=center><asp:Button
                                          ID="Button1" runat="server" OnClick="Button1_Click" Text="确 定" />
