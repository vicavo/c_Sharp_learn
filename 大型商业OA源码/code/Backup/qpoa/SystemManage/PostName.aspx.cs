...
{
    public partial class PostName : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(ImageButton6, "iiii7c", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_PostName where 1=1";
            SqlStrStartCount = "select count(id) from qp_PostName where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_PostName";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_PostName " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SQL_GetList_check = "select * from qp_username  where   PostId in (" + CheckStr + ")";

            SqlDataReader NewReader = List.GetList(SQL_GetList_check);
            if (NewReader.Read())
            {
                this.Response.Write("<script language=javascript>alert('删除失败，其中存在正在使用的职位，请在用户管理中查看！');</script>");
                return;
            ...
            string SqlStr = "  Delete from qp_PostName  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除职位[" + CheckCbxNameDel() + "]", "职位管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("PostName_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("PostName_add.aspx");
        }
        ...
        {
            Response.Redirect("PostName_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("PostName_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
