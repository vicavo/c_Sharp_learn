<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentModle.aspx.cs" Inherits="qpoa.SystemManage.DocumentModle" %>
...
function chksearchstr()
{
    ...
    showwait();	
    window.location="DocumentModle.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 红头文件管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='DocumentModle.aspx';showwait();">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="name" HeaderText="名称" SortExpression="name">
                                     ...
                                     <asp:BoundField DataField="Type" HeaderText="文档类型" SortExpression="Type">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                   
