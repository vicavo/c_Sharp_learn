...
FCKConfig.ToolbarSets["Qiupeng1"] = [
	['Source','NewPage','-','Image','Flash','-','TextColor','BGColor','-','Table','Bold','Italic','Underline','StrikeThrough','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','FontSize']
] ;

FCKConfig.ToolbarSets["Qiupeng"] = [
	['Source','DocProps','NewPage'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['Select','ImageButton','HiddenField'],
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent','Blockquote'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Style','FontFormat','FontName','FontSize'],
	['TextColor','BGColor'],
	['Image','Flash','Table','Rule','Smiley','SpecialChar','PageBreak','FitWindow','Preview']		// No comma for the last row.
] ;
