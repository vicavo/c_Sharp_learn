<script language=javascript>
			...
			{
				if(document.Form1.isJust.checked)
...
function fPopCalendar(popCtrl, dateCtrl,strDate){
  if (popCtrl == previousObject){
	  	if (document.all.VicPopCal.style.visibility == "visible"){
  		HiddenDiv();
  		return true;
  	}
...
with (document) {
write("<Div id='VicPopCal' style='POSITION:absolute;VISIBILITY:hidden;border:1px solid;z-index:100;'>");
write("<table border='0' width='100%' bgcolor='#cccccc'>");
write("<TR>");
...
write("<DIV style='background-color:#6474E8'><table width='100%' border='0'>");
