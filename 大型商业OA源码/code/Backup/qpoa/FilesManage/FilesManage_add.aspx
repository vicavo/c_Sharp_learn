<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManage_add.aspx.cs" Inherits="qpoa.FilesManage.FilesManage_add" %>
...
function chknull()
{
  ...
  if(document.getElementById('RoomName').value=='')
    {
    alert('所属卷库不能为空，请先在卷库管理中增加');
    form1.RoomName.focus();
    return false;
    }	
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="FilesManage.aspx"  class="line_b">案卷管理</a> >> 新增案卷</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
