<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageshowBook.aspx.cs" Inherits="qpoa.FilesManage.FilesManageshowBook" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                       <br>&nbsp;&nbsp;&nbsp;文 件 号：<input id="jsNum" type="text"   style="width: 138px"/>&nbsp;&nbsp;主 题 词：<input id="jsName" type="text"   style="width: 138px"/>\
                      <br>&nbsp;&nbsp;&nbsp;文件标题：<input id="jsTitle" type="text"   style="width: 138px"/>&nbsp;&nbsp;辅 标 题：<input id="jsOtherTitle" type="text"   style="width: 138px"/>\
                      <br>&nbsp;&nbsp;&nbsp;发文单位：<input id="jsFwCompany" type="text"   style="width: 138px"/>&nbsp;&nbsp;发文日期：<input id="jsFwTime" type="text"   style="width: 138px"/>\
                      <br>&nbsp;&nbsp;&nbsp;密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级：<input id="jsMiji" type="text"   style="width: 138px"/>&nbsp;&nbsp;紧急等级：<input id="jsDengji" type="text"   style="width: 138px"/>\
                       <br>&nbsp;&nbsp;&nbsp;文件分类：<input id="jsWjType" type="text"   style="width: 138px"/>&nbsp;&nbsp;公文类别：<input id="jsGwType" type="text"   style="width: 138px"/>\
                      <br>&nbsp;&nbsp;&nbsp;所属案卷：<input id="jsFilesName" type="text"   style="width: 360px"/>\
...
if(document.getElementById('jsNum').value!='')
{
midSql=midSql+"Num="+document.getElementById('jsNum').value+"";
}
...
if(document.getElementById('jsOtherTitle').value!='')
{
midSql=midSql+"&OtherTitle="+document.getElementById('jsOtherTitle').value+"";
}  

if(document.getElementById('jsFwCompany').value!='')
{
midSql=midSql+"FwCompany="+document.getElementById('jsFwCompany').value+"";
}

if(document.getElementById('jsFwTime').value!='')
{
midSql=midSql+"FwTime="+document.getElementById('jsFwTime').value+"";
}



if(document.getElementById('jsMiji').value!='')
{
midSql=midSql+"&Miji="+document.getElementById('jsMiji').value+"";
}  

if(document.getElementById('jsDengji').value!='')
{
midSql=midSql+"&Dengji="+document.getElementById('jsDengji').value+"";
}  

if(document.getElementById('jsWjType').value!='')
{
midSql=midSql+"&WjType="+document.getElementById('jsWjType').value+"";
}  

if(document.getElementById('jsGwType').value!='')
{
midSql=midSql+"&GwType="+document.getElementById('jsGwType').value+"";
}  

if(document.getElementById('jsFilesName').value!='')
{
midSql=midSql+"&FilesName="+document.getElementById('jsFilesName').value+"";
}  

showwait();

window.location="FilesManageshowBook.aspx?id=<%=Request.QueryString["id"]%>&key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManage.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">案卷管理</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Num") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Num" HeaderText="文件号" SortExpression="Num">
                                   ...
                                   <asp:BoundField DataField="Miji" HeaderText="密级" SortExpression="Miji">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>           
                                       <asp:BoundField DataField="FilesName" HeaderText="所属案卷" SortExpression="FilesName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                            
                                    ...
                                    <asp:TemplateField HeaderText="状态">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                          ...
                                          <a href="FilesManageshowBook_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>&backid=<%=Request.QueryString["id"]%>">查看</a>
                                           <a href="FilesManageshowBook_update.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>&backid=<%=Request.QueryString["id"]%>">修改</a>
                                          <asp:LinkButton ID="Shanchu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="Shanchu">删除</asp:LinkButton>
                                            <a href="FilesManageshowBook_jyjl.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>&backid=<%=Request.QueryString["id"]%>">借阅记录</a>
                                            <asp:LinkButton ID="ShouHui" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="ShouHui">收回</asp:LinkButton>
                                             <asp:LinkButton ID="XiaoHui" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="XiaoHui">销毁</asp:LinkButton>
