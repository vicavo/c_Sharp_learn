<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageJy_show.aspx.cs" Inherits="qpoa.FilesManage.FilesManageJy_show" %>
...
window.location="FilesManageJy_show.aspx?id=<%=Request.QueryString["id"]%>&key=1&"+midSql+"";
}
...
{
var num=Math.random();
window.open ("FilesManageJy_show_show.aspx?tmp="+num+"&id="+str+"", "_blank", "height=650, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")
}
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                           <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="FilesManageJy.aspx"  class="line_b">案卷借阅</a> >> 查看文件</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageJy.aspx';showwait();"
                                    type="button">
                                    ...
                                    <asp:TemplateField HeaderText="状态">
                                     ...
                                     <asp:TemplateField HeaderText="借阅">
                                        ...
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                             ...
                                             <asp:LinkButton ID="JieYue" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="JieYue">借阅</asp:LinkButton>
