<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManage.aspx.cs" Inherits="qpoa.FilesManage.FilesManage" %>
...
window.location="FilesManage.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  案卷管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="所属部门" SortExpression="UnitName">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="175px"/>
                                        <ItemTemplate>
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                          <a href="FilesManage_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">查看</a>
                                          <a href="FilesManageshowBook.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">查看文件</a>
                                           <a href="FilesManage_update.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">修改</a>
                                            <asp:LinkButton ID="ShouHui" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="ShouHui">收回文件</asp:LinkButton>
                                            ...
                                            <asp:LinkButton ID="ZtOrQd" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="ZtOrQd">拆卷/封卷</asp:LinkButton>
                                        </ItemTemplate>
