<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageJy_ytg.aspx.cs" Inherits="qpoa.FilesManage.FilesManageJy_ytg" %>
...
window.location="FilesManageJy_ytg.aspx?key=1&"+midSql+"";
}
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageJy.aspx';showwait();"
                                 ...
                                 <button class="btn4on" onclick="javascript:window.location='FilesManageJy_ytg.aspx';showwait();"
                                    type="button"><font class="shadow_but">未归还</font></button>
                                    
                                    
                                      <button class="btn4off" onclick="javascript:window.location='FilesManageJy_wtg.aspx';showwait();"
                                    type="button"><font class="shadow_but">拒绝借阅</font></button>      
       
       
       
                                    
                                     <button class="btn4off" onclick="javascript:window.location='FilesManageYgh.aspx';showwait();"
                                    type="button"><font class="shadow_but">已归还</font></button>
                            </td>
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="State" HeaderText="状态" SortExpression="State">
                                     ...
                                     <asp:TemplateField HeaderText="归还">
                                      ...
                                      <asp:LinkButton ID="GuiHuan" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="GuiHuan">归还</asp:LinkButton>
