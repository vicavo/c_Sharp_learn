<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageshowBook_jyjl.aspx.cs" Inherits="qpoa.FilesManage.FilesManageshowBook_jyjl" %>
...
window.location="FilesManageshowBook_jyjl.aspx?backid=<%=Request.QueryString["backid"] %>&key=1&"+midSql+"";
}
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                         <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="FilesManage.aspx"  class="line_b">案卷管理</a> >> 查看文件借阅记录</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageshowBook.aspx?id=<%=Request.QueryString["backid"] %>';showwait();"
                                    type="button">
                                    <font class="shadow_but">查看文件</font></button>
