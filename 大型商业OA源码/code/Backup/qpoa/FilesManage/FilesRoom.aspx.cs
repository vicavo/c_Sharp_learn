...
namespace qpoa.FilesManage
{
    public partial class FilesRoom : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "hhhh1b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "hhhh1c", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "hhhh1d", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "hhhh1e", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "hhhh1i", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            if (List.StrIFInStr("hh1hh1a", Session["perstr"].ToString()))
            {
                SqlStrStart = "select * from qp_FilesRoom where 1=1";
                SqlStrStartCount = "select count(id) from qp_FilesRoom where 1=1";
            }
            ...
            else
            {
                if (List.StrIFInStr("hh1hh1a", Session["perstr"].ToString()))
                {
                    string SQL_GetCount = "select count(id) from  qp_FilesRoom ";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_FilesRoom  " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_FilesRoom  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除卷库管理[" + CheckCbxNameDel() + "]", "卷库管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("FilesRoom_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("FilesRoom_add.aspx");
        }
        ...
        {
            Response.Redirect("FilesRoom_show.aspx?id=" + CheckCbxUpdate() + "");
        }
