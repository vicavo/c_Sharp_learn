<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageBookXh.aspx.cs" Inherits="qpoa.FilesManage.FilesManageBookXh" %>
...
window.location="FilesManageBookXh.aspx?key=1&"+midSql+"";
}
...
{
var num=Math.random();
window.open ("FilesManageJy_ytg_show.aspx?tmp="+num+"&id="+str+"", "_blank", "height=650, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  档案销毁</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageBookXh.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">档案销毁</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="文件号" SortExpression="Num">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                            <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "Id") %>);"> <%# ((Eval("Num").ToString()))%></a>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="状态">
                                     ...
                                     <asp:TemplateField HeaderText="还原">
                                        ...
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                            <asp:LinkButton ID="HuanYuan" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="HuanYuan">还原</asp:LinkButton>
                                        </ItemTemplate>
