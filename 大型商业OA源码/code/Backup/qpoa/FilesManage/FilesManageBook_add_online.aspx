<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageBook_add_online.aspx.cs" Inherits="qpoa.FilesManage.FilesManageBook_add_online" %>
...
<HTML>
	<HEAD>
		...
		function chknull()
		{
			...
			var num=Math.random();
			document.all.FramerControl1.Open("http://"+serverpath+"/FilesManage/FilesManageBookFj/<%=forfile%>?tmp="+num+"", true);
...
//		}	
        ...
        function SaveToWeb()
        {
          showwait();	
           ...
           document.all.FramerControl1.HttpPost("http://"+serverpath+"/FilesManage/FilesManageBook_add_online_save.aspx?file=<%=forfile%>&number=<%=number%>&forname=<%=forname%>");
