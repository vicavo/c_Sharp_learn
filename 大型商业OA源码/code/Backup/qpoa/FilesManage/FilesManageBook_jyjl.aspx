<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageBook_jyjl.aspx.cs" Inherits="qpoa.FilesManage.FilesManageBook_jyjl" %>
...
window.location="FilesManageBook_jyjl.aspx?key=1&"+midSql+"";
}
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                        <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="FilesManageBook.aspx"  class="line_b">文件管理</a> >> 文件借阅记录</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
