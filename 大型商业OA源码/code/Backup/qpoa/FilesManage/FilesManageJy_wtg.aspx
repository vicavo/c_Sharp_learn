<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageJy_wtg.aspx.cs" Inherits="qpoa.FilesManage.FilesManageJy_wtg" %>
...
window.location="FilesManageJy_wtg.aspx?key=1&"+midSql+"";
}
                              ...
                              <button class="btn4off" onclick="javascript:window.location='FilesManageJy.aspx';showwait();"
                                 ...
                                 <button class="btn4off" onclick="javascript:window.location='FilesManageJy_ytg.aspx';showwait();"
                                    type="button"><font class="btn4off">未归还</font></button>
                                      ...
                                      <button class="btn4on" onclick="javascript:window.location='FilesManageJy_wtg.aspx';showwait();"
