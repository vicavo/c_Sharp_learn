<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilesManageBook.aspx.cs" Inherits="qpoa.FilesManage.FilesManageBook" %>
...
window.location="FilesManageBook.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  文件管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='FilesManageBook.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">文件管理</font></button>
                                    ...
                                    <asp:TemplateField HeaderText="状态">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                          ...
                                          <a href="FilesManageBook_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">查看</a>
                                           <a href="FilesManageBook_update.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">修改</a>
                                          <asp:LinkButton ID="Shanchu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="Shanchu">删除</asp:LinkButton>
                                            <a href="FilesManageBook_jyjl.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">借阅记录</a>
