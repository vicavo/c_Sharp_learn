<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitle_show_update.aspx.cs" Inherits="qpoa.KmManage.KmTitle_show_update" %>
                           ...
                           <tr>
                            ...
                            <tr>
                             ...
                             <tr  id="printshow3">
                                ...
                                &nbsp; &nbsp; &nbsp;&nbsp;<asp:Button ID="Button4" runat="server" Text="下一步管理章节" CssClass="button_blue" OnClick="Button4_Click" />
