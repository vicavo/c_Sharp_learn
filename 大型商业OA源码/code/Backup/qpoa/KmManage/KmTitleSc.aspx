<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitleSc.aspx.cs" Inherits="qpoa.KmManage.KmTitleSc" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                     ...
                     <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 我的收藏</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                ...
                <td valign="top" style="height: 40px"> 
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                         ...
                         <button class="btn4off" type="button" onclick="javascript:window.location='KmTitle.aspx';showwait();"><font class="shadow_but">我的知识</font></button>
                        ...
                        <button class="btn4on" type="button" onclick="javascript:window.location='KmTitleSc.aspx';showwait();"><font class="shadow_but">我的收藏</font></button>
                            </td>
                                    ...
                                    <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                          <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "id") %>);">查看</a>
                                            ...
                                            <asp:LinkButton ID="ShouCang" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="ShouCang">取消收藏</asp:LinkButton>
                                        </ItemTemplate>
