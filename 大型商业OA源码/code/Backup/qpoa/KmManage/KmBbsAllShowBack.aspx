<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmBbsAllShowBack.aspx.cs" Inherits="qpoa.KmManage.KmBbsAllShowBack" validateRequest="false"%>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; 回复知识讨论</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
