<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmLittleType_update.aspx.cs" Inherits="qpoa.KmManage.KmLittleType_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="KmLittleType.aspx"  class="line_b">知识小类维护</a> >> 修改知识小类信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                           ...
                           <tr class="">
                                ...
                                <asp:TextBox ID="SyRealname" runat="server" Height="55px" TextMode="MultiLine" Width="80%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser1();" alt="" src="../images/FDJ.gif" border="0"></A>
