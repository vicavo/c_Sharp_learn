...
{
    public partial class KmTitlePhTjQl : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string SQL_GetList_xs = "select top 20 * from qp_KmTitle  where State='正常' and IfTj='是' order by TjTime desc";
