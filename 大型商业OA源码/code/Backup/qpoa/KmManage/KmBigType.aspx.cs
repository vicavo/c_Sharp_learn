...
{
    public partial class KmBigType : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "jjjj1", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "jjjj1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "jjjj1", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "jjjj1", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_KmBigType where 1=1";
            SqlStrStartCount = "select count(id) from qp_KmBigType where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_KmBigType";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_KmBigType " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_KmBigType  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除知识大类[" + CheckCbxNameDel() + "]", "知识大类维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("KmBigType_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("KmBigType_add.aspx");
        }
        ...
        {
            Response.Redirect("KmBigType_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("KmBigType_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
