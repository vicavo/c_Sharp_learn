<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmTitlePhTj.aspx.cs" Inherits="qpoa.KmManage.KmTitlePhTj" %>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               ...
                               <button class="btn4on" onclick="javascript:window.location='KmTitlePhTj.aspx';showwait();" type="button"><font class="shadow_but">用户推荐</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="Realname" HeaderText="作者" SortExpression="Realname">
                                    ...
                                    <asp:BoundField DataField="TjNum" HeaderText="推荐数" SortExpression="TjNum">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                        
