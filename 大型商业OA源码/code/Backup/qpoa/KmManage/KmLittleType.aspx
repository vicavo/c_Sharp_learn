<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KmLittleType.aspx.cs" Inherits="qpoa.KmManage.KmLittleType" %>
...
function chksearchstr()
{
    ...
    midSql=midSql+"Name="+document.getElementById('jsname').value+"";
     ...
     showwait();	
    window.location="KmLittleType.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 知识小类维护</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off6k" 
                                    type="button" onclick="javascript:window.location='KmLittleType.aspx';showwait();">
                                    <font class="shadow_but">知识小类维护</font></button>
                            </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="name" HeaderText="名称" SortExpression="name">
                                     ...
                                     <asp:BoundField DataField="BigName" HeaderText="所属大类" SortExpression="BigName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField> 
                                    
                                    
                                     <asp:TemplateField HeaderText="允许使用人" SortExpression="SyRealname">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <%# ((Eval("SyRealname").ToString().Length > 20) ? (Eval("SyRealname").ToString().Substring(0, 20)) + "..." : (Eval("SyRealname").ToString()))%>
                                        </ItemTemplate>
