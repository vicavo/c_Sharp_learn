<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OftenModle_add.aspx.cs" Inherits="qpoa.MyAffairs.OftenModle_add" validateRequest="false"%>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="OftenModle.aspx"  class="line_b">常用模版设置</a> >> 新增常用模版</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
