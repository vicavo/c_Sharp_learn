<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyNetMetting_Jyshow.aspx.cs" Inherits="qpoa.MyAffairs.MyNetMetting_Jyshow" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 查看网络会议纪要</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                    <asp:Label ID="Name" runat="server" Width="100%"></asp:Label></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width=85% style="word-break:break-all">
                                    <asp:Label ID="d_content" runat="server" Width="100%"></asp:Label></td>
                            </tr>
