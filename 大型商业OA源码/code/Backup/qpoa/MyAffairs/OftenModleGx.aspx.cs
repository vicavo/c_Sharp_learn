...
{
    public partial class OftenModleGx : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "1111l6", Session["perstr"].ToString());
         
            List.QuanXianVis(ImageButton6, "1111l6", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "1111l6", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_OftenModle where CHARINDEX('," + this.Session["Username"] + ",',','+SharingUsername+',')   >   0 and 1=1";
            SqlStrStartCount = "select count(id) from qp_OftenModle where  CHARINDEX('," + this.Session["Username"] + ",',','+SharingUsername+',')   >   0 and  1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_OftenModle where  CHARINDEX('," + this.Session["Username"] + ",',','+SharingUsername+',')   >   0";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_OftenModle where CHARINDEX('," + this.Session["Username"] + ",',','+SharingUsername+',')   >   0 " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_OftenModle  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除常用模版[" + CheckCbxNameDel() + "]", "常用模版设置");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("OftenModle_update.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("OftenModle_add.aspx");
        }
        ...
        {
            Response.Redirect("OftenModle_show.aspx?id=" + CheckCbxUpdate() + "");
        }
