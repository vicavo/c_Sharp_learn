<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitNotic_add.aspx.cs" Inherits="qpoa.MyAffairs.UnitNotic_add"  validateRequest="false"%>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 部门通知 >> <a href="UnitNotic.aspx"  class="line_b">部门通知管理</a> >> 新增部门通知</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
