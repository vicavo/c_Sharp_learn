<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDiary.aspx.cs" Inherits="qpoa.MyAffairs.MyDiary" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;日志时间：<input id="jsDiaryTime" type="text"  style="width: 208px"/>格式yyyy-mm-dd\
                      <br>&nbsp;&nbsp;&nbsp;日志类型：<input id="jsDiaryType" type="text"  style="width: 208px"/>\
                      <br>&nbsp;&nbsp;&nbsp;日志内容：<input id="jsContent" type="text"  style="width: 208px"/>\
...
{
    var midSql="";
    if(document.getElementById('jsDiaryTime').value!='')
    {
    midSql=midSql+"DiaryTime="+document.getElementById('jsDiaryTime').value+"";
    }
    
    if(document.getElementById('jsDiaryType').value!='')
    {
    midSql=midSql+"DiaryType="+document.getElementById('jsDiaryType').value+"";
    }   
    ...
    if(!objRe.test(document.getElementById('jsContent').value))
    {
   ...
   showwait();	
   window.location="MyDiary.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 日志上报</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                             <button class="btn4off" onclick="javascript:window.location='MyDiary.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">日志上报</font></button>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DiaryTime") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="DiaryTime" HeaderText="日志时间" SortExpression="DiaryTime" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="DiaryType" HeaderText="日志类型" SortExpression="DiaryType" >
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                   ...
                                   <asp:TemplateField HeaderText="内容">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='MyDiary_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                             <a href='MyDiary_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">修改</a>
                                        </ItemTemplate>
