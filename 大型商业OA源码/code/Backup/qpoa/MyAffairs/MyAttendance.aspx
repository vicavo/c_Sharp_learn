<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAttendance.aspx.cs" Inherits="qpoa.MyAffairs.MyAttendance" %>
...
window.location="MyAttendance.aspx?type=<%=Request.QueryString["Type"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MyAttendance_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MyAttendance_dc.aspx?type=<%=Request.QueryString["Type"]%>&outkey=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='MyAttendance.aspx?type=<%=Request.QueryString["Type"]%>';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
