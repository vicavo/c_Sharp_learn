<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyMetting_ycy.aspx.cs" Inherits="qpoa.MyAffairs.MyMetting_ycy" %>
...
function chksearchstr()
{
    ...
    window.location="MyMetting_ycy.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MyMetting_dc.aspx?key=2&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MyMetting_dc.aspx?key=2&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4off" onclick="javascript:window.location='MyMetting.aspx';showwait();" type="button"><font class="shadow_but">我的会议</font></button>
                               <button class="btn4on" onclick="javascript:window.location='MyMetting_ycy.aspx';showwait();" type="button"><font class="shadow_but">参与会议</font></button>
