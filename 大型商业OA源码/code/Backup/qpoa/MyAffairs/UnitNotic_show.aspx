<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UnitNotic_show.aspx.cs"
    Inherits="qpoa.MyAffairs.UnitNotic_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 部门通知 >> <a href="UnitNotic.aspx"
                                                                class="line_b">部门通知管理</a> >> 查看部门通知</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            <a href="javascript:void(0)">
                                                                <img src="../images/button_print.jpg" border="0" onclick="printpage()" /></a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr class="" id="Tr2">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                                        ...
                                                        已阅读人员：</td>
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <asp:Label ID="ydrealname" runat="server" Width="90%"></asp:Label></td>
                                                </tr>
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                <input id="Button1" type="button" value="返 回" onclick="history.go(-1)" class="button_blue"/>
                                                            </font>
                                                        </div>
                                                    </td>
                                                </tr>
