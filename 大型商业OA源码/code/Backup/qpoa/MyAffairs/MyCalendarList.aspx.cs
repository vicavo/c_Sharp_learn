...
{
    public partial class MyCalendarList : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string SQL_GetCount = "select count(id) from  qp_MyCalendar where  Username='" + this.Session["username"] + "'   and (convert(char(10),cast(CalendarTime as datetime),120)=convert(char(10),cast('" + Request.QueryString["time"] + "' as datetime),120) ) ";
            CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

            string SQL_GetList_xs = "select * from qp_MyCalendar where  Username='" + this.Session["username"] + "' and (convert(char(10),cast(CalendarTime as datetime),120)=convert(char(10),cast('" + Request.QueryString["time"] + "' as datetime),120) )  " + Sqlsort + "";
        ...
        {
            Response.Redirect("MyCalendar_add.aspx?time="+Request.QueryString["time"]+"");
        }
