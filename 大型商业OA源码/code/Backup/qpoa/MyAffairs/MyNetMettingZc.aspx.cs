...
{
    public partial class MyNetMettingZc : System.Web.UI.Page
    {
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            {
                SqlStrStart = "select * from qp_NetMetting  where  MettingHeaderUser='" + Session["Username"] + "'    and 1=1";
                SqlStrStartCount = "select count(id) from qp_NetMetting  where  MettingHeaderUser='" + Session["Username"] + "'      and  1=1";
            ...
            else
            {
                if (List.StrIFInStr("1111h3", Session["perstr"].ToString()))
                {
                    string SQL_GetCount = "select count(id) from  qp_NetMetting where  MettingHeaderUser='" + Session["Username"] + "'    ";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_NetMetting  where  MettingHeaderUser='" + Session["Username"] + "'    " + Sqlsort + "";
