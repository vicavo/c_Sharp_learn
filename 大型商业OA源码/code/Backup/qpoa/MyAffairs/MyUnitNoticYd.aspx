<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyUnitNoticYd.aspx.cs" Inherits="qpoa.MyAffairs.MyUnitNoticYd" %>
...
window.location="MyUnitNoticYd.aspx?key=1&"+midSql+"";
}
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='MyUnitNotic.aspx';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">未读通知</font></button>
                                                                
                                                                 <button class="btn4on" onclick="javascript:window.location='MyUnitNoticYd.aspx';showwait();"
                                                                type="button">
