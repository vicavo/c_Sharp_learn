<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyMetting.aspx.cs" Inherits="qpoa.MyAffairs.MyMetting" %>
...
function chksearchstr()
{
    ...
    window.location="MyMetting.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MyMetting_dc.aspx?key=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MyMetting_dc.aspx?key=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 我的会议</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4on" onclick="javascript:window.location='MyMetting.aspx';showwait();" type="button"><font class="shadow_but">我的会议</font></button>
                               <button class="btn4off" onclick="javascript:window.location='MyMetting_ycy.aspx';showwait();" type="button"><font class="shadow_but">参与会议</font></button>
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="是否参与">
                                    ...
                                    <asp:TemplateField HeaderText="相关操作">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="120px"/>
                                        <ItemTemplate>
                                           <a href='MyMetting_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
