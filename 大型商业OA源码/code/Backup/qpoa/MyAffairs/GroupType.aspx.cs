...
{
    public partial class GroupType : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "1111i4b", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "1111i4d", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "1111i4e", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "1111i4i", Session["perstr"].ToString());
            List.QuanXianVis(GridView1, "11i11i43", Session["perstr"].ToString());
        }
        ...
        {
            SqlStrStart = "select * from qp_GroupType where 1=1";
            SqlStrStartCount = "select count(id) from qp_GroupType where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_GroupType";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_GroupType " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_GroupType  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除通讯录类别[" + CheckCbxNameDel() + "]", "通讯录类别管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("GroupType_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("GroupType_add.aspx");
        }
        ...
        {
            Response.Redirect("GroupType_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("GroupType_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
