<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OftenModle.aspx.cs" Inherits="qpoa.MyAffairs.OftenModle" %>
...
function chksearchstr()
{
   ...
   showwait();	
    window.location="OftenModle.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='OftenModle.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">我的模版</font></button>
                                <button class="btn4off" onclick="javascript:window.location='OftenModleGx.aspx';showwait();" type="button"><font class="shadow_but">共享模版</font></button>
                            </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="模版名称" SortExpression="Name">
                                     ...
                                     <asp:BoundField DataField="Sharing" HeaderText="是否共享" SortExpression="Sharing">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                   
