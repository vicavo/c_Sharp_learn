<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UseSpRemark.aspx.cs" Inherits="qpoa.MyAffairs.UseSpRemark" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      审批备注：<input id="jsname" type="text" />\
...
function chksearchstr()
{
   ...
   showwait();	
    window.location="UseSpRemark.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 常用审批备注</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='UseSpRemark.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">审批备注</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Title" HeaderText="审批备注" SortExpression="Title">
