...
{
    public partial class CompanyGroup_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                InsertLog("导出公司通讯录", "公司通讯录");
                DataBindToGridview();
                List.ToExcel(GridView1, "CompanyGroup");
        ...
        public void DataBindToGridview()
        {
            ...
            {
                string SQL_GetList_xs = "select * from qp_CompanyGroup where substring(dbo.fun_getPY(name),1,1)='" + Request.QueryString["XS"] + "' ";
            ...
            else
            {
                ...
                if (List.StrIFInStr("11i11i13", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetList_xs = "select * from qp_CompanyGroup  ";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
