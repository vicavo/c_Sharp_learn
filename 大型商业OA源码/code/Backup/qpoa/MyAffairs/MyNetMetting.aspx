<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyNetMetting.aspx.cs" Inherits="qpoa.MyAffairs.MyNetMetting" %>
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                       &nbsp;&nbsp;&nbsp;会议名称：<input id="jsname" type="text"  style="width: 398px"/>\
                         <br> &nbsp;&nbsp;&nbsp;会议主题：<input id="jsTitle" type="text"  style="width: 398px"/>\
                          <br> &nbsp;&nbsp;&nbsp;主&nbsp;&nbsp持&nbsp;人：<input id="jsMettingHeader" type="text"  style="width: 398px"/>\
...
function chksearchstr()
{
    ...
    window.location="MyNetMetting.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4on" onclick="javascript:window.location='MyNetMetting.aspx';showwait();" type="button"><font class="shadow_but">我的会议</font></button>
                               <button class="btn4off" onclick="javascript:window.location='MyNetMetting_ycy.aspx';showwait();" type="button"><font class="shadow_but">参与会议</font></button>
                              <button class="btn4off" onclick="javascript:window.location='MyNetMettingZc.aspx';showwait();" type="button"><font class="shadow_but">主持会议</font></button>
                            </td>
                              <td style="height: 26px" align="right" > 
                                  <a href="javascript:void(0)"><img onclick="UploadComplete()" src="../images/button_search.jpg"  border=0 id="IMG1" runat="server"/></a></td>
                        </tr>
                    </table>
                    </div>
                </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="是否参与">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="HyCyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                           <a href='MyNetMetting_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                            <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "ID") %>);">进入</a>
                                            <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>' Visible=false></asp:Label>
                                            <asp:Label ID="Label2" runat="server" ></asp:Label>
                                            <asp:LinkButton ID="canyu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="canyu">参与</asp:LinkButton>
                                        </ItemTemplate>
