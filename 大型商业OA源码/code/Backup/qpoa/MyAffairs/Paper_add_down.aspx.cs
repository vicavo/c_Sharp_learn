...
{
    public partial class Paper_add_down : System.Web.UI.Page
    {
        Db List = new Db();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (NewReader.Read())
            {
                InsertLog("下载个人文件[" + NewReader["name"] + "]", "个人文件柜");

                Response.Redirect("PaperFj/" + Server.UrlDecode(Request.QueryString["number"]) + "");
