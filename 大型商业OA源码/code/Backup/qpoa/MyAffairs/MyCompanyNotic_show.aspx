<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCompanyNotic_show.aspx.cs" Inherits="qpoa.MyAffairs.MyCompanyNotic_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 公司通知 >> <a href="MyCompanyNotic.aspx"  class="line_b">公司通知浏览</a> >> 查看公司通知</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
