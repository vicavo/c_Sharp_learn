<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCalendarJK.aspx.cs" Inherits="qpoa.MyAffairs.MyCalendarJK" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
             &nbsp;&nbsp;&nbsp;事务人&nbsp;&nbsp;：&nbsp;<input id="jsRealname" type="text"  style="width: 208px"/>\
                      <br>&nbsp;&nbsp;&nbsp;事务时间：<input id="jsCalendarTime" type="text"  style="width: 208px"/>格式yyyy-mm-dd\
...
function chksearchstr()
{
   ...
   showwait();	
   window.location="MyCalendarJK.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 日程监控</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                             ...
                             <button class="btn4off" onclick="javascript:window.location='MyCalendarJK.aspx';showwait();"
                                    type="button"><font class="shadow_but">日程监控</font></button> 
                    ...
                    <td valign="top">
                        ...
                        <div id="Div1">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                BorderWidth="1px" CellPadding="4" CellSpacing="1" GridLines="None" 
                                ...
                                <Columns>
                                    <asp:BoundField DataField="CalendarTime" HeaderText="事务时间" SortExpression="CalendarTime" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                     ...
                                     <asp:TemplateField HeaderText="开始时间">
                                      ...
                                      <asp:TemplateField HeaderText="内容">
                                        ...
                                        <ItemStyle Wrap="False" HorizontalAlign=Center />
                                                            ...
                                                            <asp:BoundField DataField="Realname" HeaderText="事务人" SortExpression="Realname" >
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   
                                     ...
                                     <asp:TemplateField HeaderText="操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='MyCalendarJK_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
