<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicGroup_show.aspx.cs" Inherits="qpoa.MyAffairs.PublicGroup_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="PublicGroup.aspx"  class="line_b">公共通讯录</a> >> 查看公共通讯录</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off" 
                                    type="button">
                                    <font class="shadow_but">公共通讯录</font></button></td>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17">
                                    ...
                                    <asp:Label ID="IfOpen" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="17%">
                                ...
                                <td class="newtd2" height="17" width="35%">
                                    <asp:Label ID="GroupName" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="17" width="33%">
                                    ...
                                    <asp:Label ID="OtherName" runat="server" Width="90%"></asp:Label></td>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    style="color: #000000" width="15%">
                                    职务：</td>
                                <td class="newtd2" height="17" width="35%">
                              ...
                              <tr>
                                ...
                                <td class="newtd2" height="17" width="33%">
                                    ...
                                    <asp:Label ID="Spouses" runat="server" Width="90%"></asp:Label></td>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                    子女：</td>
                                <td class="newtd2" height="17" width="35%">
                                 
                                    <asp:Label ID="Children" runat="server" Width="90%"></asp:Label></td>
                            </tr>                          
                            ...
                            <tr>
                                ...
                                <td class="newtd2" width="83%" style="height: 17px" colspan=3>
                                    ...
                                    <asp:Label ID="CName" runat="server" Width="90%"></asp:Label></td>
                            ...
                            <tr>
                                ...
                                <td class="newtd2" style="height: 17px" width="33%">
                                    ...
                                    <asp:Label ID="CAddress" runat="server" Width="90%"></asp:Label></td>
                                <td align="right" class="newtd1" nowrap="nowrap" style="height: 17px"
                                    width="15%">
                                   单位邮编：</td>
                                <td class="newtd2" style="height: 17px" width="35%">
                               
                                    <asp:Label ID="CZipCode" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                             ...
                             <tr>
                                ...
                                <td class="newtd2" width="33%" style="height: 17px">
                                    ...
                                    <asp:Label ID="CTel" runat="server" Width="90%"></asp:Label></td>
                                <td align="right" class="newtd1" nowrap="nowrap"
                                    width="15%" style="height: 17px">
                                    单位传真：</td>
                                <td class="newtd2" width="35%" style="height: 17px">
                                    
                                    <asp:Label ID="CFax" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td class="newtd2" width="33%" style="height: 17px">
                                    ...
                                    <asp:Label ID="HAddress" runat="server" Width="90%"></asp:Label></td>
                                <td align="right" class="newtd1" nowrap="nowrap"
                                    width="15%" style="height: 17px">
                                    家庭邮编：</td>
                                <td class="newtd2" width="35%" style="height: 17px">
                                  
                                    <asp:Label ID="HZipCode" runat="server" Width="90%"></asp:Label></td>
                            </tr>                            
                              ...
                              <tr>
                                ...
                                <td class="newtd2" width="33%" style="height: 17px">
                                    ...
                                    <asp:Label ID="HTel" runat="server" Width="90%"></asp:Label></td>
                                <td align="right" class="newtd1" nowrap="nowrap"
                                    width="15%" style="height: 17px">
                                    手机：</td>
                                <td class="newtd2" width="35%" style="height: 17px">
                                 
                                    <asp:Label ID="HMoveTel" runat="server" Width="90%"></asp:Label></td>
                            </tr>  
                             ...
                             <tr>
                                ...
                                <td class="newtd2" width="33%" style="height: 17px">
                                    ...
                                    <asp:Label ID="HXiaoTel" runat="server" Width="90%"></asp:Label></td>
                                <td align="right" class="newtd1" nowrap="nowrap"
                                    width="15%" style="height: 17px">
                                    电子邮件：</td>
                                <td class="newtd2" width="35%" style="height: 17px">
