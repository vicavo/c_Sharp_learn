<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Folders_show.aspx.cs" Inherits="qpoa.MyAffairs.Folders_show" %>
...
function chksearchstr()
{
    ...
    showwait();	
    window.location="Folders_show.aspx?id=<%= Request.QueryString["id"] %>&key=1&"+midSql+"";
}
                    ...
                    <td valign="top" >
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FoldersName" HeaderText="文件夹名称" SortExpression="FoldersName">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                  
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                            <a href='Paper_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&keyid=<%# DataBinder.Eval(Container.DataItem, "FoldersID") %>' onclick="showwait();">查看</a>
                                             <a href='Paper_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&keyid=<%# DataBinder.Eval(Container.DataItem, "FoldersID") %>' onclick="showwait();">修改</a>
                                        </ItemTemplate>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <a href="javascript:void(0)" onclick="UploadComplete()">查询文件</a>
                                   将选中文件转移：<asp:DropDownList ID="Folder" runat="server" Width="121px">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" style="height: 17px" width="85%">
                                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">新建子文件夹</asp:LinkButton>
                        <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click">重命名文件夹</asp:LinkButton>
                        <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click">删除此文件夹</asp:LinkButton>
                        <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click">共享此文件夹</asp:LinkButton>&nbsp;&nbsp;文件夹名：<%=Namefile %> 
                                </td>
                            </tr>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                  ...
                                  <td >
                                    ...
                                    &nbsp;&nbsp;<asp:LinkButton ID="btnLast" runat="server" CssClass="line" CommandArgument="last" OnClick="PagerButtonClick">尾页</asp:LinkButton>&nbsp;<font color="#000000"> 页码：<asp:TextBox ID="GoPage" runat="server" Width="25px"></asp:TextBox>
