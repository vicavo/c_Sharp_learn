<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyCalendarJK_show.aspx.cs" Inherits="qpoa.MyAffairs.MyCalendarJK_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="MyCalendarJK.aspx"  class="line_b">日程监控</a> >> 查看日程</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off6k" 
                                    type="button">
                                    <font class="shadow_but">日程监控</font></button></td>
