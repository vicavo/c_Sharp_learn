...
{
    public partial class Emailprv : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "1111l4", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "1111l4", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "1111l4", Session["perstr"].ToString());
        ...
        {
            //SqlStrStart = "select * from qp_Emailprv where Username='" + this.Session["username"] + "' and 1=1";
            //SqlStrStartCount = "select count(id) from qp_Emailprv where  Username='" + this.Session["username"] + "' and  1=1";
            ...
            //else
            //{
                string SQL_GetCount = "select count(id) from  qp_Emailprv where  Username='" + this.Session["username"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Emailprv where  Username='" + this.Session["username"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            //}
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Emailprv  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除邮件参数[" + CheckCbxNameDel() + "]", "邮件参数设置");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Emailprv_update.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Emailprv_add.aspx");
        }
        ...
        {
            Response.Redirect("Emailprv_show.aspx?id=" + CheckCbxUpdate() + "");
        }
