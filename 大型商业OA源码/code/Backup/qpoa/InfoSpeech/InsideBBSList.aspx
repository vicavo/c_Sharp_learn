<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsideBBSList.aspx.cs" Inherits="qpoa.InfoSpeech.InsideBBSList" %>
                            ...
                            <asp:GridView ID="GridView1" runat="server"
                                ...
                                <Columns>
                                 <asp:TemplateField HeaderText="标题" SortExpression="title">
                                        ...
                                        <ItemTemplate>
                                        <a href=InsideBBSListShow.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&BigId=<%# DataBinder.Eval(Container.DataItem, "BigId")%>><%# DataBinder.Eval(Container.DataItem, "title")%></a>
                                       </ItemTemplate>
