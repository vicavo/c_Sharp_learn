<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NbMailSendDel.aspx.cs" Inherits="qpoa.InfoSpeech.NbMailSendDel" %>
...
window.location="NbMailSendDel.aspx?key=1&"+midSql+"";
}
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='NbMailAccept.aspx';showwait();"
                                 ...
                                 <button class="btn4off" onclick="javascript:window.location='NbMailSend.aspx';showwait();"
                                    type="button"><font class="shadow_but">已发送</font></button>
                              <button class="btn4on" onclick="javascript:window.location='NbMailSendDel.aspx';showwait();"
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailSendDel_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "sendrealname") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField> 
                                 <asp:TemplateField HeaderText="邮件主题" SortExpression="title">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailSendDel_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "title") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
