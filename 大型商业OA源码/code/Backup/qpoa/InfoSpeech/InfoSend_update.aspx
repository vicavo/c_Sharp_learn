<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoSend_update.aspx.cs" Inherits="qpoa.InfoSpeech.InfoSend_update"  validateRequest="false"%>
...
{  
    ...
    if(document.getElementById('State').value=='传阅完成')
    {
        alert('当前状态传阅完成，不能做修改');
        return false;
    }
    
    
    if (!confirm("确认删除此人员信息吗？"))
    return false;
}
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; 修改文件传阅</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="83%">
                                    <asp:TextBox ID="State" runat="server" Width="70%"></asp:TextBox>
                                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">暂停/启动</asp:LinkButton></td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="17%">
                           ...
                           <tr  class="" id="nextrs23">
                            ...
                            <tr>
                                <td class="newtd2" colspan="4" height="17">
                                    <asp:CheckBox ID="C1" runat="server" Text="允许编辑WORD,EXCEL,PPT附件" Checked="True" />
                                    &nbsp;
