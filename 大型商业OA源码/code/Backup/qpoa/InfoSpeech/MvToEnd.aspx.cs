...
{
    public partial class MvToEnd : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from SendedOutBox where 1=1 and username='" + Session["realname"] + "(" + Session["Username"] + ")'";
            SqlStrStartCount = "select count(id) from SendedOutBox where 1=1 and username='" + Session["realname"] + "(" + Session["Username"] + ")'";
            ...
            {
                string SQL_GetCount = "select count(id) from  SendedOutBox where   1=1 and username='" + Session["realname"] + "(" + Session["Username"] + ")'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from SendedOutBox   where   1=1 and username='" + Session["realname"] + "(" + Session["Username"] + ")'  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
