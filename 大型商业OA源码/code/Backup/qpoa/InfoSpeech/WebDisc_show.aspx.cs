...
{
    public partial class WebDisc_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql_down_bh = "select id,Linew+name as aaa  from qp_WebDisc where username='" + Session["username"] + "' order by QxString asc";
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_WebDiscFile  where FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "'  and 1=1 ";
            SqlStrStartCount = "select count(id) from qp_WebDiscFile  where   FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "'  and  1=1 ";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_WebDiscFile where  FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "' ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_WebDiscFile where  FoldersID='" + Request.QueryString["id"] + "' and  Username='" + Session["username"] + "' " + Sqlsort + " ";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_WebDiscFile  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除文件[" + CheckCbxNameDel() + "]", "网络硬盘");
        ...
        protected void LinkButton7_Click(object sender, EventArgs e)
        {
            ...
            string SQL_GetList = "select * from qp_WebDisc  where id='" + Folder.SelectedValue + "'";
            SqlDataReader NewReader = List.GetList(SQL_GetList);
            if (NewReader.Read())
            {
                string Sql_update = "Update qp_WebDiscFile  Set FoldersName='" + NewReader["Name"] + "',FoldersID='" + NewReader["id"] + "' where ID in (" + CheckStr + ")";
                List.ExeSql(Sql_update);
            }
            NewReader.Close();


            InsertLog("转移文件[" + CheckCbxNameDel() + "]", "网络硬盘");
        ...
        protected void LinkButton5_Click(object sender, EventArgs e)
        {
            ...
            this.Response.Write("<script language=javascript>alert('提交成功！'); window.parent.location = 'WebDisc.aspx'</script>");
        }

        protected void LinkButton6_Click(object sender, EventArgs e)
        {

            Response.Redirect("WebDisc_showGx.aspx?id=" + Request.QueryString["id"] + "");

        }

        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            Response.Redirect("WebDisc_add.aspx?id=" + Request.QueryString["id"] + "");
        }

        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            Response.Redirect("WebDisc_update.aspx?id=" + Request.QueryString["id"] + "");
        }

        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            Response.Redirect("WebDiscShow_add.aspx?id=" + Request.QueryString["id"] + "");
        }
        ...
        {
            string SqlStr = "  Delete from qp_WebDisc  where id='" + IDStr + "'";
            ...
            while (MyReader.Read())
            {
                string SqlStr1 = "  Delete from qp_WebDisc  where id='" + MyReader["ID"].ToString() + "'";
                List.ExeSql(SqlStr1);
                string SQL_GetList1 = "select * from qp_WebDisc where ParentNodesID=" + MyReader["id"] + " ";
