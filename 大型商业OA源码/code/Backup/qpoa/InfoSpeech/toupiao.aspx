<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="toupiao.aspx.cs" Inherits="qpoa.InfoSpeech.toupiao" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 投票浏览</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="投票主题">
                                        ...
                                        <ItemTemplate>
                                          <a href='toupiao_tp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();"><%# DataBinder.Eval(Container.DataItem, "title") %></a>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="xuanze" HeaderText="选择类型" SortExpression="xuanze">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                           ...
                                           <a href='toupiao_tp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">参加投票</a>
                                        </ItemTemplate>
