...
{
    public partial class qp_InsideBBSBig : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "dddd4b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "dddd4b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "dddd4b", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "dddd4b", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_InsideBBSBig where 1=1";
            SqlStrStartCount = "select count(id) from qp_InsideBBSBig where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_InsideBBSBig";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_InsideBBSBig " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_InsideBBSBig  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除讨论区类别[" + CheckCbxNameDel() + "]", "讨论区类别管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("InsideBBSBig_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("InsideBBSBig_add.aspx");
        }
        ...
        {
            Response.Redirect("InsideBBSBig_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("InsideBBSBig_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
