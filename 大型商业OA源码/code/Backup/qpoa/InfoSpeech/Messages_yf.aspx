<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messages_yf.aspx.cs" Inherits="qpoa.InfoSpeech.Messages_yf" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;消息标题：<input id="jstitle" type="text"  style="width: 398px"/>\
                       <br>&nbsp;&nbsp;&nbsp;接收人员：<input id="jssendrealname" type="text"   style="width: 138px"/>&nbsp;&nbsp;发送时间：<input id="jsitimes" type="text"   style="width: 138px"/>格式yyyy-mm-dd&nbsp;\
...
window.location="Messages_yf.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  内部消息管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Messages.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">未读消息</font></button>
                                  <button class="btn4off" onclick="javascript:window.location='Messages_yd.aspx';showwait();"
                                    type="button"><font class="shadow_but">已读消息</font></button>
                                 <button class="btn4on" onclick="javascript:window.location='Messages_yf.aspx';showwait();"
                                    type="button"><font class="shadow_but">已发消息</font></button>
                              <button class="btn4off" onclick="javascript:window.location='Messages_ys.aspx';showwait();"
                                    type="button"><font class="shadow_but">已收消息</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="消息标题" SortExpression="title">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=Messages_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "title") %></a>
                                    ...
                                    <asp:BoundField DataField="acceptrealname" HeaderText="接收人" SortExpression="acceptrealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="sfck" HeaderText="是否接收" SortExpression="sfck">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
