<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NbMailSendCg_show.aspx.cs" Inherits="qpoa.InfoSpeech.NbMailSendCg_show"  validateRequest="false"%>
                                ...
                                <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                    	<div align="center"><FONT face="宋体">
                                            <asp:Button ID="Button2" runat="server" CssClass="button_blue" OnClick="Button1_Click"
                                                Text="发 送" />
                                            &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; </FONT><asp:Button ID="Button3" runat="server" CssClass="button_blue" OnClick="Button3_Click1"
                                                Text="返 回" /></div> </td>
                            </tr>
