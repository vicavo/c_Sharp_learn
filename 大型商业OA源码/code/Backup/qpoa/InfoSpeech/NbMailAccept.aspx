<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NbMailAccept.aspx.cs" Inherits="qpoa.InfoSpeech.NbMailAccept" %>
...
window.location="NbMailAccept.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='NbMailAccept.aspx';showwait();"
                                    type="button">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailAccept_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "sendrealname") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField> 
                                 <asp:TemplateField HeaderText="邮件主题" SortExpression="title">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                          <a href=NbMailAccept_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>><%# DataBinder.Eval(Container.DataItem, "title") %></a>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
