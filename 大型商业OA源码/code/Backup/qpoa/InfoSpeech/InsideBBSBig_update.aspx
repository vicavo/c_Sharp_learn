<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsideBBSBig_update.aspx.cs" Inherits="qpoa.InfoSpeech.InsideBBSBig_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="InsideBBSBig.aspx"  class="line_b">讨论区类别管理</a> >> 修改讨论区类别信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off6k" 
                                    type="button">
                                    <font class="shadow_but">讨论区类别管理</font></button></td>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    ...
                                    公开部门：</td>
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                <asp:TextBox ID="UnitName" runat="server" Height="34px" TextMode="MultiLine" Width="85%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openunit()" src="../images/FDJ.gif" border="0"></A></td>
                            </tr>
                            <tr  id="printshow3">
...
document.getElementById("UnitName").value=arr[1]; 
}
}
