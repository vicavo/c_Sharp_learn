...
{
    public partial class WbMailAcceptList : System.Web.UI.Page
    {
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string SQL_GetCount = "select count(id) from  qp_Mail where   EmailAdd='" + EmailAdd + "' and Username='" + this.Session["username"] + "'";
            CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

            string SQL_GetList_xs = "select * from qp_Mail where   EmailAdd='" + EmailAdd + "' and Username='" + this.Session["username"] + "' " + Sqlsort + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Mail  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);
