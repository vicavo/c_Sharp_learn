<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chatcontent.aspx.cs" Inherits="qpoa.InfoSpeech.chatcontent" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 互动聊天</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='chatcontent.aspx';showwait();">
                                    <font class="shadow_but">互动聊天</font></button>
                            </td>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="聊天室">
                                   ...
                                   <asp:BoundField DataField="State" HeaderText="描述" SortExpression="State">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                  
