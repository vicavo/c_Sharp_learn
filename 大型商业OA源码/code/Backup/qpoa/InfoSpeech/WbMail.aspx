<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WbMail.aspx.cs" Inherits="qpoa.InfoSpeech.WbMail" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="EmailAdd" HeaderText="邮件地址" SortExpression="EmailAdd">
                                     ...
                                     <asp:TemplateField HeaderText="相关操作">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="80px"/>
                                        <ItemTemplate>
                                            <a href='WbMailAccept.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">接收邮件</a>
                                        </ItemTemplate>
