<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MvToEnd.aspx.cs" Inherits="qpoa.InfoSpeech.MvToEnd" %>
...
function chksearchstr()
{
	...
	showwait();
    window.location="MvToEnd.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MvToEnd_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MvToEnd_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  已发短信 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='MvToEnd.aspx';showwait();">
