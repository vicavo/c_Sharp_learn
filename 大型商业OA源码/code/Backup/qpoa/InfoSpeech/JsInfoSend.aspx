<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JsInfoSend.aspx.cs" Inherits="qpoa.InfoSpeech.JsInfoSend" %>
...
window.location="JsInfoSend.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='JsInfoSend.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">未阅读</font></button>
                                     <button class="btn4off" onclick="javascript:window.location='YJsInfoSend.aspx';showwait();"
                                    type="button">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                     <asp:TemplateField HeaderText="标题" SortExpression="Title">
                                        ...
                                        <ItemTemplate>
                                          <a href=JsInfoSend_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "Gid") %>><%# DataBinder.Eval(Container.DataItem, "Title") %></a>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <asp:Label ID="HyId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Gid")%>' Visible=false></asp:Label>
                                          <a href="JsInfoSend_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "Gid")%>">阅读</a>
                                        </ItemTemplate>
