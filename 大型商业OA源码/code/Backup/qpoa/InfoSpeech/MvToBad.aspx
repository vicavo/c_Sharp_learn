<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MvToBad.aspx.cs" Inherits="qpoa.InfoSpeech.MvToBad" %>
...
function chksearchstr()
{
	...
	showwait();
    window.location="MvToBad.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MvToBad_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MvToBad_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='MvToBad.aspx';showwait();">
