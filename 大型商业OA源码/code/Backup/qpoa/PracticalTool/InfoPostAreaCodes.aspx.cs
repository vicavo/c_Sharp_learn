...
using System.IO;
namespace qpoa.PracticalTool
{
    public partial class InfoPostAreaCodes : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                {
                    MidSql = MidSql + " and (Province like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["Name"])) + "%' or  AreaName like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["Name"])) + "%'  or  PostCode like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["Name"])) + "%'   or  AreaCode like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["Name"])) + "%' )";
                }
            }
            return MidSql;
        ...
        public void Bindquanxian()
        {
            ...
            List.QuanXianVis(IMG1, "gggg5", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_InfoPostAreaCodes where 1=1";
            SqlStrStartCount = "select count(id) from qp_InfoPostAreaCodes where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_InfoPostAreaCodes";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_InfoPostAreaCodes " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_AssetsType  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除固定资产性质[" + CheckCbxNameDel() + "]", "固定资产性质");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("AssetsType_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("AssetsType_add.aspx");
        }
        ...
        {
            Response.Redirect("AssetsType_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("AssetsType_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
