<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIYMould_add.aspx.cs" Inherits="qpoa.DIYMould.DIYMould_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="DIYMould.aspx" class="line_b">工作台模块</a> >>
                          工作台模块设置</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:TextBox ID="LookMuch" runat="server" Width="95%">4</asp:TextBox></td>
                            </tr>
                            <tr  id="printshow3">
