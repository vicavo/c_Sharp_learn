<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Website.aspx.cs" Inherits="qpoa.FreWebsite.Website" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      网址名：<input id="jsname" type="text" />是否共享：<input id="jsiffree" type="text" />\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsiffree').value!='')
    {
    midSql=midSql+"IfFree="+document.getElementById('jsiffree').value+"";
    }
   showwait();	
    window.location="Website.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 常用网址</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='Website.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">我的网址</font></button>
                                <button class="btn4off" onclick="javascript:window.location='WebsiteGx.aspx';showwait();" type="button"><font class="shadow_but">共享网址</font></button>
                            </td>
                              <td style="height: 26px" align="right" > 
                                  ...
                                  <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/images/button_gx.jpg" OnClick="ImageButton4_Click1" />
                                  <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/images/button_qxgx.jpg" OnClick="ImageButton5_Click" />
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="网址名称(点击打开)" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                            <a href='<%# DataBinder.Eval(Container.DataItem, "WebAdd") %>' target=_blank title="点击浏览网址"   class="line_b"><%# DataBinder.Eval(Container.DataItem, "Name") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="网址(点击打开)" SortExpression="WebAdd">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                            <a href='<%# DataBinder.Eval(Container.DataItem, "WebAdd") %>' target=_blank title="点击浏览网址"   class="line_b"><%# DataBinder.Eval(Container.DataItem, "WebAdd") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="IfFree" HeaderText="是否共享" SortExpression="IfFree">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                </Columns>
