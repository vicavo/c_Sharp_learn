<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Website_show.aspx.cs" Inherits="qpoa.FreWebsite.Website_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%" style="height: 24px"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom" style="height: 24px"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Website.aspx"  class="line_b">常用网址</a> >> 查看网址信息</td>
