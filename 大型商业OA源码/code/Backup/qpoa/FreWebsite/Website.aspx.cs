    ...
    public partial class Website : System.Web.UI.Page
    {
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                if (Request.QueryString["IfFree"] != null)
                {
                    MidSql = MidSql + " and IfFree like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["IfFree"])) + "%'";
                }
            }
            return MidSql;
        ...
        {
            List.QuanXianVis(ImageButton1, "gggg4", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "gggg4", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "gggg4", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "gggg4", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton5, "gggg4", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "gggg4", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "gggg4", Session["perstr"].ToString());
        ...
        public void BindAttribute()
        {
            ...
            ImageButton4.Attributes["onclick"] = "javascript:return gxcheck();";
            ImageButton5.Attributes["onclick"] = "javascript:return qxgxcheck();";
        ...
        {
            SqlStrStart = "select * from qp_Website where Username='"+this.Session["username"]+"' and 1=1";
            SqlStrStartCount = "select count(id) from qp_Website where  Username='" + this.Session["username"] + "' and  1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_Website where  Username='" + this.Session["username"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_Website where  Username='" + this.Session["username"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Website  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除网址[" + CheckCbxNameDel() + "]", "常用网址");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Website_update.aspx?id=" + CheckCbxUpdate() + "");
                    }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Website_add.aspx");
        }
        ...
        {
            Response.Redirect("Website_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("Website_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
        ...
        protected void ImageButton4_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  update qp_Website set IfFree='是' where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("共享网址[" + CheckCbxNameDel() + "]", "常用网址");
        ...
        protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  update qp_Website set IfFree='否' where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("取消共享[" + CheckCbxNameDel() + "]", "常用网址");
