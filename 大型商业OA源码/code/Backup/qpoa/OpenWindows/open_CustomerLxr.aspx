<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_CustomerLxr.aspx.cs" Inherits="qpoa.OpenWindows.open_CustomerLxr" %>
	...
	<body scroll="no" onload="onradiobutton()">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请选择联系人</td>
				</tr>
				<tr>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center"
                                            Wrap="False" />
                                        <ItemTemplate>
                                           <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "KhRealname")%>' name="Rad"  />
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="KhRealname" HeaderText="名称" SortExpression="KhRealname">
