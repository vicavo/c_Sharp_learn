<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_OfficeThing.aspx.cs" Inherits="qpoa.OpenWindows.open_OfficeThing" %>
	...
	<body scroll="no" onload="onradiobutton()">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请选择办公用品</td>
				</tr>
				<tr>
			    ...
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 470px; height: 49px">
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left">
                            名称关键字：<asp:TextBox ID="name" runat="server" Width="334px"></asp:TextBox>
