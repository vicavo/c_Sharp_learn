<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_Username_metting.aspx.cs" Inherits="qpoa.OpenWindows.open_Username_metting" %>
	...
	<body scroll="no" onload="onradiobutton()">
		...
		<form id="Form1" method="post" runat="server">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="../images/show_02.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请选择会议室管理员</td>
				</tr>
				<tr>
