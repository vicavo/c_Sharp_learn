...
{
    public partial class open_CustomerForSpro : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("open_CustomerForSpro.aspx?str=" + name.Text + "&requeststr=" + Server.UrlDecode(Request.QueryString["requeststr"].ToString()) + "");
        }
