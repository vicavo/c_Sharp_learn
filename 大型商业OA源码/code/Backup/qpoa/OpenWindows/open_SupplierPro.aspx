<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_SupplierPro.aspx.cs" Inherits="qpoa.OpenWindows.open_SupplierPro" %>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center"
                                            Wrap="False" />
                                        <ItemTemplate>
                                           <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "CpName")%>' name="Rad"  />
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="CpName" HeaderText="产品名称" SortExpression="name">
