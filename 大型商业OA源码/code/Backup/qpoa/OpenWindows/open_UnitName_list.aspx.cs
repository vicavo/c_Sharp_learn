...
{
    public partial class open_UnitName_list : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    string sql_down1 = "select * from qp_UnitName  where id in (" + strlist + ")";
        ...
        public void DataBindToDownList()
        {
                ...
                string sql_down1 = "select * from qp_UnitName";
