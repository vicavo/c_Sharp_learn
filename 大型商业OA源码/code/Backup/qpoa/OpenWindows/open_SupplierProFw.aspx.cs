...
{
    public partial class open_SupplierProFw : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                {
                    MidSql = MidSql + " and FwName like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["CpName"])) + "%'";
                }
        ...
        public void DataBindToGridview()
        {
            if (Request.QueryString["key"] != null)
            {
                ...
                string SQL_GetList_xs = "select * from qp_SupplierProFw where  1=1 " + SqlStrMid + "";
            ...
            {
                string SQL_GetList_xs = "select * from qp_SupplierProFw  ";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
        ...
        {
            Response.Redirect("open_SupplierProFw.aspx?key=1&CpName=" + CpName.Text + "&Name=" + Name.Text + "&requeststr=" + Server.UrlDecode(Request.QueryString["requeststr"].ToString()) + "");
        }
    }
}
