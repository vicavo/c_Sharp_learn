<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactsCare_update.aspx.cs" Inherits="qpoa.SaleManage.ContactsCare_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 客户忠诚度管理 >> <a href="ContactsCare.aspx"  class="line_b">客户关怀</a> >> 修改客户关怀</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off6k" 
                                    type="button">
                                    <font class="shadow_but">客户关怀</font></button></td>
