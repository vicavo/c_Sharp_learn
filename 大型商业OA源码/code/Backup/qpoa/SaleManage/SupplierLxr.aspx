<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierLxr.aspx.cs" Inherits="qpoa.SaleManage.SupplierLxr" %>
...
function chksearchstr()
{
    ...
    window.location="SupplierLxr.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SupplierLxr_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SupplierLxr_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 供应商管理 >> 联系人信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               <button class="btn4off" onclick="javascript:window.location='Supplier.aspx';showwait();"
                                ...
                                <button class="btn4on" onclick="javascript:window.location='SupplierLxr.aspx';showwait();" type="button"><font class="shadow_but">联系人信息</font></button>
