...
namespace qpoa.SaleManage
{
    public partial class SaleProduct : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "ffff4b1b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "ffff4b1c", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "ffff4b1d", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "ffff4b1e", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "ffff4b1i", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "ffff4b1f", Session["perstr"].ToString());
        ...
        {
            if (List.StrIFInStr("ff1bzff1", Session["perstr"].ToString()))
            {
            ...
            if (List.StrIFInStr("ff2bzff1", Session["perstr"].ToString()))
            {
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SaleProduct  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SaleProduct_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SaleProduct_add.aspx");
        }
        ...
        {
            Response.Redirect("SaleProduct_show.aspx?id=" + CheckCbxUpdate() + "");
        }
