<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleProductFw_update.aspx.cs" Inherits="qpoa.SaleManage.SaleProductFw_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>  销售记录 >>   <a href=SaleProductFw.aspx class="line_b">服务型产品</a> >> 修改服务型产品</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off" 
                                    type="button">
                                    <font class="shadow_but">服务型产品</font></button></td>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="24" width="33%" colspan="3">
                                    <asp:TextBox ID="AllMoney" runat="server" Width="90%" ></asp:TextBox></td>
...
wName_1=window.showModalDialog("../OpenWindows/open_CustomerForFwro.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:400px;DialogHeight=480px;status:no;scroll=yes;help:no");                
...
wName_cp=window.showModalDialog("../OpenWindows/open_SupplierProFw.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:750px;DialogHeight=580px;status:no;scroll=yes;help:no");                
