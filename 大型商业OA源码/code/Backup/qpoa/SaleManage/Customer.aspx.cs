...
namespace qpoa.SaleManage
{
    public partial class Customer : System.Web.UI.Page
    {
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_Customer  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除客户信息[" + CheckCbxNameDel() + "]", "客户信息管理");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Customer_update.aspx?id=" + CheckCbxUpdate() + "");
        ...
        {
            Response.Redirect("Customer_show.aspx?id=" + CheckCbxUpdate() + "");
        }
