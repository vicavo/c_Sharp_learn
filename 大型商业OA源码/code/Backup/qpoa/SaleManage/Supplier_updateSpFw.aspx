<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier_updateSpFw.aspx.cs" Inherits="qpoa.SaleManage.Supplier_updateSpFw" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      供应商：<input id="jsname" type="text" />&nbsp;名称：<input id="jsfwname" type="text" />\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsfwname').value!='')
    {
    midSql=midSql+"&FwName="+document.getElementById('jsfwname').value+"";
    }  


    showwait();
    	
    window.location="Supplier_updateSpFw.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SupplierProFwxg_dc.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SupplierProFwxg_dc.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="Supplier.aspx"  class="line_b">供应商管理</a> >> 查看[<font color=red><%=KhRealnameShow%></font>]产品管理信息 >> 服务型产品信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "FwName") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="FwName" HeaderText="服务名称" SortExpression="FwName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                    ...
                                    <asp:BoundField DataField="FwMoney" HeaderText="服务收费标准" SortExpression="FwMoney">
