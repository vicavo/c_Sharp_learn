<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="qpoa.SaleManage.Customer" %>
...
function chksearchstr()
{
    ...
    window.location="Customer.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("Customer_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("Customer_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='Customer.aspx';showwait();"type="button"><font class="shadow_but">客户信息</font></button>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Tel" HeaderText="电话" SortExpression="Tel">
                                       ...
                                       <asp:TemplateField HeaderText="其他信息">
                                        ...
                                        <ItemTemplate>
                                            <a href='CustomerLxr.aspx?KeyId=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">联系人信息</a>
                                        </ItemTemplate>
