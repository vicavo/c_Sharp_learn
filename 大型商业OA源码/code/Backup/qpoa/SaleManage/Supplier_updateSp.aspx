<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier_updateSp.aspx.cs" Inherits="qpoa.SaleManage.Supplier_updateSp" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                      供应商：<input id="jsname" type="text" />&nbsp;名称：<input id="jscpname" type="text" />\
                         <br>型&nbsp;&nbsp;&nbsp;号：<input id="jscpmodle" type="text" />&nbsp;类别：<input id="jscptype" type="text" />\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jscpname').value!='')
    {
    midSql=midSql+"&CpName="+document.getElementById('jscpname').value+"";
    }  
    if(document.getElementById('jscpmodle').value!='')
    {
    midSql=midSql+"&CpModle="+document.getElementById('jscpmodle').value+"";
    }    
    if(document.getElementById('jscptype').value!='')
    {
    midSql=midSql+"&CpType="+document.getElementById('jscptype').value+"";
    }   

    showwait();
    	
    window.location="Supplier_updateSp.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SupplierSpxg_dc.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SupplierSpxg_dc.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="Supplier.aspx"  class="line_b">供应商管理</a> >> 查看[<font color=red><%=KhRealnameShow%></font>]产品管理信息 >> 常规产品信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
      ...
      <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
             ...
             <button class="btn4off" onclick="javascript:window.location='Supplier_update.aspx?id=<%=Request.QueryString["KeyId"] %>';showwait();"
                                    type="button">
                                    <font class="shadow_but">供应商信息</font></button>
                                <button class="btn4off" onclick="javascript:window.location='Supplier_updateLxr.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">联系人信息</font></button>
                                 <button class="btn4on" onclick="javascript:window.location='Supplier_updateSp.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">产品信息</font></button>
                            </td>
                   ...
                   <div id="Div2" align=left>  <asp:Button ID="Button2" runat="server" Text="常规产品信息" OnClick="Button2_Click" />
                    <asp:Button ID="Button3" runat="server" Text="服务性产品信息" OnClick="Button3_Click" /></div></td>
                <td width="17" style="height: 40px">&nbsp;</td>
              </tr>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CpName") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="CpName" HeaderText="产品名称" SortExpression="CpName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                    ...
                                    <asp:BoundField DataField="CpModle" HeaderText="产品型号" SortExpression="CpModle">
                                        <ItemStyle HorizontalAlign="Center" Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CpType" HeaderText="产品类别" SortExpression="CpType">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" />
                                        <ItemStyle Wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CbMoney" HeaderText="成本价" SortExpression="CbMoney">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CsMoney" HeaderText="出售价" SortExpression="CsMoney">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" />
                                    </asp:BoundField>
