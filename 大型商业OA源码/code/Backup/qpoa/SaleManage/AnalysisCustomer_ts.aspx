<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisCustomer_ts.aspx.cs" Inherits="qpoa.SaleManage.AnalysisCustomer_ts" %>
...
showwait();
var num=Math.random();
window.open ("AnalysisCustomer_ts_dc.aspx?id=<%=Request.QueryString["id"] %>&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("AnalysisCustomer_ts_dc.aspx?id=<%=Request.QueryString["id"] %>&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                     ...
                     <td valign="bottom" width="81%"><a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="AnalysisCustomer.aspx"  class="line_b">客户综合信息</a>  >>  客户投诉</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                 <asp:TemplateField HeaderText="客户名称">
                                        ...
                                        <ItemTemplate>
                                             <a href=AnalysisCustomer_ts_show.aspx?id=<%= Request.QueryString["id"]%>&showid=<%# DataBinder.Eval(Container.DataItem, "ID") %> ><%# DataBinder.Eval(Container.DataItem, "name") %></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
