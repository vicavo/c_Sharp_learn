<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactsSurvey_update.aspx.cs" Inherits="qpoa.SaleManage.ContactsSurvey_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 客户忠诚度管理 >> <a href="ContactsSurvey.aspx"  class="line_b">满意度调查</a> >> 修改满意度调查</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off6k" 
                                    type="button">
                                    <font class="shadow_but">满意度调查</font></button></td>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:TextBox ID="Content" runat="server" Height="76px" TextMode="MultiLine" Width="90%"></asp:TextBox></td>
                            </tr>
                               <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">客户反馈： 
                                ...
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                    <asp:TextBox ID="Feedback" runat="server" Height="76px" TextMode="MultiLine" Width="90%"></asp:TextBox></td>
                            </tr>
