<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierSp.aspx.cs" Inherits="qpoa.SaleManage.SupplierSp" %>
...
function chksearchstr()
{
    ...
    window.location="SupplierSp.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SupplierSp_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SupplierSp_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 供应商管理 >> 产品管理 >> 常规产品信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               <button class="btn4off" onclick="javascript:window.location='Supplier.aspx';showwait();"
                                    type="button">
                                ...
                                <button class="btn4off" onclick="javascript:window.location='SupplierLxr.aspx';showwait();" type="button"><font class="shadow_but">联系人信息</font></button>
                                 <button class="btn4on" onclick="javascript:window.location='SupplierSp.aspx';showwait();" type="button"><font class="shadow_but">产品信息</font></button>
                            </td>
