<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierProFw.aspx.cs" Inherits="qpoa.SaleManage.SupplierProFw" %>
...
function chksearchstr()
{
    ...
    window.location="SupplierProFw.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SupplierFwPro_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SupplierFwPro_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 供应商管理 >> 产品管理 >> 服务型产品信息</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
