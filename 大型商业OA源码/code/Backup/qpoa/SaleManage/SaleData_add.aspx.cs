...
{
    public partial class SaleData_add : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql_insert = "insert into qp_SaleData (Name,Type) "
                              + "values ('" + List.GetFormatStr(Name.Text) + "','" + Request.QueryString["type"].ToString() + "')";
            List.ExeSql(sql_insert);

            InsertLog("新增数据字典[" + List.GetFormatStr(Name.Text) + "]", "销售管理-基础数据字典-" + typename + "");
