<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisCustomer.aspx.cs" Inherits="qpoa.SaleManage.AnalysisCustomer" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                      &nbsp;&nbsp;&nbsp;客户名称：<input id="jsname" type="text"  style="width: 158px"/>&nbsp;业务员：<input id="jsywrealname" type="text"  style="width: 158px"/>\
                         <br>&nbsp;&nbsp;&nbsp;客户编号：<input id="jscustomernumber" type="text"  style="width: 158px"/>&nbsp;行&nbsp;&nbsp;&nbsp;业：<input id="jsindustry" type="text"  style="width: 158px"/><A href="javascript:void(0)" onclick="OpenSaleData2()">[选择]</A>\
                          <br>&nbsp;&nbsp;&nbsp;客户来源：<input id="jscsource" type="text"   style="width: 124px"/><A href="javascript:void(0)" onclick="OpenSaleData3()">[选择]</A>&nbsp;重要度：<input id="jscimportant" type="text"   style="width: 158px"/><A href="javascript:void(0)" onclick="OpenSaleData4()">[选择]</A>\
                         <br>&nbsp;&nbsp;&nbsp;销售方式：<input id="jssales" type="text"    style="width: 124px"/><A href="javascript:void(0)" onclick="OpenSaleData7()">[选择]</A>&nbsp;企业性质：<input id="jsnature" type="text" style="width: 158px"/><A href="javascript:void(0)" onclick="OpenSaleData6()">[选择]</A>\
...
function chksearchstr()
{
    ...
    window.location="AnalysisCustomer.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("AnalysisCustomer_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("AnalysisCustomer_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 客户管理 >>  客户信息管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AnalysisCustomer.aspx';showwait();"
                                    type="button">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="YwRealname" HeaderText="业务员" SortExpression="YwRealname">
                                       ...
                                       <asp:TemplateField HeaderText="相关信息">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False"/>
                                        <ItemTemplate>
                                            <a href='AnalysisCustomer_lxr.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">联系人</a>
                                        <a href='AnalysisCustomer_jw.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">交往</a>
                                       <a href='AnalysisCustomer_fw.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">服务</a>
                                       <a href='AnalysisCustomer_gh.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">关怀</a>
                                       <a href='AnalysisCustomer_hf.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">回访</a>
                                        <a href='AnalysisCustomer_ts.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">投诉</a>
                                        <a href='AnalysisCustomer_myd.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">满意度</a>
                                        <a href='AnalysisCustomer_ht.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">合同</a>
                                        <a href='AnalysisCustomer_cpxs.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">产品销售</a>
                                        <a href='AnalysisCustomer_fwxcp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">服务型产品</a>
                                        
                                        </ItemTemplate>
                                        
                                        
                                        <ItemStyle Wrap="False" HorizontalAlign=Center Width="380px"/>
                                    </asp:TemplateField>
