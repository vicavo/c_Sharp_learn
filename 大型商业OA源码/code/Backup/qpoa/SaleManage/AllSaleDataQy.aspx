<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllSaleDataQy.aspx.cs" Inherits="qpoa.SaleManage.AllSaleDataQy" %>
...
midSql=midSql+"&Endtime="+document.getElementById('jsendtime').value+"";
    ...
    window.location="AllSaleDataQy.aspx?Type=1&key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  客户综合分析  >>  客户属性分析   >>  客户区域</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AllSaleDataQy.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">客户区域</font></button>
