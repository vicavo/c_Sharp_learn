...
{
    public partial class SupplierProFwxg_update : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            this.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='SupplierProFwxg.aspx?KeyId=" + Request.QueryString["KeyId"] + "'</script>");
