<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactsLog_add.aspx.cs" Inherits="qpoa.SaleManage.ContactsLog_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="ContactsLog.aspx"  class="line_b">客户交往记录</a> >> 新增交往记录</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
