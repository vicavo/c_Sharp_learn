...
{
    public partial class SupplierLxrxg_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview()
        {
            ...
            {
                SqlStrStart = "select * from qp_SupplierLxr where  KeyId='" + Request.QueryString["KeyId"] + "' and  Username='" + this.Session["username"] + "' and 1=1";


            }
            if (List.StrIFInStr("ff2eff5", Session["perstr"].ToString()))
            {
                SqlStrStart = "select * from qp_SupplierLxr where  KeyId='" + Request.QueryString["KeyId"] + "'  and UnitId='" + this.Session["UnitId"] + "' and 1=1";
            ...
            else
            {
                if (List.StrIFInStr("ff1eff5", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetList_xs = "select * from qp_SupplierLxr where   KeyId='" + Request.QueryString["KeyId"] + "' and  Username='" + this.Session["username"] + "' order by id desc";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                }//个人
                ...
                if (List.StrIFInStr("ff2eff5", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetList_xs = "select * from qp_SupplierLxr where   KeyId='" + Request.QueryString["KeyId"] + "' and  UnitId='" + this.Session["UnitId"] + "' order by id desc";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                }//部门
                ...
                if (List.StrIFInStr("ff3eff5", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetList_xs = "select * from qp_SupplierLxr  where   KeyId='" + Request.QueryString["KeyId"] + "' order by id desc";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
                if (List.StrIFInStr("ff4eff5", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetList_xs = "select * from qp_SupplierLxr  where   KeyId='" + Request.QueryString["KeyId"] + "' and  GroupId='" + this.Session["GroupId"] + "' order by id desc";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
