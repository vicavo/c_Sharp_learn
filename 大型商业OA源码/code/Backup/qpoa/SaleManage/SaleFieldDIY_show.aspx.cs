...
{
    public partial class SaleFieldDIY_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (NewReader.Read())
                {
                    ...
                    showBl.Text = NewReader["showBl"].ToString();
                ...
                InsertLog("查看自定义字段[" + List.GetFormatStr(Name.Text) + "]", "销售管理-自定义字段-" + typename + "");
