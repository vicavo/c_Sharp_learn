...
{
    public partial class SupplierLxr : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            {
                SqlStrStart = "select * from qp_SupplierLxr where Username='" + this.Session["username"] + "' and 1=1";
                SqlStrStartCount = "select count(id) from qp_SupplierLxr where  Username='" + this.Session["username"] + "' and  1=1";
            ...
            if (List.StrIFInStr("ff2eff5", Session["perstr"].ToString()))
            {
                ...
                {
                    SqlStrStart = "select * from qp_SupplierLxr where   CHARINDEX('" + this.Session["QxString"] + "',QxString) > 0 and 1=1";
                    SqlStrStartCount = "select count(id) from qp_SupplierLxr where    CHARINDEX('" + this.Session["QxString"] + "',QxString) > 0 and  1=1";
                }
                else
                {
                    SqlStrStart = "select * from qp_SupplierLxr where UnitId='" + this.Session["UnitId"] + "' and 1=1";
                    SqlStrStartCount = "select count(id) from qp_SupplierLxr where  UnitId='" + this.Session["UnitId"] + "' and  1=1";
                }
            ...
            {
                SqlStrStart = "select * from qp_SupplierLxr where 1=1";
                SqlStrStartCount = "select count(id) from qp_SupplierLxr where 1=1";
            }

            if (List.StrIFInStr("ff4eff5", Session["perstr"].ToString()))
            {
                SqlStrStart = "select * from qp_SupplierLxr where GroupId='" + this.Session["GroupId"] + "'and 1=1";
                SqlStrStartCount = "select count(id) from qp_SupplierLxr where GroupId='" + this.Session["GroupId"] + "'and  1=1";
            }
            ...
            else
            {
                if (List.StrIFInStr("ff1eff5", Session["perstr"].ToString()))
                {
                    string SQL_GetCount = "select count(id) from  qp_SupplierLxr where Username='" + this.Session["username"] + "'";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_SupplierLxr where Username='" + this.Session["username"] + "' " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                }//个人
                ...
                if (List.StrIFInStr("ff2eff5", Session["perstr"].ToString()))
                {
                    ...
                    if (this.Session["KeyQx"].ToString() == "允许管理子部门数据")
                    {
                        ...
                        string SQL_GetCount = "select count(id) from  qp_SupplierLxr where CHARINDEX('" + this.Session["QxString"] + "',QxString) > 0";
                        CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                        string SQL_GetList_xs = "select * from qp_SupplierLxr where CHARINDEX('" + this.Session["QxString"] + "',QxString) > 0 " + Sqlsort + "";
                        GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                        GridView1.DataBind();
                    ...
                    else
                    {
                        ...
                        string SQL_GetCount = "select count(id) from  qp_SupplierLxr where UnitId='" + this.Session["UnitId"] + "'";
                        CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                        string SQL_GetList_xs = "select * from qp_SupplierLxr where UnitId='" + this.Session["UnitId"] + "' " + Sqlsort + "";
                        GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                        GridView1.DataBind();
                ...
                if (List.StrIFInStr("ff3eff5", Session["perstr"].ToString()))
                {
                    string SQL_GetCount = "select count(id) from  qp_SupplierLxr ";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_SupplierLxr  " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
                if (List.StrIFInStr("ff4eff5", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetCount = "select count(id) from  qp_SupplierLxr  where GroupId='" + this.Session["GroupId"] + "'";
                    CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                    string SQL_GetList_xs = "select * from qp_SupplierLxr  where GroupId='" + this.Session["GroupId"] + "' " + Sqlsort + "";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("SupplierLxr_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("SupplierLxr_add.aspx");
        }
        ...
        {
            Response.Redirect("SupplierLxr_show.aspx?id=" + CheckCbxUpdate() + "");
        }
