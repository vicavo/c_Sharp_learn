<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerPublic.aspx.cs" Inherits="qpoa.SaleManage.CustomerPublic" %>
...
function chksearchstr()
{
    ...
    window.location="CustomerPublic.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CustomerPublic_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CustomerPublic_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 客户管理 >>  客户信息管理 >>  共享客户</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='Customer.aspx';showwait();"
                                ...
                                <button class="btn4on" onclick="javascript:window.location='CustomerPublic.aspx';showwait();" type="button"><font class="shadow_but">共享客户</font></button>
                                  <button class="btn4off" onclick="javascript:window.location='CustomerOpen.aspx';showwait();" type="button"><font class="shadow_but">公开客户</font></button>
                            </td>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Tel" HeaderText="电话" SortExpression="Tel">
                                       ...
                                       <asp:TemplateField HeaderText="其他信息">
                                        ...
                                        <ItemTemplate>
                                            <a href='CustomerPublicLxr.aspx?KeyId=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">联系人信息</a>
                                        </ItemTemplate>
