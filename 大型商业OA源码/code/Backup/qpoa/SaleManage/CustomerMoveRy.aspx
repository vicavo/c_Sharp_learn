<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMoveRy.aspx.cs" Inherits="qpoa.SaleManage.CustomerRy" %>
...
function RyMove()
{
    ...
    if(document.getElementById('OldRealname').value=='')
    {
    alert('用户不能为空');
    ...
    {
    alert('转移前用户和转移后用户不能一样');
   
    return false;
    }

	
    if (!window.confirm("你确认要将用户["+document.getElementById('OldRealname').value+"]的数据转移给用户["+document.getElementById('Realname').value+"]吗？"))
    {
     //showwait()
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 客户管理 >>  客户转移 >>  按用户转移</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 80%;">
                              <button class="btn4off6k" onclick="javascript:window.location='CustomerMove.aspx';showwait();" type="button"><font class="shadow_but">按结果转移</font></button>&nbsp;
                                <button class="btn4on6k" onclick="javascript:window.location='CustomerMoveRy.aspx';showwait();" type="button"><font class="shadow_but">按人员转移</font></button>&nbsp;
                                  <button class="btn4off6k" onclick="javascript:window.location='CustomerMoveBm.aspx';showwait();" type="button"><font class="shadow_but">按部门转移</font></button>&nbsp;
                    	...
                    	<table  cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                <td valign="top" style="height: 25px">
                                    将用户<asp:TextBox ID="OldRealname" runat="server" Width="19%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser1();" alt="" src="../images/FDJ.gif" border="0"></A>
                                    数据转移到用户<asp:TextBox ID="Realname" runat="server" Width="19%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser();" alt="" src="../images/FDJ.gif" border="0"></A>
