...
{
    public partial class CustomerOpenLxr_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview()
        {
            ...
            else
            {
                ...
                string SQL_GetList_xs = "select * from qp_CustomerLxr  where   Sharing='公开' and   KeyId='" + Request.QueryString["KeyId"] + "'";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
