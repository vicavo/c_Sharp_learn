<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier_update.aspx.cs" Inherits="qpoa.SaleManage.Supplier_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Supplier.aspx"  class="line_b">供应商信息</a> >> 修改供应商信息</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
           ...
           <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                  <button class="btn4on" 
                                    type="button" id="BUTTON4"  runat="server">
                                    <font class="shadow_but">供应商信息</font></button>
                                     <button  class="btn4off"  type="button" id="BUTTON3" runat="server" onserverclick="BUTTON3_ServerClick" ><font class="shadow_but">联系人信息</font></button>
                                 <button class="btn4off" type="button" id="BUTTON5" onserverclick="BUTTON5_ServerClick" runat="server"><font class="shadow_but">产品信息</font></button> 
