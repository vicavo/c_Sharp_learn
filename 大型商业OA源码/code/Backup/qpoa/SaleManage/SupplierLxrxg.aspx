<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierLxrxg.aspx.cs" Inherits="qpoa.SaleManage.SupplierLxrxg" %>
...
function chksearchstr()
{
    ...
    window.location="SupplierLxrxg.aspx?KeyId=<%=Request.QueryString["KeyId"]%>&key=1&"+midSql+"";
}
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                               <button class="btn4off" onclick="javascript:window.location='Supplier_show.aspx?id=<%=Request.QueryString["KeyId"] %>';showwait();"
                                ...
                                <button class="btn4on" onclick="javascript:window.location='SupplierLxrxg.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">联系人信息</font></button>
                                 <button class="btn4off" onclick="javascript:window.location='SupplierSpxg.aspx?KeyId=<%=Request.QueryString["KeyId"] %>';showwait();" type="button"><font class="shadow_but">产品信息</font></button>
                            </td>
