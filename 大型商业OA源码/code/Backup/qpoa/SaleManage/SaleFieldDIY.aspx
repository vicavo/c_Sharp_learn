<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleFieldDIY.aspx.cs" Inherits="qpoa.SaleManage.SaleFieldDIY" %>
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 销售管理自定义字段 >> <%=typename %>自定义字段</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off9k" 
                                    type="button" onclick="javascript:window.location='SaleFieldDIY.aspx?type=<%=type %>';showwait();">
                                    <font class="shadow_but">自定义字段</font></button>
                            </td>
                              <td style="height: 26px" align="right" > 
                                  <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/images/button_show.jpg" OnClick="ImageButton4_Click" />
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="showBl" HeaderText="输入框所占比例" >
