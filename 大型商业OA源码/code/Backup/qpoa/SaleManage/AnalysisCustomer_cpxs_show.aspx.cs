...
{
    public partial class AnalysisCustomer_cpxs_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string SQL_GetList = "select * from qp_SaleProduct where id='" + List.GetFormatStr(Request.QueryString["showid"]) + "'";
                ...
                InsertLog("查看销售记录－常规产品[" + ProductName.Text + "]", "客户综合信息");
        ...
        {
            Response.Redirect("AnalysisCustomer_cpxs.aspx?id="+Request.QueryString["id"]+"");
        }
