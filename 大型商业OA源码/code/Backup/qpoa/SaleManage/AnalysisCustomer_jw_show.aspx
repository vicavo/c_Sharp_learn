<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnalysisCustomer_jw_show.aspx.cs" Inherits="qpoa.SaleManage.AnalysisCustomer_jw_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%" style="height: 24px"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom" style="height: 24px"><a href="../main_d.aspx"  class="line_b">工作台</a> >>  <a href="AnalysisCustomer.aspx"  class="line_b">客户综合信息</a> >> <a href="AnalysisCustomer_jw.aspx?id=<%=Request.QueryString["id"] %>"  class="line_b">客户交往记录</a> >> 查看交往记录</td>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off6k" 
                                    type="button">
                                    <font class="shadow_but">交往记录</font></button></td>
