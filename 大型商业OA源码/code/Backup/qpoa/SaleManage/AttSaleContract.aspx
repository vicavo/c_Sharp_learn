<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttSaleContract.aspx.cs" Inherits="qpoa.SaleManage.AttSaleContract" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;&nbsp;&nbsp;客&nbsp;&nbsp;户&nbsp;&nbsp;名&nbsp;&nbsp;称：<input id="jsname" type="text"  style="width: 138px"/>&nbsp;合&nbsp;&nbsp;同&nbsp;&nbsp;名&nbsp;&nbsp;称：<input id="jscontractname" type="text"  style="width: 138px"/>\
                        <br> &nbsp;&nbsp;&nbsp;合&nbsp;&nbsp;同&nbsp;&nbsp;编&nbsp;&nbsp;号：<input id="jscontractnum" type="text"   style="width: 138px"/>&nbsp;合&nbsp;&nbsp;同&nbsp;&nbsp;类&nbsp;&nbsp;型：<input id="jscontracttype" type="text"   style="width: 138px"/><A href="javascript:void(0)"><IMG onclick="OpenSaleData11()" src="../images/FDJ.gif" border="0"></A>\
...
midSql=midSql+"&Endtime="+document.getElementById('jsendtime').value+"";
    ...
    window.location="AttSaleContract.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  统计分析  >>  销售统计   >>  合同统计</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AttSaleContract.aspx';showwait();"
                                    type="button">
