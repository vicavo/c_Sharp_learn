<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactsCare_show.aspx.cs" Inherits="qpoa.SaleManage.ContactsCare_show" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 客户忠诚度管理 >> <a href="ContactsCare.aspx"  class="line_b">客户关怀</a> >> 查看客户关怀</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
