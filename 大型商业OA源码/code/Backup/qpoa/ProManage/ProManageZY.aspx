<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageZY.aspx.cs" Inherits="qpoa.ProManage.ProManageZY" %>
...
function chksearchstr()
{
    ...
    window.location="ProManageZY.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ProManageZY_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ProManageZY_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 项目资源</td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='ProManageZY.aspx?XmName=';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">项目资源</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1" class="mainDiv">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Leibie" HeaderText="资源类别" SortExpression="Leibie">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Mingcheng" HeaderText="资源名称" SortExpression="Mingcheng">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
