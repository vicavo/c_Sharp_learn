<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageYS_show.aspx.cs"
    Inherits="qpoa.ProManage.ProManageYS_show" %>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="17%">
                                                        预算费用：</td>
                                                    <td class="newtd2" colspan="3" height="24">
                                                        <asp:Label ID="Feiyong" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
