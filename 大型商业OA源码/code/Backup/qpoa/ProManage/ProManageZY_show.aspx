<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageZY_show.aspx.cs"
    Inherits="qpoa.ProManage.ProManageZY_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="ProManageZY.aspx?XmName="
                                                                class="line_b">项目资源</a> >> 查看项目资源</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
