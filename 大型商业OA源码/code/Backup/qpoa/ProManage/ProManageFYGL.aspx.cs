...
{
    public partial class ProManageFYGL : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            SqlStrStart = "select * from qp_ProManageFY where SpUsername='" + this.Session["username"] + "' and Jieguo='等待审批'";
            SqlStrStartCount = "select count(id) from qp_ProManageFY where  SpUsername='" + this.Session["username"] + "'  and Jieguo='等待审批'";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_ProManageFY where SpUsername='" + this.Session["username"] + "' and Jieguo='等待审批'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from qp_ProManageFY where  SpUsername='" + this.Session["username"] + "' and Jieguo='等待审批' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
