<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageWB_show.aspx.cs"
    Inherits="qpoa.ProManage.ProManageWB_show" %>
                                        ...
                                        <td valign="top">
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="85%">
                                                        <asp:Label ID="Jiebaofang" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr id="printshow3">
