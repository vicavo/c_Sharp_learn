...
{
    public partial class ProManageMG : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "kkkk1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "kkkk1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "kkkk1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "kkkk1", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "kkkk1", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "kkkk1", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_ProManage where Username='" + this.Session["username"] + "' and 1=1";
            SqlStrStartCount = "select count(id) from qp_ProManage where  Username='" + this.Session["username"] + "' and  1=1";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_ProManage where Username='" + this.Session["username"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from qp_ProManage where Username='" + this.Session["username"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_ProManage  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除项目创建[" + CheckCbxNameDel() + "]", "项目创建");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("ProManageMG_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("ProManageMG_add.aspx");
        }
        ...
        {
            Response.Redirect("ProManageMG_show.aspx?id=" + CheckCbxUpdate() + "");
        }
