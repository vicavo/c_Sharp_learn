<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageWB_dc.aspx.cs" Inherits="qpoa.ProManage.ProManageWB_dc" %>
        ...
        <div>
            <asp:GridView Style="font-size: 12px" ID="GridView1" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Leibie" HeaderText="外包类别">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Zhuti" HeaderText="外包类别">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Contents" HeaderText="外包内容">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Jiebaofang" HeaderText="接包方">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
                </Columns>
