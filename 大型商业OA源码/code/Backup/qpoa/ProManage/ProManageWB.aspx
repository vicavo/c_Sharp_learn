<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageWB.aspx.cs" Inherits="qpoa.ProManage.ProManageWB" %>
...
function chksearchstr()
{
    ...
    window.location="ProManageWB.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("ProManageWB_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("ProManageWB_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 项目外包</td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; width: 11%;">
                                                            <button class="btn4off" onclick="javascript:window.location='ProManageWB.aspx?XmName=';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">项目外包</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1" class="mainDiv">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Leibie" HeaderText="外包类别" SortExpression="Leibie">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Zhuti" HeaderText="外包主题" SortExpression="Zhuti">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Jiebaofang" HeaderText="接包方" SortExpression="Jiebaofang">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
