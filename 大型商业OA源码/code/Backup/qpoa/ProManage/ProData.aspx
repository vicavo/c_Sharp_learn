<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProData.aspx.cs" Inherits="qpoa.ProManage.ProData" %>
...
function chksearchstr()
{
    ...
    midSql=midSql+"Name="+document.getElementById('jsname').value+"";
     ...
     showwait();	
    window.location="ProData.aspx?type=<%=type %>&key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 项目管理数据字典 >> <%=typename %></td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='ProData.aspx?type=<%=type %>';showwait();">
