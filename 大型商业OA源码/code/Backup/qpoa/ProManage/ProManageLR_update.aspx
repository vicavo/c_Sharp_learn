<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageLR_update.aspx.cs" Inherits="qpoa.ProManage.ProManageLR_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="ProManageLR.aspx?XmName="
                                                                class="line_b">项目利润</a> >> 修改项目利润</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">项目利润</font></button></td>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="17%">
                                                        利润：</td>
                                                    <td class="newtd2" colspan="3" height="24">
                                                        <asp:TextBox ID="Lirun" runat="server" Width="95%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
