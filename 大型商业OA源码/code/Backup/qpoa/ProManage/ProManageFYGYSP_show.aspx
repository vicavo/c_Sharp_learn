<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageFYGYSP_show.aspx.cs" Inherits="qpoa.ProManage.ProManageFYGYSP_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="ProManageFYGYSP.aspx"
                                                                class="line_b">报销管理</a> >> 查看报销管理</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
