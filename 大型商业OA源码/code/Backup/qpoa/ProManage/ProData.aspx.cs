...
{
    public partial class ProData : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "kkkka3", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "kkkka3", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "kkkka3", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "kkkka3", Session["perstr"].ToString());
        }
        ...
        {
            SqlStrStart = "select * from qp_ProData where type='" + Request.QueryString["type"] + "' and  1=1";
            SqlStrStartCount = "select count(id) from qp_ProData where type='" + Request.QueryString["type"] + "' and 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_ProData where type='" + Request.QueryString["type"] + "'";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_ProData where type='" + Request.QueryString["type"] + "' " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_ProData  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除数据字典[" + CheckCbxNameDel() + "]", "项目管理-基础数据字典-" + typename + "");
        ...
        {
            Response.Redirect("ProData_update.aspx?type=" + type + "&id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("ProData_add.aspx?type=" + type + "&");
        }
    }
}
