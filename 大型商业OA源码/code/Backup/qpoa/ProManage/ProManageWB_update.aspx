<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageWB_update.aspx.cs" Inherits="qpoa.ProManage.ProManageWB_update" %>
...
{  
    ...
    wName2=window.showModalDialog("../OpenWindows/open_ProData.aspx?tmp="+num+"&requeststr="+str+"&type=7","window", "dialogWidth:400px;DialogHeight=480px;status:no;scroll=yes;help:no");               
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> <a href="ProManageWB.aspx?XmName="
                                                                class="line_b">项目外包</a> >> 修改项目外包</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">项目外包</font></button></td>
                                        ...
                                        <td valign="top">
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="85%">
                                                        <asp:TextBox ID="Jiebaofang" runat="server" Width="90%"></asp:TextBox></td>
                                                </tr>
                                                <tr id="printshow3">
