<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ProManageYS_dc.aspx.cs"
    Inherits="qpoa.ProManage.ProManageYS_dc" %>
        ...
        <div>
            <asp:GridView Style="font-size: 12px" ID="GridView1" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Leibie" HeaderText="预算类别">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Zhuti" HeaderText="预算主题">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Feiyong" HeaderText="预算费用">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
