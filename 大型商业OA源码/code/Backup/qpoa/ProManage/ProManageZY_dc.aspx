<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProManageZY_dc.aspx.cs" Inherits="qpoa.ProManage.ProManageZY_dc" %>
        ...
        <div>
            <asp:GridView Style="font-size: 12px" ID="GridView1" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Leibie" HeaderText="资源类别">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Mingcheng" HeaderText="资源名称">
                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                    </asp:BoundField>
