...
{
    public partial class ProManageFYGYSP_show : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string SQL_GetList = "select * from qp_ProManageFY where id='" + List.GetFormatStr(Request.QueryString["id"]) + "' and SpUsername='" + this.Session["username"] + "'";
