<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorkFlow_add_Next.aspx.cs" Inherits="qpoa.WorkFlow.AddWorkFlow_add_Next" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%" style="height: 24px"><img src="../images/top_3.gif" ></td>
                       <td width="70%" valign="bottom" style="height: 24px"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="AddWorkFlow.aspx"  class="line_b">新建工作</a> >> 快速新建</td>
  ...
  <tr>
                           ...
                           <tr>
                                <td align="right" class="newtd1" nowrap="nowrap"
                                    ...
                                    选择下一步骤：</td>
                               <td class="newtd2" colspan="3" style="height: 24px">
                           ...
                           <tr>
                            ...
                            <tr>
                             ...
                             <tr  id="printshow3">
                                ...
                                &nbsp; &nbsp; &nbsp;&nbsp;<asp:Button ID="Button4" runat="server" Text="返回" CssClass="button_blue" OnClick="Button4_Click" />
                                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</FONT></div> </td>
                            </tr>
