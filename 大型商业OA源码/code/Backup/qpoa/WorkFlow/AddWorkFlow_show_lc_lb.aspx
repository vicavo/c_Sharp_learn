<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorkFlow_show_lc_lb.aspx.cs" Inherits="qpoa.WorkFlow.AddWorkFlow_show_lc_lb" %>
                    ...
                    <td valign="top">
                        ...
                        <div id="Div1" class="mainDiv">
                         ...
                         　　　　 <asp:TemplateField HeaderText="下一步骤">
                                    ...
                                    <asp:TemplateField HeaderText="该步骤的各项属性">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="220px"/>
                                        <ItemTemplate>
                                            <a href="javascript:void(0)"  title="<%# DataBinder.Eval(Container.DataItem, "WriteFileName") %>">可写字段</a>
                                            <br><img src="../images/node_user.gif" />
                                            <a href="javascript:void(0)"  title="<%# DataBinder.Eval(Container.DataItem, "JBRObjectName") %>">经办人员</a>
                                            <a href="javascript:void(0)" title="<%# DataBinder.Eval(Container.DataItem, "JBBMObjectName") %>">经办部门</a>
                                            <a href="javascript:void(0)"  title="<%# DataBinder.Eval(Container.DataItem, "JBJSObjectName") %>">经办角色</a>
                                        </ItemTemplate>
