<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowName_show_add_node_add.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowName_show_add_node_add" %>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                                    终止审批：</td>
                                <td class="newtd2" colspan="3" height="17" width="85%"><asp:DropDownList ID="StopSp" runat="server" Width="90%">
