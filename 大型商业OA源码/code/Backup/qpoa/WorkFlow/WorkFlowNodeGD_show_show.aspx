<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowNodeGD_show_show.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowNodeGD_show_show" %>
...
window.open ("AddWorkFlow_spyj.aspx?tmp="+num+"&id=<%=AddWorkFlowId %>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no")
}
          ...
          <td height="35">
            ...
            <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <div id="printshow2">  <input id="Button6" type="button" value="流程图" onclick='window.open ("AddWorkFlow_show_lc.aspx?FlowNumber=<%=FlowNumber%>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")'/>
                          <input id="Button7" type="button" value="审批意见" onclick="OpenSpyj();"/>
                          <input id="Button1" type="button" value="打 印" onclick="printaa();"/>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr class="">
                                ...
                                <td class="newtd2" colspan="3" height="17" width="83%">
                                    <asp:Label ID="FqRealname" runat="server" Width="90%"></asp:Label></td>
                            </tr>
                            ...
                            <tr  id="printshow3">
                                <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                    	<div align="center"><FONT face="宋体">
                                            <input id="Button2" class="button_blue" onclick="history.back()" size="20" type="button"
                                                value="返 回" /></FONT>&nbsp;</div> </td>
                            </tr>
