...
namespace qpoa.WorkFlow
{
    public partial class FormType : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "bbbb2b", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "bbbb2b", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "bbbb2b", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "bbbb2b", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_FormType where 1=1";
            SqlStrStartCount = "select count(id) from qp_FormType where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_FormType";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_FormType " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_FormType  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除表单类别[" + CheckCbxNameDel() + "]", "表单类别维护");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("FormType_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("FormType_add.aspx");
        }
        ...
        {
            Response.Redirect("FormType_show.aspx?id=" + CheckCbxUpdate() + "");
        }

        protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("FormType_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
