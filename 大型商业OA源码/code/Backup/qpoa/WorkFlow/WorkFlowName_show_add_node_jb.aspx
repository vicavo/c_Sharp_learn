<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowName_show_add_node_jb.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowName_show_add_node_jb" %>
          ...
          <td height="35">
            ...
            <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
              ...
              <asp:TextBox ID="NodeNumber" runat="server" Visible="False"></asp:TextBox>
                        <asp:DropDownList ID="StopSp" runat="server" Width="90%" Visible="False">
                                    <asp:ListItem>是</asp:ListItem>
                                    <asp:ListItem>否</asp:ListItem>
                                </asp:DropDownList></td>
                    <td width="17" >
...
<asp:TextBox ID="UpNodeNum" runat="server" Width="90%"  style="DISPLAY: none"></asp:TextBox>
