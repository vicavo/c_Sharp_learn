<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowSearchShow.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowSearchShow" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%" style="height: 24px"><img src="../images/top_3.gif" ></td>
                       <td width="60%" valign="bottom" style="height: 24px"><a href="../main_d.aspx"  class="line_b">工作台</a> >> 查看工作</td>
