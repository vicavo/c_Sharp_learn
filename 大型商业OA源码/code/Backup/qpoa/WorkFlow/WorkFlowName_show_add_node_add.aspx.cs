...
{
    public partial class WorkFlowName_show_add_node_add : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            string SQL_GetList2 = "select  * from qp_WorkFlowNode where FlowNumber='" + List.GetFormatStr(Request.QueryString["FlowNumber"]) + "' and NodeNum='" + NodeNum.Text + "' ";
           ...
           InsertLog("新增工作流步骤[" + NodeName.Text + "]", "工作流步骤");
