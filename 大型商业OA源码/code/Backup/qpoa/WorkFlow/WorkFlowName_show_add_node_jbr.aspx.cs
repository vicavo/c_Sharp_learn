...
{
    public partial class WorkFlowName_show_add_node_jbr : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (NewReader.Read())
                {
                    ...
                    JBRObjectId.Text = NewReader["JBRObjectId"].ToString();
                    JBRObjectName.Text = NewReader["JBRObjectName"].ToString();
        ...
        {
            string Sql_update = "Update qp_WorkFlowNode  Set JBRObjectId='" + JBRObjectId.Text + "',JBRObjectName='" + JBRObjectName.Text + "' where id='" + int.Parse(Request.QueryString["id"]) + "'";
            List.ExeSql(Sql_update);
         
            InsertLog("设置经办人，步骤[" + NodeName.Text + "]", "工作流步骤");
