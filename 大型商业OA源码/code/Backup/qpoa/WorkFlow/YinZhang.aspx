<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YinZhang.aspx.cs" Inherits="qpoa.WorkFlow.YinZhang" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:center;margin-top:10px;padding-bottom:10px">\
                         印章名称：<input id="jsName" type="text"   style="width: 138px"/>&nbsp;印章类别：<input id="jsYxType" type="text"   style="width: 138px"/>\
...
if(document.getElementById('jsYxType').value!='')
{
midSql=midSql+"YxType="+document.getElementById('jsYxType').value+"";
}

    showwait();
    	
    window.location="YinZhang.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  印章管理  >>  我的印章</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='YinZhang.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">我的印章</font></button>
