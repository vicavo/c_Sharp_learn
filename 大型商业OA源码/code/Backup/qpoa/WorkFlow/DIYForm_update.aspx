<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DIYForm_update.aspx.cs"
    Inherits="qpoa.WorkFlow.DIYForm_update" ValidateRequest="false" %>
                                            ...
                                            <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                                                ...
                                                <tr>
                                                    <td class="newtd2" height="17" width="85%">
                                                        名称：<asp:TextBox ID="FormName" runat="server" Width="84%" MaxLength="10"></asp:TextBox>(10字符)</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="newtd2">
                                                        ...
                                                        <font color="red">1.点击左边控件按钮将会把内容插入到编辑器中鼠标的光标所在处，如果鼠标的光标没有在编辑器中将不会插入内容。
                                                            <br />
                                                            2.页面中存在重复的字段，系统在流程条件判断中将取页面上第一个控件的值。如果第一个控件没有值，系统默认为未取到值。 </font>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
