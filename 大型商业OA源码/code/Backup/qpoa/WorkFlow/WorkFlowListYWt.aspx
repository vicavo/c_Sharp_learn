<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowListYWt.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowListYWt" %>
...
window.location="WorkFlowListYWt.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  工作管理  >>  已委托工作</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='WorkFlowListYbl.aspx';showwait();"
                                    type="button">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td ><asp:DropDownList ID="FormName" runat="server" AutoPostBack="True" Width="180px">
                                            ...
                                            <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="已委托" /></td>
                                    </tr>
                                    <tr>
                                        <td height=5>
                                        </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="表单类型" SortExpression="FormName">
                                     ...
                                     <asp:BoundField DataField="WtRealname" HeaderText="代办人" SortExpression="WtRealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField> 
                                    ...
                                    <asp:TemplateField HeaderText="步骤与流程图" SortExpression="NodeName">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                          <a href='javascript:void(0)' onclick='window.open ("AddWorkFlow_show_lc.aspx?FlowNumber=<%# DataBinder.Eval(Container.DataItem, "FlowNumber") %>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")'><%# DataBinder.Eval(Container.DataItem, "NodeName") %></a>
                                       </ItemTemplate>
                                        <ItemStyle Wrap="False" HorizontalAlign=Center />
                                    </asp:TemplateField>   
                                  <asp:TemplateField HeaderText="流程操作">
                                        ...
                                        <ItemTemplate>
                                           <a href='WorkFlowListYWt_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                       </ItemTemplate>
