...
LoadWindow("WorkFlowName_show_add_node_add.aspx?FlowNumber="+str11+"");
}

//编辑步骤属性
function Edit_Process(Process_ID)
{
	LoadWindow("WorkFlowName_show_add_node_jb.aspx?ID="+Process_ID);
}
...
LoadWindow("WorkFlowName_show_add_node_zj.aspx?FlowNumber="+str11+"&ID="+Process_ID+"");
}


function set_item(Process_ID)
{
	LoadWindow("WorkFlowName_show_add_node_kxzd.aspx?ID="+Process_ID);
}

function set_condition(Process_ID)
{
	LoadWindow("WorkFlowName_show_add_node_tjsz.aspx?ID="+Process_ID);
}

function set_user(Process_ID)
{
	LoadWindow("WorkFlowName_show_add_node_jbr.aspx?ID="+Process_ID);
}

function set_dept(Process_ID)
{
	LoadWindow("WorkFlowName_show_add_node_bm.aspx?ID="+Process_ID);
}

function set_priv(Process_ID)
{
	LoadWindow("WorkFlowName_show_add_node_js.aspx?ID="+Process_ID);
}
...
window.open ("WorkFlowName_show_add_node_del.aspx?id="+Process_ID+"", "_blank", "height=1, width=1,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
