<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowName_show_add_node_bm.aspx.cs" Inherits="qpoa.WorkFlow.WorkFlowName_show_add_node_bm" %>
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    ...
                                    经办部门：</td>
                                <td class="newtd2" colspan="3" height="17" width="85%">
                                <asp:TextBox ID="JBBMObjectName" runat="server" Height="55px" TextMode="MultiLine" Width="85%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser1();" alt="" src="../images/FDJ.gif" border="0"></A></td>
                            </tr>
                            <tr  id="printshow3">
...
<asp:TextBox ID="JBBMObjectId" runat="server" Width="90%"  style="DISPLAY: none"></asp:TextBox>
...
wName_1=window.showModalDialog("../OpenWindows/open_UnitName_list.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:650px;DialogHeight=580px;status:no;scroll=yes;help:no");                
var arr = wName_1.split("|");
for(var i=0;i<arr.length;i++)
{ 
document.getElementById("JBBMObjectId").value=arr[0]; 
document.getElementById("JBBMObjectName").value=arr[1]; 
}
