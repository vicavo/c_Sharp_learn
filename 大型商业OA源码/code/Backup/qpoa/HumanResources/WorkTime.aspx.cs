...
namespace qpoa.HumanResources
{
    public partial class WorkTime : System.Web.UI.Page
    {
        ...
        {
            List.QuanXianVis(ImageButton1, "eeee8ab", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "eeee8ac", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "eeee8ad", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "eeee8ae", Session["perstr"].ToString());
        }
        ...
        {
            if (List.StrIFInStr("eeaee8a3", Session["perstr"].ToString()))
            {
                string SQL_GetCount = "select count(id) from  qp_WorkTime  ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_WorkTime   " + Sqlsort + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_WorkTime   where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除上下班时间[" + CheckCbxNameDel() + "]", "上下班时间设置");
            DataBindToGridview("order by id desc");
        }
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("WorkTime_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("WorkTime_add.aspx");
        }

        protected void ImageButton6_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("WorkTime_show.aspx?id=" + CheckCbxUpdate() + "");
        }
