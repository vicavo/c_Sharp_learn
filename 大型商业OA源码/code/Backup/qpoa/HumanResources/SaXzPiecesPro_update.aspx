<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaXzPiecesPro_update.aspx.cs" Inherits="qpoa.HumanResources.SaXzPiecesPro_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; <a href="SaXzPieces.aspx"  class="line_b">计件工序</a> >>&nbsp; 修改计件工序</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off" 
                                    type="button">
                                    <font class="shadow_but">计件工序</font></button></td>
                    ...
                    <td valign="top" >
                        ...
                        <table align="center" class="newtable" border="0" cellpadding="4" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td class="newtd2" height="17" width="35%">
                                    <asp:TextBox ID="Name" runat="server" Width="85%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="opengj();" alt="" src="../images/FDJ.gif" border="0"></A></td>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">人员姓名：
                                </td>
                                <td class="newtd2" height="17" width="35%">
                                    <asp:TextBox ID="DyRealname" runat="server" Width="85%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser();" alt="" src="../images/FDJ.gif" border="0"></A> </td>
                            </tr>
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">
                            ...
                            <tr>
                                ...
                                <td class="newtd2" colspan="3" height="17" width="83%">
                                    <asp:TextBox ID="AllMoney" runat="server" Width="95%" onclick="allmoneycheck()"></asp:TextBox></td>
                            </tr>
...
wName_3=window.showModalDialog("../OpenWindows/open_SaXzPiecesPro.aspx?tmp="+num+"&requeststr="+str+"&number="+cValue+"","window", "dialogWidth:550px;DialogHeight=480px;status:no;scroll=yes;help:no");                
