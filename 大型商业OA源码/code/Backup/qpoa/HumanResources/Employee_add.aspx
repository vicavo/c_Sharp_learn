<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_add.aspx.cs" Inherits="qpoa.InfoSpeech.Employee_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="Employee.aspx"  class="line_b">档案管理</a> >> 新增人事档案</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
