<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaXzPiecesPro.aspx.cs" Inherits="qpoa.HumanResources.SaXzPiecesPro" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                   &nbsp;&nbsp;&nbsp;帐套名称：<input id="jsSaName" type="text"   style="width: 138px"/>&nbsp;&nbsp;人员姓名：<input id="jsDyRealname" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                   <br>&nbsp;&nbsp;&nbsp;工序名称：<input id="jsName" type="text"   style="width: 138px"/>&nbsp;&nbsp;工作日期：<input id="jsWorkTime" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
function chksearchstr()
{
   var midSql="";
	...
	showwait();
    window.location="SaXzPiecesPro.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("SaXzPiecesPro_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("SaXzPiecesPro_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  薪资管理  >>  计件工序</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='SaXzPiecesPro.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">计件工序</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DyRealname" HeaderText="人员姓名" SortExpression="DyRealname">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                 
  
                                      <asp:BoundField DataField="Name" HeaderText="工序名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   
                                    
                                     <asp:BoundField DataField="DjMoney" HeaderText="单价" SortExpression="DjMoney">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   
                                    
                                    <asp:BoundField DataField="WorkNum" HeaderText="数量" SortExpression="WorkNum">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>   
                                     ...
                                     <asp:BoundField DataField="WorkTime" HeaderText="工作日" SortExpression="WorkTime" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>    
