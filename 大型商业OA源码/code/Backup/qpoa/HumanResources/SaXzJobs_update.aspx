<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaXzJobs_update.aspx.cs" Inherits="qpoa.HumanResources.SaXzJobs_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; <a href="SaXzPieces.aspx"  class="line_b">计时工种</a> >>&nbsp; 修改计时工种</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off" 
                                    type="button">
                                    <font class="shadow_but">计时工种</font></button></td>
...
wName_3=window.showModalDialog("../OpenWindows/open_SaXzJobs.aspx?tmp="+num+"&requeststr="+str+"&number="+cValue+"","window", "dialogWidth:550px;DialogHeight=480px;status:no;scroll=yes;help:no");                
