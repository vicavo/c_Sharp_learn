...
{
    public partial class SalariesAddYsp : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_SalariesAdd  where (State='已通过' or  State='未通过')";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_SalariesAdd  where (State='已通过' or  State='未通过')  " + Sqlsort + "";
