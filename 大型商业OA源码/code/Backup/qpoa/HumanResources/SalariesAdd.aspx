<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalariesAdd.aspx.cs" Inherits="qpoa.HumanResources.SalariesAdd" %>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='SalariesAdd.aspx';showwait();"type="button"><font class="shadow_but">未审批</font></button>
                             <button class="btn4off" onclick="javascript:window.location='SalariesAddYsp.aspx';showwait();"type="button"><font class="shadow_but">已审批</font></button>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Realname" HeaderText="录入人" SortExpression="Realname">
                                     ...
                                     <asp:TemplateField HeaderText="管理">
                                        ...
                                        <ItemTemplate>
                                            <a href='javascript:void(0)' onclick='window.open ("SalariesAddSet_add.aspx?Number=<%# DataBinder.Eval(Container.DataItem, "Number") %>", "_blank", "height=650, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=100,left=120")'>管理</a>
                                        </ItemTemplate>
