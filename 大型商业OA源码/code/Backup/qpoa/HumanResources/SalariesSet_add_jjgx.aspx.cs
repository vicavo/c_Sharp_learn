...
{
    public partial class SalariesSet_add_jjgx : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            string SQL_GetCount = "select count(id) from  qp_SaPiecesPro where  (SaNumber='" + Request.QueryString["number"] + "')";
            CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

            string SQL_GetList_xs = "select * from qp_SaPiecesPro where (SaNumber='" + Request.QueryString["number"] + "') " + Sqlsort + "";
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_SaPiecesPro  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);
