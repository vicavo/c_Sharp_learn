<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalariesSet_add_jjgz.aspx.cs" Inherits="qpoa.HumanResources.SalariesSet_add_jjgz" %>
...
{
var num=Math.random();
window.open ("SalariesSet_add_jjgz_update.aspx?tmp="+num+"&number=<%=Request.QueryString["number"]%>&id="+str+"", "_blank", "height=370, width=650,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=120,left=150")
}
...
{
var num=Math.random();
window.open ("SalariesSet_add_jjgz_add.aspx?tmp="+num+"&number=<%=Request.QueryString["number"]%>", "_blank", "height=370, width=650,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=120,left=150")
}
</script>
</head>
<body class="newbody">
                ...
                <td valign="top" style="height: 40px"> 
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <button class="btn4on" onclick="javascript:window.location='SalariesSet_add_jjgz.aspx?number=<%=Request.QueryString["number"]%>';showwait();" type="button"><font class="shadow_but">计时工种</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="工种名称" SortExpression="Name">
