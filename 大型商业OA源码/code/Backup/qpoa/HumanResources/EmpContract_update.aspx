<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpContract_update.aspx.cs" Inherits="qpoa.HumanResources.EmpContract_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="EmpContract.aspx"  class="line_b">人事合同</a> >> 修改人事合同</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                           ...
                           <tr>
                            ...
                            <tr  class="" id="nextrs23">
                                ...
                                <td class="newtd2" height="17" width="33%" colspan=3>
                                    ...
                                    <asp:CheckBox ID="C1Fj" runat="server" Text="修改附件" /></td>
