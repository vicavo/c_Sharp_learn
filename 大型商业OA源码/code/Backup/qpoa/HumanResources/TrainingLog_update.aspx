<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingLog_update.aspx.cs" Inherits="qpoa.HumanResources.TrainingLog_update" validateRequest="false"%>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >>&nbsp; <a href="TrainingLog.aspx"  class="line_b">培训记录</a> >>&nbsp; 修改培训记录</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
