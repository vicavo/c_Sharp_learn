<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpContract.aspx.cs" Inherits="qpoa.HumanResources.EmpContract" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                   &nbsp;&nbsp;&nbsp;签约人员：<input id="jsName" type="text"   style="width: 138px"/>&nbsp;&nbsp;合同编号：<input id="jsNumber" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
window.location="EmpContract.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("EmpContract_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("EmpContract_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  人事合同 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='EmpContract.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">人事合同</font></button>
                    ...
                    到期合同筛选：<asp:DropDownList ID="DropDownList1" runat="server">
                        <asp:ListItem Value="1000000">全部</asp:ListItem>
                        <asp:ListItem Value="3">三天内到期合同</asp:ListItem>
                        <asp:ListItem Value="7">一周内到期合同</asp:ListItem>
                        <asp:ListItem Value="14">两周内到期合同</asp:ListItem>
                        <asp:ListItem Value="30">一个月内到期合同</asp:ListItem>
                        <asp:ListItem Value="90">三个月内到期合同</asp:ListItem>
                        <asp:ListItem Value="183">半年内到期合同</asp:ListItem>
                        <asp:ListItem>过期合同</asp:ListItem>
                    </asp:DropDownList>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="签约人员" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                 
                                    <asp:BoundField DataField="Type" HeaderText="合同状态" SortExpression="Type">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>  
                                    
                                     <asp:BoundField DataField="Number" HeaderText="合同编号" SortExpression="Number">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>  
                                      <asp:BoundField DataField="QyTime" HeaderText="签约日期" SortExpression="QyTime" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                     
                                       <asp:BoundField DataField="MyTime" HeaderText="满约日期" SortExpression="MyTime" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                      
