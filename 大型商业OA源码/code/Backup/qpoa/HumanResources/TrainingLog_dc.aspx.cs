...
{
    public partial class TrainingLog_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                InsertLog("导出培训记录", "培训记录");
                DataBindToGridview();
                List.ToExcel(GridView1, "TrainingLog");
        ...
        public void DataBindToGridview()
        {
            ...
            else
            {
                if (List.StrIFInStr("ee4ee4a3", Session["perstr"].ToString()))
                {
                    string SQL_GetList_xs = "select * from qp_TrainingLog  ";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
