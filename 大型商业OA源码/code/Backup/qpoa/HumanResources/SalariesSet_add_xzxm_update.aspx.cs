...
{
    public partial class SalariesSet_add_xzxm_update : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string SQL_GetList = "select * from qp_SaProduct where id='" + List.GetFormatStr(Request.QueryString["id"]) + "'";
                ...
                if (NewReader.Read())
                {
                    ...
                    txtForumla.Text = NewReader["GsName"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string Sql_update = "Update qp_SaProduct  Set Name='" + List.GetFormatStr(Name.Text) + "',  CsMoney='" + List.GetFormatStr(CsMoney.Text) + "',  IfGs='" + IfGs + "',  GsName='" + txtForumla.Text + "'  where id='" + int.Parse(Request.QueryString["id"]) + "'";
            List.ExeSql(Sql_update);


            InsertLog("修改薪资项目[" + Name.Text + "]", "帐套管理");
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    int var1 = Convert.ToInt32(Eval(CreateStr(txtForumla.Text, returnint)));
