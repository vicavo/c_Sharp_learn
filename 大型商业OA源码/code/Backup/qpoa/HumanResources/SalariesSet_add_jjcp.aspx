<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalariesSet_add_jjcp.aspx.cs" Inherits="qpoa.HumanResources.SalariesSet_add_jjcp" %>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4on" onclick="javascript:window.location='SalariesSet_add_jjcp.aspx?number=<%=Request.QueryString["number"]%>';showwait();" type="button"><font class="shadow_but">计件产品</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Number" HeaderText="产品编号" SortExpression="Number">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
 
                                     <asp:BoundField DataField="Modle" HeaderText="规格型号" SortExpression="Modle">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                    
                                   <asp:BoundField DataField="DjMoney" HeaderText="计件单价" SortExpression="DjMoney">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                               
