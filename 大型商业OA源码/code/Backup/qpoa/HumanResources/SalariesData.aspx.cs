...
{
    public partial class SalariesData : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton3, "eeee6b", Session["perstr"].ToString());
            List.QuanXianVis(GridView1, "eeee6b", Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            if (List.StrIFInStr("eeee6b", Session["perstr"].ToString()))
            {
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            InsertLog("删除未上报工资[" + CheckCbxNameDel() + "]", "薪资数据");
