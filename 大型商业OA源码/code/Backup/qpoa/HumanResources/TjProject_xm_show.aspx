<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TjProject_xm_show.aspx.cs" Inherits="qpoa.HumanResources.TjProject_xm_show" %>
              ...
              <tr> 
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  查看<%=Typename %></td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
