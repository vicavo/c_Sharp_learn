<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinGround.aspx.cs" Inherits="qpoa.WinGround" %>
...
function chksearchstr()
{
    ...
    midSql=midSql+"Name="+document.getElementById('jsname').value+"";
     ...
     showwait();	
    window.location="WinGround.aspx?key=1&"+midSql+"";
}
...
{
var num=Math.random();
window.open ("WinGround_show.aspx?tmp="+num+"&id="+str+"", "_blank", "height=150, width=220,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="main_d.aspx" class="line_b">工作台</a> >> Windows快捷组</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" 
                                    type="button" onclick="javascript:window.location='WinGround.aspx';showwait();">
                                    <font class="shadow_but">快捷组</font></button>
                            </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                     ...
                                     <asp:TemplateField HeaderText="快捷方式名称" SortExpression="Name">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                         <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "ID") %>);"><%# DataBinder.Eval(Container.DataItem, "Name") %></a>
                                        
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="程序路径" SortExpression="MathRoad">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                           <a href="javascript:void(0)" onclick="showfrom(<%# DataBinder.Eval(Container.DataItem, "ID") %>);"><%# DataBinder.Eval(Container.DataItem, "MathRoad")%></a>
