<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingGh_update.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingGh_update" %>
              ...
              <tr> 
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  办公用品管理  >>  <a href=OfficeThingGh.aspx class="line_b">办公用品登记</a>  >>  新增归还登记</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td width=30% style="height: 26px">
                                <button class="btn4off6k" 
                                    type="button">
                                    <font class="shadow_but">归还登记</font></button></td>
