<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookManageSearch.aspx.cs" Inherits="qpoa.PublicAffairs.BookManageSearch" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;&nbsp;&nbsp;图书名称：<input id="jsname" type="text"  style="width: 398px"/>\
                       <br>&nbsp;&nbsp;&nbsp;所属部门：<input id="jsUnitName" type="text"   style="width: 138px"/>&nbsp;【<A href="javascript:void(0)" onclick="Openbumen()">选择</A>】&nbsp;图书类别：<input id="jsType" type="text"   style="width: 138px"/>&nbsp;【<A href="javascript:void(0)" onclick="Openleibie()">选择</A>】&nbsp;\
                       <br>&nbsp;&nbsp;&nbsp;图书作者：<input id="jsAuthor" type="text"  style="width: 398px"/>\
                        <br>&nbsp;&nbsp;&nbsp;出版社名：<input id="jsPublisher" type="text"  style="width: 398px"/>\
                         <br>&nbsp;&nbsp;&nbsp;存放地点：<input id="jsStorage" type="text"  style="width: 398px"/>\
                         <br>&nbsp;&nbsp;&nbsp;内容简介：<input id="jsIntroduction" type="text"  style="width: 398px"/>\
...
if(document.getElementById('jsPublisher').value!='')
{
midSql=midSql+"Publisher="+document.getElementById('jsPublisher').value+"";
}



if(document.getElementById('jsStorage').value!='')
{
midSql=midSql+"&Storage="+document.getElementById('jsStorage').value+"";
}  


if(document.getElementById('jsIntroduction').value!='')
{
midSql=midSql+"&Introduction="+document.getElementById('jsIntroduction').value+"";
} 
 
 
showwait();

window.location="BookManageSearch.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("BookManageSearch_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("BookManageSearch_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
...
var num=Math.random();
var str=document.getElementById("jsUnitName").value;
wName6=window.showModalDialog("../OpenWindows/open_UnitNameOnly.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:400px;DialogHeight=480px;status:no;scroll=yes;help:no");               
if(wName6!=null && wName6!= "undefined")
{
document.getElementById("jsUnitName").value=wName6; 
}
...
var num=Math.random();
var str=document.getElementById("jsType").value;
...
{
document.getElementById("jsType").value=wName3; 
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  图书信息管理 &gt;&gt; 图书信息查询</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='BookManageSearch.aspx';showwait();"
                                    type="button">
                                    <font class="shadow_but">图书信息</font></button>
                        ...
                        <div id="Div1" class="mainDiv">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Type" HeaderText="图书类别" SortExpression="Type">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
