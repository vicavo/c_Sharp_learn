<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingApply_hyjy.aspx.cs" Inherits="qpoa.PublicAffairs.MettingApply_hyjy" validateRequest="false"%>
...
window.showModalDialog("MettingApply_hyjy_del.aspx?tmp="+num+"&number="+cValue+" ","window","dialogWidth:1px;DialogHeight=1px;status:no;scroll=yes;help:no");                
