<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetMetting.aspx.cs" Inherits="qpoa.PublicAffairs.NetMetting" %>
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                       &nbsp;&nbsp;&nbsp;会议名称：<input id="jsname" type="text"  style="width: 398px"/>\
                         <br> &nbsp;&nbsp;&nbsp;会议主题：<input id="jsTitle" type="text"  style="width: 398px"/>\
                          <br> &nbsp;&nbsp;&nbsp;主&nbsp;&nbsp持人：<input id="jsMettingHeader" type="text"  style="width: 398px"/>\
...
function chksearchstr()
{
    ...
    if(document.getElementById('jsMettingHeader').value!='')
    {
    midSql=midSql+"&MettingHeader="+document.getElementById('jsMettingHeader').value+"";
    }  
    ...
    window.location="NetMetting.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MettingApply_sp_dc.aspx?key=3&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MettingApply_sp_dc.aspx?key=3&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 网络会议</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4on" onclick="javascript:window.location='NetMetting.aspx';showwait();" type="button"><font class="shadow_but">正常状态</font></button>
                                  <button class="btn4off" onclick="javascript:window.location='NetMettingJx.aspx';showwait();" type="button"><font class="shadow_but">正在进行</font></button>
                               <button class="btn4off" onclick="javascript:window.location='NetMettingJs.aspx';showwait();" type="button"><font class="shadow_but">已经结束</font></button>                             
                            </td>
                              <td style="height: 26px" align="right" > &nbsp;<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/button_add.jpg"
                        ...
                        <div id="Div1" >
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="MettingHeaderUser" HeaderText="主持人" SortExpression="MettingHeaderUser">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                 
                                       <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                           <a href='NetMetting_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                           <asp:LinkButton ID="jinxing" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="jinxing">进行</asp:LinkButton>
                                           <asp:LinkButton ID="jieshu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="jieshu">结束</asp:LinkButton>
                                        </ItemTemplate>
