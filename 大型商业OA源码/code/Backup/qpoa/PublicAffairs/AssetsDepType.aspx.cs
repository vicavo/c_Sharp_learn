...
{
    public partial class AssetsDepType : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc6db", Session["perstr"].ToString());

            List.QuanXianVis(ImageButton2, "cccc6dd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc6de", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc6di", Session["perstr"].ToString());
        ...
        {
            SqlStrStart = "select * from qp_AssetsDepType where 1=1";
            SqlStrStartCount = "select count(id) from qp_AssetsDepType where 1=1";
            ...
            {
                string SQL_GetCount = "select count(id) from  qp_AssetsDepType";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_AssetsDepType " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
            }
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_AssetsDepType  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除资产折旧类别[" + CheckCbxNameDel() + "]", "资产折旧类别");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("AssetsDepType_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("AssetsDepType_add.aspx");
        }
        ...
        {
            Response.Redirect("AssetsDepType_qx.aspx?id=" + CheckCbxUpdate() + "");
        }
