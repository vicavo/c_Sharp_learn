<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingCg.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingCg" %>
...
window.location="OfficeThingCg.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("OfficeThingCg_dc.aspx?outkey=1&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("OfficeThingCg_dc.aspx?outkey=1&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='OfficeThingCg.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
