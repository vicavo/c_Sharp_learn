<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingApply_sp_ytg.aspx.cs" Inherits="qpoa.PublicAffairs.MettingApply_sp_ytg" %>
...
function chksearchstr()
{
    ...
    window.location="MettingApply_sp_ytg.aspx?key=1&"+midSql+"";
}
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4on" onclick="javascript:window.location='MettingApply_sp_ytg.aspx';showwait();" type="button"><font class="shadow_but">已通过</font></button>
