<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingGh_ysp.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingGh_ysp" %>
...
window.location="OfficeThingGh_ysp.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("OfficeThingGh_ysp_dc.aspx?tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("OfficeThingGh_ysp_dc.aspx?tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='OfficeThingGh_sp.aspx';showwait();"type="button"><font class="shadow_but">未审批</font></button>
                                <button class="btn4on" onclick="javascript:window.location='OfficeThingGh_ysp.aspx';showwait();" type="button"><font class="shadow_but">已审批</font></button>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a href="OfficeThingGh_ysp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>">查看</a>
