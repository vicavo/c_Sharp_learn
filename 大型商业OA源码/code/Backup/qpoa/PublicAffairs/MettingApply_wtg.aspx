<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingApply_wtg.aspx.cs" Inherits="qpoa.PublicAffairs.MettingApply_wtg" %>
...
function chksearchstr()
{
    ...
    window.location="MettingApply_wtg.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MettingApply_dc.aspx?key=4&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MettingApply_dc.aspx?key=4&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <button class="btn4off" onclick="javascript:window.location='MettingApply.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
   <button class="btn4off" onclick="javascript:window.location='MettingApply_dsp.aspx';showwait();" type="button"><font class="shadow_but">待审批</font></button>
                               ...
                               <button class="btn4on" onclick="javascript:window.location='MettingApply_wtg.aspx';showwait();" type="button"><font class="shadow_but">未通过</font></button>
