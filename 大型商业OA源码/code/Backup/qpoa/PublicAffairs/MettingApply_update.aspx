<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingApply_update.aspx.cs" Inherits="qpoa.PublicAffairs.MettingApply_update" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="MettingApply.aspx"  class="line_b">会议申请</a> >> 修改会议申请</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
          ...
          <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
           ...
           <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
            ...
            <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
              ...
              <asp:TextBox ID="State" runat="server" Visible="False" Width="12%"></asp:TextBox></td>
        </tr>
      </table></td>
  </tr>
</table>
