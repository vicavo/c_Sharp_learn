<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingCg_sp.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingCg_sp" %>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4on" onclick="javascript:window.location='OfficeThingCg_sp.aspx';showwait();"type="button"><font class="shadow_but">未审批</font></button>
                                <button class="btn4off" onclick="javascript:window.location='OfficeThingCg_ysp.aspx';showwait();" type="button"><font class="shadow_but">已审批</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        ...
                                        <ItemTemplate>
                                            <a href="OfficeThingCg_sp_sp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>">审批</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
