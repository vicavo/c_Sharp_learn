<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingLy_ysp_show.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingLy_ysp_show" %>
              ...
              <tr> 
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  办公用品管理  >>  <a href=OfficeThingLy_ysp.aspx class="line_b">审批办公用品领用</a>  >>  查看办公用品领用审批</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
