<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetsDepType.aspx.cs" Inherits="qpoa.PublicAffairs.AssetsDepType" %>
...
function chksearchstr()
{
    ...
    {
    midSql=midSql+"DepType="+document.getElementById('jsname').value+"";
    }
     showwait();	
    window.location="AssetsDepType.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 资产折旧类别</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off6k" 
                                    type="button" onclick="javascript:window.location='AssetsDepType.aspx';showwait();">
                                    <font class="shadow_but">资产折旧类别</font></button>
                            </td>
                                    ...
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DepType") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="DepType" HeaderText="类别名称" SortExpression="name">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                              
                                    
                                     <asp:TemplateField HeaderText="折旧率" SortExpression="DepRate">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                         <%# DataBinder.Eval(Container.DataItem, "DepRate")%>%
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>            
                                    
                                    <asp:TemplateField HeaderText="折旧周期" SortExpression="DepCycle">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                        <ItemTemplate>
                                         <%# DataBinder.Eval(Container.DataItem, "DepCycle") %>天
                                        </ItemTemplate>
                                        <ItemStyle Wrap="False" />
                                    </asp:TemplateField>                              
                                          <asp:BoundField DataField="Content" HeaderText="类别说明" SortExpression="name">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                                                                      
