...
{
    public partial class OfficeThingLy : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            SqlStrStart = "select * from qp_OfficeThingLy where 1=1 and  (Username='" + this.Session["username"] + "')";
            SqlStrStartCount = "select count(id) from qp_OfficeThingLy where 1=1 and  (Username='" + this.Session["username"] + "')";
            ...
            else
            {
                ...
                string SQL_GetCount = "select count(id) from  qp_OfficeThingLy where  (Username='" + this.Session["username"] + "')";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";

                string SQL_GetList_xs = "select * from qp_OfficeThingLy where (Username='" + this.Session["username"] + "') " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
