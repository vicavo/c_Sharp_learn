<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarApply_syz.aspx.cs" Inherits="qpoa.PublicAffairs.CarApply_syz" %>
...
function chksearchstr()
{
    ...
    window.location="CarApply_syz.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarApply_dc.aspx?key=5&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarApply_dc.aspx?key=5&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
  ...
  <button class="btn4off" onclick="javascript:window.location='CarApply.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
   <button class="btn4off" onclick="javascript:window.location='CarApply_dsp.aspx';showwait();" type="button"><font class="shadow_but">待审批</font></button>
                               ...
                               <button class="btn4off" onclick="javascript:window.location='CarApply_wtg.aspx';showwait();" type="button"><font class="shadow_but">未通过</font></button>
                                  <button class="btn4on" onclick="javascript:window.location='CarApply_syz.aspx';showwait();" type="button"><font class="shadow_but">使用中</font></button>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="ManagerName" HeaderText="审批人" SortExpression="ManagerName">
                                      ...
                                      <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>' CommandName="ShanChu">结束</asp:LinkButton>
