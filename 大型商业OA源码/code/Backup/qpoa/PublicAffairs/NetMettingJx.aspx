<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetMettingJx.aspx.cs" Inherits="qpoa.PublicAffairs.NetMettingJx" %>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                ...
                                <button class="btn4off" onclick="javascript:window.location='NetMetting.aspx';showwait();" type="button"><font class="shadow_but">正常状态</font></button>
                                  <button class="btn4on" onclick="javascript:window.location='NetMettingJx.aspx';showwait();" type="button"><font class="shadow_but">正在进行</font></button>
                                   ...
                                   <asp:BoundField DataField="MettingHeaderUser" HeaderText="主持人" SortExpression="MettingHeaderUser">
                                       ...
                                       <asp:TemplateField HeaderText="相关操作">
                                        ...
                                        <ItemTemplate>
                                          ...
                                          <a href='NetMetting_Hyjy.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">会议纪要</a>
