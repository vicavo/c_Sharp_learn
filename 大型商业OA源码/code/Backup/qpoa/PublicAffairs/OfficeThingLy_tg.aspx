<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeThingLy_tg.aspx.cs" Inherits="qpoa.PublicAffairs.OfficeThingLy_tg" %>
...
showwait();
var num=Math.random();
window.open ("OfficeThingLy_dc.aspx?outkey=2&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("OfficeThingLy_dc.aspx?outkey=2&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='OfficeThingLy.aspx';showwait();"type="button"><font class="shadow_but">全部记录</font></button>
                                <button class="btn4on" onclick="javascript:window.location='OfficeThingLy_tg.aspx';showwait();" type="button"><font class="shadow_but">已通过</font></button>
                               <button class="btn4off" onclick="javascript:window.location='OfficeThingLy_wtg.aspx';showwait();" type="button"><font class="shadow_but">未通过</font></button>
                            </td>
