<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarInfo_ysh.aspx.cs" Inherits="qpoa.PublicAffairs.CarInfo_ysh" %>
...
window.location="CarInfo_ysh.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarInfo_dc.aspx?keys=2&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarInfo_dc.aspx?keys=2&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
