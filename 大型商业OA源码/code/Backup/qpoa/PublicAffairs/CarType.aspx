<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarType.aspx.cs" Inherits="qpoa.CarType" %>
...
function chksearchstr()
{
    ...
    midSql=midSql+"Name="+document.getElementById('jsname').value+"";
     ...
     showwait();	
    window.location="CarType.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 车辆类型管理</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off6k" 
                                    type="button" onclick="javascript:window.location='CarType.aspx';showwait();">
                                    <font class="shadow_but">车辆类型管理</font></button>
                            </td>
