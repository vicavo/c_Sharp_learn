<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetsDep.aspx.cs" Inherits="qpoa.PublicAffairs.AssetsDep" %>
...
window.location="AssetsDep.aspx?key=1&"+midSql+"";
}
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  固定资产  >>  固定资产折旧</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                              <button class="btn4off" onclick="javascript:window.location='AssetsDep.aspx';showwait();"
                                    type="button">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="全部资产折旧" OnClick="Button2_Click" /></td>
                <td width="17" style="height: 40px">&nbsp;</td>
              </tr>
