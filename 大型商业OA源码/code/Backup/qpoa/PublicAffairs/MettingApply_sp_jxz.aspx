<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingApply_sp_jxz.aspx.cs" Inherits="qpoa.PublicAffairs.MettingApply_sp_jxz" %>
...
function chksearchstr()
{
    ...
    window.location="MettingApply_sp_jxz.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("MettingApply_sp_dc.aspx?key=5&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("MettingApply_sp_dc.aspx?key=5&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
                   ...
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td style="height: 26px; width: 11%;">
                                <button class="btn4off" onclick="javascript:window.location='MettingApply_sp.aspx';showwait();" type="button"><font class="shadow_but">待审批</font></button>
                               ...
                               <button class="btn4off" onclick="javascript:window.location='MettingApply_sp_wtg.aspx';showwait();" type="button"><font class="shadow_but">未通过</font></button>
                                  <button class="btn4on" onclick="javascript:window.location='MettingApply_sp_jxz.aspx';showwait();" type="button"><font class="shadow_but">进行中</font></button>
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="ManagerName" HeaderText="审批人" SortExpression="ManagerName">
                                       ...
                                       <asp:TemplateField HeaderText="相关操作">
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" Width="150px"/>
                                        <ItemTemplate>
                                           <a href='MettingApply_sp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">查看</a>
                                          <a href='MettingApply_sp_hyjy.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">会议纪要</a>
