...
namespace qpoa
{
    public partial class Assets_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                InsertLog("导出固定资产", "固定资产");
                DataBindToGridview();
               List.ToExcel(GridView1, "Assets");
        ...
        public void DataBindToGridview()
        {
            ...
            else
            {
                if (List.StrIFInStr("cc6cc6a3", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetList_xs = "select * from qp_Assets where Username='" + this.Session["username"] + "'";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                }//个人
                ...
                if (List.StrIFInStr("cc6cc6a3", Session["perstr"].ToString()))
                {
                    ...
                    string SQL_GetList_xs = "select * from qp_Assets  ";
                    GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                    GridView1.DataBind();
                } //公司
