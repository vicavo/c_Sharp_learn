...
{
    public partial class OfficeThingCg_sp_sp : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string Sql_update1 = "Update qp_OfficeThingCg   Set SpRemark='" + List.GetFormatStr(SpRemark.Text) + "',Shenpi='" + Shenpi.SelectedValue + "',SpUsername='" + Session["username"] + "',SpRealname='" + Session["realname"] + "',SpTimes='" + System.DateTime.Now.ToString() + "' where id='" + int.Parse(Request.QueryString["id"]) + "'";
            ...
            InsertLog("审批办公用品[" + Name.Text + "]入库，[" + Shenpi.SelectedValue + "]", "审批办公用品入库");


            this.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='OfficeThingCg_sp.aspx'</script>");
        }
