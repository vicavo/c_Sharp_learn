...
{
    public partial class MettingApply_hyjy : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        {
            Response.Redirect("MettingApply_jxz.aspx");
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            this.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='MettingApply_jxz.aspx'</script>");
