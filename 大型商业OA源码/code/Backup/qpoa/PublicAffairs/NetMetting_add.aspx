<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetMetting_add.aspx.cs" Inherits="qpoa.PublicAffairs.NetMetting_add" %>
                ...
                <td valign="top"> <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="3%"><img src="../images/top_3.gif" ></td>
                       <td width="81%" valign="bottom"><a href="../main_d.aspx"  class="line_b">工作台</a> >> <a href="NetMetting.aspx"  class="line_b">网络会议</a> >> 新增网络会议</td>
                      <td width="81%">&nbsp;</td>
                    </tr>
                  </table>
                            ...
                            <tr>
                               ...
                               <tr>
                                ...
                                <td class="newtd2" width="33%" style="height: 24px">
                                    <asp:TextBox ID="MettingIp" runat="server" Width="85%"></asp:TextBox></td>
                                <td align="right" class="newtd1" nowrap="nowrap"
                                    width="15%" style="height: 24px">
                                   会议主持人：</td>
                                <td class="newtd2" width="35%" style="height: 24px">
                                    <asp:TextBox ID="MettingHeader" runat="server" Width="85%"></asp:TextBox><A href="javascript:void(0)"><IMG onclick="openuser();" alt="" src="../images/FDJ.gif" border="0"></A></td>
                            </tr>              
                            <tr>
                                <td align="right" class="newtd1" height="17" nowrap="nowrap"
                                    width="15%">开始时间：
