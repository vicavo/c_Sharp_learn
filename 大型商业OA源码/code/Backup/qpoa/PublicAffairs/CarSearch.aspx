<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarSearch.aspx.cs" Inherits="qpoa.PublicAffairs.CarSearch" %>
...
function chksearchstr()
{
    ...
    window.location="CarSearch.aspx?key=1&"+midSql+"";
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >> 车辆使用查询</td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
  ...
  <button class="btn4off" onclick="javascript:window.location='CarSearch.aspx';showwait();"type="button"><font class="shadow_but">使用查询</font></button>
