...
{
    public partial class MettingHouse : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public string CreateMidSql()
        {
            ...
            if (Request.QueryString["key"] != null)
            {
                ...
                {
                    MidSql = MidSql + " and Equipment like '%" + List.GetFormatStr(Server.UrlDecode(Request.QueryString["Equipment"])) + "%'";
                }
        ...
        {
            List.QuanXianVis(ImageButton1, "cccc4cb", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton6, "cccc4cc", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton2, "cccc4cd", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton3, "cccc4ce", Session["perstr"].ToString());
            List.QuanXianVis(IMG1, "cccc4ci", Session["perstr"].ToString());
            List.QuanXianVis(ImageButton4, "cccc4cf", Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            //{
            SqlStrStart = "select * from qp_MettingHouse where 1=1";
            SqlStrStartCount = "select count(id) from qp_MettingHouse where 1=1";
            //}
            ...
            else
            {
                ...
                //if (List.StrIFInStr("cc1cca3", Session["perstr"].ToString()))
                //{
                string SQL_GetCount = "select count(id) from  qp_MettingHouse ";
                CountsLabel = "" + List.GetCount(SQL_GetCount) + "";
                string SQL_GetList_xs = "select * from qp_MettingHouse  " + Sqlsort + "";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
                //} //公司
        ...
        protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string SqlStr = "  Delete from qp_MettingHouse  where ID in (" + CheckStr + ")";
            List.ExeSql(SqlStr);

            InsertLog("删除会议室信息[" + CheckCbxNameDel() + "]", "会议室设置");
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("MettingHouse_update.aspx?id=" + CheckCbxUpdate() + "");

        }

        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("MettingHouse_add.aspx");
        }
        ...
        {
            Response.Redirect("MettingHouse_show.aspx?id=" + CheckCbxUpdate() + "");
        }
