...
{
    public partial class MyWorkPlan_bm_dc : System.Web.UI.Page
    {
        Db List = new Db();
        ...
        public void DataBindToGridview()
        {
            ...
            else
            {
                ...
                string SQL_GetList_xs = "select * from qp_WorkPlan where (CHARINDEX('," + this.Session["UnitId"] + ",',','+SendUnitId+',')   >   0 ) ";
                GridView1.DataSource = List.GetGrid_Pages_not(SQL_GetList_xs);
                GridView1.DataBind();
