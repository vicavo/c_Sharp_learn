<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarInfo_wxz.aspx.cs" Inherits="qpoa.PublicAffairs.CarInfo_wxz" %>
   ...
   function UploadComplete()
    {
            ...
            <div style="clear:both;text-align:left;margin-top:10px;padding-bottom:10px">\
                     &nbsp;&nbsp;&nbsp;厂牌型号：<input id="jsCarModel" type="text"   style="width: 138px"/>&nbsp;&nbsp;车牌号：<input id="jsCarNum" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
                       <br>&nbsp;&nbsp;&nbsp;车辆类型：<input id="jsCarType" type="text"   style="width: 138px"/>&nbsp;&nbsp;驾驶员：<input id="jsDriver" type="text"   style="width: 138px"/>&nbsp;&nbsp;\
...
if(document.getElementById('jsCarModel').value!='')
{
midSql=midSql+"CarModel="+document.getElementById('jsCarModel').value+"";
}
...
if(document.getElementById('jsCarType').value!='')
{
midSql=midSql+"CarType="+document.getElementById('jsCarType').value+"";
}


if(document.getElementById('jsDriver').value!='')
{
midSql=midSql+"&Driver="+document.getElementById('jsDriver').value+"";
}  

 
showwait();

window.location="CarInfo_wxz.aspx?key=1&"+midSql+"";
}
...
showwait();
var num=Math.random();
window.open ("CarInfo_dc.aspx?keys=3&tmp="+num+"", "_blank", "height=1, width=1")
}	
function outexcels()
{
showwait();
var num=Math.random();
window.open ("CarInfo_dc.aspx?keys=3&tmp="+num+"&str=<%=SqlStrMid%>", "_blank", "height=1, width=1")
}	
              ...
              <tr> 
                ...
                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="81%" valign="bottom"><a href="../main_d.aspx" class="line_b">工作台</a> >>  车辆信息管理 </td>
                      <td width="16%">&nbsp;</td>
                    </tr>
                  </table>
                ...
                <td valign="top" style="height: 40px"> 
                   <div id="printshow2"> <table align="center" background="../images/bg0003.gif" border="0" cellpadding="0"
                        ...
                        <tr>
                           ...
                           <button class="btn4off" onclick="javascript:window.location='CarInfo.aspx';showwait();"type="button"><font class="shadow_but">可用车辆</font></button><button class="btn2off" onclick="javascript:window.location='CarInfo_ysh.aspx';showwait();" type="button"><font class="shadow_but">已损坏</font></button>&nbsp;<button class="btn2on" onclick="javascript:window.location='CarInfo_wxz.aspx';showwait();" type="button"><font class="shadow_but">维修中</font></button>&nbsp;<button class="btn2off" onclick="javascript:window.location='CarInfo_ybf.aspx';showwait();" type="button"><font class="shadow_but">已报废</font></button>
                        ...
                        <div id="Div1" >
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="选择">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                             ...
                                             <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CarNum") %>'
                                                Visible="False" Width="0px"></asp:Label>
                                        </ItemTemplate>
                                        <FooterStyle Wrap="True" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="CarModel" HeaderText="厂牌型号" SortExpression="CarModel">
                                    ...
                                    <asp:BoundField DataField="Driver" HeaderText="驾驶员" SortExpression="Driver">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>
                                        <asp:BoundField DataField="CarPrice" HeaderText="购买价格" SortExpression="CarPrice">
                                        <ItemStyle Wrap="False" />
                                        <HeaderStyle CssClass="newtitle" ForeColor="white" Wrap="False" />
                                    </asp:BoundField>                               
